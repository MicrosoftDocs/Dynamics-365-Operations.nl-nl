...
description: In dit artikel wordt beschreven hoe detailhandelproducten in Microsoft Dynamics 365 for Operations - detailhandel instellen.
author: josaw1
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
5.  Producten toevoegen aan navigatiehiërarchieën. Voordat u producten kunnen worden bekeken online of in-punt van verkooppunten (POS), worden ze in een detailhandel navigatiehiërarchie gecategoriseerd.
6.  Producten toevoegen aan de catalogus. Hoewel deze stap optioneel voor POS is, vereisen onlinewinkels dat de producten in ten minste één catalogus worden opgenomen.
