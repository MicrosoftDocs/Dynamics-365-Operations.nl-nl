...
description: In dit artikel worden de boekingstypen beschreven die worden gebruikt voor activa-leasingtransacties.
author: moaamer
ms.date: 04/12/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8889057"
---
# <a name="lease-posting-types"></a>Boekingstypen voor lease

[!include [banner](../includes/banner.md)]

In dit artikel worden de boekingstypen beschreven die worden gebruikt voor activa-leasingtransacties.
