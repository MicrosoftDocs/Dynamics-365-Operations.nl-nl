...
description: In dit artikel worden de belangrijkste termen gedefinieerd die in Kostprijsboekhouding worden gebruikt.
author: aprilolson
ms.date: 08/31/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8881928"
---
# <a name="cost-accounting-terminology"></a>Terminologie voor kostprijsboekhouding

[!include [banner](../includes/banner.md)]

In dit artikel worden de belangrijkste termen gedefinieerd die in Kostprijsboekhouding worden gebruikt.
