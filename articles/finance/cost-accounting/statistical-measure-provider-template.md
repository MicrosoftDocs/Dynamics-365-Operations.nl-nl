...
description: In dit artikel vindt u informatie over statistische dimensieleden en sjablonen van provider van statistische maateenheden.
author: AndersGirke
ms.date: 06/16/2017
ms.topic: article
ms.prod: ''
...
Statistische maateenheden kunnen afkomstig zijn van allerlei bronnen. Dynamics 365 Finance is een uitstekende bron om statistische metingen uit te halen. U kunt met een sjabloon van een statistische maateenheidprovider makkelijk de statistische maateenheden configureren die u wilt extraheren.
