...
description: In dit onderwerp worden de pagina's beschreven die u gebruikt voor het instellen van algemene en optionele functionaliteit voor Leveranciers. Daarnaast worden de stappen beschreven die u moet uitvoeren voordat u Leveranciers kunt instellen.
author: abruer
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
-   In het grootboek:
    ...
    -   Als u van plan bent wisselkoerscorrecties uit te voeren, moet u valutacodes configureren op de pagina **Valuta's**, wisselkoerstypen configureren op de pagina **Wisselkoerstypen** en de wisselkoersen voor de valuta configureren op de pagina **Valutawisselkoersen**.
...
7.  Maak en beheer op de pagina **Leveranciers** leveranciersrekeningen en de btw-dienst waarbij uw organisatie btw-aangifte doet.
...
-   Configureer op de pagina **Overeenstemmingbeleid** het beleid voor tweeweg- of driewegovereenstemming.
...
-   Definieer op de pagina **Betalingsdagen** de betalingsdagen die worden gebruikt voor de berekening van vervaldatums, en geef hier de betalingsdagen voor een bepaalde dag van de week of maand op.
...
-   Configureer op de pagina **Ouderdomsperiodedefinities** door de gebruiker gedefinieerde intervallen om de verdeling van vervallen posten van leveranciersrekeningen te analyseren.
...
-   Configureer op de pagina **Betalingsdoelcodes** de **betalingsdoelcode van de centrale bank**.
