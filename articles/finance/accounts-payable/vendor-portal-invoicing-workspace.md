...
ms.locfileid: "8182624"
---
# <a name="vendor-collaboration-invoicing-workspace"></a>Werkgebied voor samenwerkingsfacturering van leveranciers

[!include [banner](../includes/banner.md)]

In dit onderwerp wordt beschreven hoe u leveranciersfacturen kunt weergeven en facturen indient vanuit het werkgebied **Leverancierssamenwerkingsfacturen**.
