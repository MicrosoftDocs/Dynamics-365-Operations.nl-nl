...
description: In dit artikel wordt uitgelegd hoe organisaties die leveranciers periodiek betalen het proces van het genereren van betalingsvoorstellen voor leveranciers kunnen automatiseren.
author: kweekley
ms.date: 04/08/2020
ms.topic: article
ms.prod: ''
