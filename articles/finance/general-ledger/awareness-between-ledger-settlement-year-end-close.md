...
description: Dit artikel bevat informatie over verbeteringen die van invloed zijn op grootboekvereffeningen en de jaarafsluiting van het grootboek.
author: kweekley
ms.date: 04/06/2022
ms.topic: article
ms.prod: ''
