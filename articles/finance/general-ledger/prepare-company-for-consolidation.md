...
description: Tijdens een consolidatie verzamelt u transacties uit meerdere reeksen rekeningen van rechtspersonen en neemt ze op in één reeks met rekeningen van rechtspersonen. In dit artikel wordt uitgelegd hoe u een rechtspersoon voorbereidt voor een consolidatie.
author: jinniew
ms.date: 10/30/2020
ms.topic: article
ms.prod: ''
...
Tijdens een consolidatie verzamelt u transacties uit meerdere reeksen rekeningen van rechtspersonen en neemt ze op in één reeks met rekeningen van rechtspersonen. In dit artikel wordt uitgelegd hoe u een rechtspersoon voorbereidt voor een consolidatie.
