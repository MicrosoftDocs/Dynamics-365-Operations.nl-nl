---
title: Werken met de functionaliteit Elektronische berichten
description: Dit onderwerp bevat informatie over het werken met de functionaliteit voor elektronische berichten (EM).
author: liza-golub
ms.date: 07/07/2021
ms.topic: article
ms.prod: ''
