...
description: In dit artikel worden antwoorden gegeven op veelgestelde vragen over de functionaliteit Eén boekstuk. Met één boekstuk voor financiële journalen (algemeen journaal, vaste-activajournaal, leveranciersbetalingsjournaal, enzovoort) kunt u meerdere subgrootboekransacties invoeren in de context van één boekstuk.
author: kweekley
ms.date: 11/05/2018
ms.topic: article
ms.prod: ''
