...
description: In dit artikel wordt beschreven waar u toegang kunt krijgen tot financiële rapportage in Microsoft Dynamics 365 Finance en hoe u de financiële rapportagemogelijkheden kunt gebruiken.
author: aprilolson
ms.date: 06/20/2022
ms.topic: article
ms.prod: ''
...
In dit artikel wordt beschreven waar u toegang kunt krijgen tot Financial reporting en hoe u de financiële rapportagemogelijkheden kunt gebruiken. Het bevat ook een omschrijving van de financiële standaardrapporten die worden geleverd.

## <a name="enable-financial-reporting"></a>Financiële rapportage inschakelen
Als u de service voor financiële rapportage voor uw organisatie wilt gebruiken, moet een LCS-beheerder (Lifecycle Services) deze service inschakelen in de LCS-portal voor uw organisatie. Als Financial Reporting niet is ingericht in uw omgeving, neemt u contact op met de LCS-beheerder om de service te inschakelen. 

## <a name="accessing-financial-reporting"></a>Toegang verkrijgen tot Financial Reporting
