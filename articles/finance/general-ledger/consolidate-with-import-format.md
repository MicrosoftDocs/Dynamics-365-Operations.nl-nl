...
description: Dit artikel bevat gedetailleerde informatie over de importindeling die wordt gebruikt wanneer u financiële gegevens van meerdere rechtspersonen consolideert.
author: jinniew
ms.date: 10/09/2020
ms.topic: article
ms.prod: ''
...
Dit artikel bevat gedetailleerde informatie over de importindeling die wordt gebruikt wanneer u financiële gegevens van meerdere rechtspersonen consolideert. De importindeling moet als tekstbestand (.txt) worden opgeslagen.
