...
2. Klik op **Nieuw**.
3. In het veld **Leveranciersrekening** typt of selecteert u een waarde.
...
19. In het veld **Leveringsdatum** voert u een datum in.
20. Typ een datum in het veld **Bevestigde leveringsdatum**.
21. Voer een nummer in het veld **Eenheidsprijs** in.
...
41. Sluit de pagina.
42. Voer een nummer in het veld **Eenheidsprijs** in.
43. Klik op **Opslaan**.
...
## <a name="verify-import-letter-of-credit-status-and-printing"></a>De status en afdruk van de importkredietbrief controleren

1. Ga naar **Contanten en bankbeheer > Kredietbrieven > Kredietbrief importeren en incasso importeren**.
2. Zoek en selecteer de gewenste record in de lijst.
3. Klik in de lijst op de koppeling in de geselecteerde rij.
    * Controleer de status van de kredietbrief2.  
    * Valideren: **Verzendstatus** = **Details van gefactureerde bankfaciliteit**  
4. Klik op **Weergeven**.
