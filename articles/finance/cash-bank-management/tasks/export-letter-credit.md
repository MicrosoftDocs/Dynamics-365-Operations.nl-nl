...
7. Klik in het veld **Vestiging** op de vervolgkeuzeknop om de zoekopdracht te openen.
...
11. Selecteer **Kredietbrief** in het veld **Type bankdocument**.
...
14. Klik op het tabblad **Betaling**.
    * Details van het bankdocumentnummer en verzendummer controleren  
15. Klik op **Boeken**.
