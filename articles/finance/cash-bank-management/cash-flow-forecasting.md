...
Met een nieuw tabblad op de pagina **Cashflowprognose instellen** kunt u bepalen welke financiële dimensies in het werkgebied **Cashflowprognose** worden gebruikt voor het filteren. Dit tabblad wordt alleen weergegeven wanneer de functie Cashflowprognoses is ingeschakeld.
...
Zie voor meer informatie [Externe gegevens in cashflowprognoses](../../finance/finance-insights/external-data-in-cash-flow.md). 
