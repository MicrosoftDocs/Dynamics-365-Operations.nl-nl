...
1.  De hoofdrekening die is opgegeven in het veld **Alternatieve contantkortingsrekening** op de pagina **Openstaande transacties vereffenen** van de klant of de pagina **Openstaande transacties vereffenen** van de leverancier.
...
> [!NOTE]
> Als de optie **Contantkortingen berekenen voor gedeeltelijke betalingen** is geselecteerd op de pagina's **Parameters van module Klanten** ofr **Parameters van module Leveranciers**, wordt de wisselkoers gebruikt die geldt op de datum van elke deelbetaling. 
