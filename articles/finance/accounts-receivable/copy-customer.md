...
description: In dit artikel wordt uitgelegd hoe u gedeelde nummerreeksen kunt gebruiken om een klant te kopiëren naar een andere rechtspersoon, maar met behoud van dezelfde klant-id.
author: abruer
ms.date: 08/31/2018
ms.topic: index-page
ms.prod: ''
