...
Dit mobiele werkgebied is bedoeld om te worden gebruikt met de app Dynamics 365 Unified Ops Mobile.
...
- Maak een foto van een ontvangstbewijs en upload die naar Dynamics 365 Finance. U kunt vervolgens deze foto later aan een onkostennota koppelen.
...
De vereisten verschillen, afhankelijk van de versie die voor uw organisatie is geïmplementeerd.

### <a name="prerequisites-if-you-use-dynamics-365-finance"></a>Vereisten als u Dynamics 365 Finance gebruikt 
Als Finance is geïmplementeerd in uw organisatie, moet de systeembeheerder het mobiele werkgebied **Onkostenbeheer** publiceren. Zie voor meer informatie [Een mobiel werkgebied publiceren](../../dev-itpro/mobile-apps/publish-mobile-workspace.md).
...
Download en installeer de mobiele app Dynamics 365 Unified Ops:
