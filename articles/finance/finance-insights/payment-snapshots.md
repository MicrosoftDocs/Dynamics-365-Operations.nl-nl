...
description: In dit artikel wordt de functie Momentopnamen beschreven. Hiermee kunt u een cashflowprognose maken voor latere analyse of vergelijking met werkelijke waarden. Wanneer u een cashflow prognose genereert, kunt u die prognose opslaan als een 'momentopname'. U kunt deze momentopnamen vervolgens gebruiken om de rekeningen te bewerken die in de prognose zijn opgenomen of om de prognose in de momentopname te vergelijken met de werkelijke waarden.
...
- Kaspositie en cashflowprognoses in de loop der tijd bijhouden.
- De gegevens filteren om een subset van rechtspersonen weer te geven waarvoor de momentopname is gemaakt.
- De kaspositie en de cashflowprognose bewerken die door het systeem zijn gegenereerd.
- Wat-als-analyses uitvoeren om optimistische, pessimistische en meest waarschijnlijke weergaven van de cashflow te overwegen.
- De werkelijke financiële prestaties vergelijken met de prognose die is opgeslagen in de momentopname.

U kunt een momentopname maken door **Nieuwe momentopname** te selecteren op het tabblad **Kaspositie** of op het tabblad **Cashflowprognose** in de werkruimte **Cashflowprognoses**. Nadat een momentopname is gemaakt, kunnen de inkomsten en uitgaven worden bewerkt en opgeslagen. Alle opgeslagen momentopnamen zijn beschikbaar op het tabblad **Momentopnamen**. Selecteer de naam van een momentopname om deze te openen.
