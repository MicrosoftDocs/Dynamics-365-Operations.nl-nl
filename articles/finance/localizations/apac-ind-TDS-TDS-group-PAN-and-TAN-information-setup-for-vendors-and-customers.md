...
description: In dit artikel wordt uitgelegd hoe u gegevens kunt instellen over de TDS-groep (belasting ingehouden op bron), het permanente rekeningnummer (PAN) en het belastingrekeningnummer (TAN) voor leveranciers en klanten.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
...
In dit artikel wordt uitgelegd hoe u gegevens kunt instellen over de TDS-groep (belasting ingehouden op bron), het permanente rekeningnummer (PAN) en het belastingrekeningnummer (TAN) voor leveranciers en klanten.
