...
description: In dit onderwerp wordt uitgelegd hoe u de invoegtoepassing Elektronische facturering kunt installeren in Microsoft Dynamics Lifecycle Services (LCS).
author: dkalyuzh
ms.date: 02/11/2022
ms.topic: article
ms.prod: ''
