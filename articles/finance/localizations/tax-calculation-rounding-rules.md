...
description: Dit artikel biedt informatie over de afrondingsregels in de parameters voor de btw-berekening van de btw-berekeningsservice.
author: kailiang
ms.date: 07/29/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8858296"
---
# <a name="tax-calculation-rounding-rules"></a>Afrondingsregels voor btw-berekening

[!include [banner](../includes/banner.md)]

Dit artikel biedt informatie over hoe de afrondingsregels in de parameters voor de btw-berekening van de btw-berekeningsservice functioneren.
