...
description: In dit artikel wordt uitgelegd hoe u componenten voor bronbelasting, zoals Huur en Contractant, moet instellen voor het belastingtype TDS (belasting ingehouden op bron). Daarnaast wordt uitgelegd hoe u de drempellimiet definieert die wordt gebruikt om TDS te berekenen voor elke TDS-component.
author: kailiang
ms.date: 02/12/2021
ms.topic: article
ms.prod: ''
