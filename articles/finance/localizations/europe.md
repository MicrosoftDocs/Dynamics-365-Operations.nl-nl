...
- [Voorschothouders](emea-advance-holders.md)
 ...
 - [Betaling van voorschot aan een werknemer (Oost-Europa)](tasks/advance-payment-employee.md)
- [Geavanceerde facturering](emea-advance-invoice.md)
- [Bankafstemming](emea-bank-reconciliation.md)
- [Correctieve facturering](emea-corrective-invoice.md)
- [Periodieke journalen maken en boeken](emea-create-post-periodic-journals.md)
- [Betalingen aanmaken voor klanten met mandaten voor automatische afschrijving](tasks/create-payments-customers-who-have-direct-debit-mandates.md)
...
- [Programma voor genereren van betalingsverwijzingen (Oost-Europa)](tasks/ee-00015-payment-reference-generation-tool.md)
- [Rapport betaalbon](emea-eur-payment-slip-report-giro.md)
...
- [Een EU-invoercertificaat ontvangen](tasks/eur-00012-receive-eu-entry-certificate.md)
- [Registratie-id's](emea-registration-ids.md)
- [Terugboekingen](emea-reverse-charge.md)
...
- Belasting op de toegevoegde waarde (Btw)
  - [naam: btw-id instellen](tasks/eur-00015-vat-id.md)
  - [Een btw-id van een leverancier registreren](tasks/eur-00015-registration-vendor-vat-id.md)
  ...
  - [Btw-puntdatum (datum van btw-registratie)](emea-tax-point-date.md)
