...
description: In dit onderwerp wordt uitgelegd hoe u een verbinding configureert zodat elektronische facturering toegang krijgt tot een Microsoft-site SharePoint.
author: dkalyuzh
ms.date: 12/15/2021
ms.topic: article
ms.prod: ''
