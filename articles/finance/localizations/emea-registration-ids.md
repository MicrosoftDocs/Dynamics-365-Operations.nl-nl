...
De volgende tabel bevat een overzicht van de ondersteunde registratietypen. Als u vertrouwd bent met de velden in Microsoft Dynamics AX 2012 voor registratie-id's, worden in deze tabel deze velden ook toegewezen aan de Dynamics 365 Finance-registratiecategorieën.

| Registratiecategorie Finance         |Land/regio  | Dynamics AX 2012-term/veld|
|---------------------------------------------------------------|---------------------|---------------------------------|
