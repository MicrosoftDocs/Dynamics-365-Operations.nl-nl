...
description: Gebruik deze procedure voor het ontwerpen van ER-configuraties (elektronische rapportage) om gegevens te importeren in Dynamics 365 for Finance and Operations, Enterprise-editie vanuit een extern bestand in CSV-indeling.
author: NickSelin
manager: AnnBe
ms.date: 12/12/2017
...
Gebruik deze procedure voor het ontwerpen van ER-configuraties (elektronische rapportage) om gegevens te importeren in Dynamics 365 for Finance and Operations, Enterprise-editie vanuit een extern bestand in CSV-indeling. In deze procedure maakt u de vereiste ER-configuraties voor het voorbeeldbedrijf Litware, Inc. Voordat u deze stappen uitvoert, moet u eerst de stappen uitvoeren in de procedure 'ER Een configuratieprovider maken en deze als actief markeren'. 
...
5. Selecteer in de structuur 'Inkomend: File\Root: Sequence\Line: Sequence 1..* '.
...
6. Selecteer in de structuur 'Inkomend: File\Root: Sequence\Line: Sequence 1..* \Types: Case'.
...
7. Selecteer in de structuur 'Inkomend: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Header: Sequence 1..1 '.
...
8. Selecteer in de structuur 'Inkomend: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Record: Sequence 1..1 (,)'.
...
12. Selecteer in de structuur 'Inkomend: File\Root: Sequence\Line: Sequence 1..* \Types: Case\Unparsed: Sequence 1..1 '.
...
6. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)' uit.
7. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)' uit.
8. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)' uit.
9. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data' uit.
10. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\CountryCode: String 0..1 (CountryCode)' uit.
11. Vouw in de structuur 'indeling\Inkomend: File(Incoming)\Root: Sequence(Root)\Line: Sequence 1..* (Line)\Types: Case(Types)\Record: Sequence 1..1 (,)(Record)\Data\TransactionDate: DateTime(TransactionDate)' uit.
