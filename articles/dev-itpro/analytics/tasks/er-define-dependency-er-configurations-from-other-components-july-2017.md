...
---
# <a name="define-the-dependency-of-configurations-from-othcomponents-for-electronic-reporting-er"></a>De afhankelijkheid van configuraties van andere onderdelen voor elektronische aangifte definiëren (ER)
