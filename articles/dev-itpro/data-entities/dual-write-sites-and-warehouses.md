...
In dit onderwerp wordt de integratie van locatie- en magazijngegevens tussen Finance and Operations en Common Data Service beschreven. Operationele locaties en magazijnen zijn gangbare concepten in een toepassing voor toeleveringsbeheer. Ze worden gebruikt om de toeleveringsketen van uw bedrijf te modelleren.
...
## <a name="operational-sites"></a>Operationele locaties

De operationele locaties zijn in Common Data Service beschikbaar met de volgende toewijzingen.
...
## <a name="warehouses"></a>Magazijnen

De magazijnen zijn beschikbaar met de volgende toewijzingen.
