...
## <a name="adjust-leave-balances"></a>Verlofsaldi aanpassen

1. Selecteer **Verlof** in de record van de werknemer.

2. Selecteer **Instellingen voor verlof en verzuim**.

3. Selecteer **Saldo aanpassen**.

4. Selecteer **Verloftype**.

5. Voer een **Aanpassingshoeveelheid** in. 
