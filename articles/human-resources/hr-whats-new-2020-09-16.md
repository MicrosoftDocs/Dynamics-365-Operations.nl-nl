...
description: In dit artikel worden de functies beschreven die nieuw of gewijzigd zijn in Microsoft Dynamics 365 Human Resources voor 16 september 2020.
author: jcart1106
ms.date: 09/16/2020
ms.topic: article
ms.prod: ''
...
In dit artikel worden de functies beschreven die in Dynamics 365 Human Resources nieuw of gewijzigd zijn. Wijzigingen die van toepassing zijn op buildnummer 8.1.3557. De getallen tussen haakjes naast sommige functies verwijzen ter referentie naar ondersteuningsnummers in Lifecycle Services (LCS).
