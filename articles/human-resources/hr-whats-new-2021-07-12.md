...
| Functie | Gegevens |
| --- | --- |
| Platformupdate 10.0.20 (44) | Platformupdate 10.0.20 is gepland voor de uitrol met de volgende servicerelease op 26 juli 2021. Zie voor meer informatie [Platformupdates voor versie 10.0.20 van apps voor financiën en bedrijfsactiviteiten (augustus 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20). |
