...
## <a name="review-payroll-entities"></a>Entiteiten salarisadministratie beoordelen

Gebruik deze API om een lijst met entiteiten op te halen die zijn gegenereerd en gereed zijn voor gebruik.
