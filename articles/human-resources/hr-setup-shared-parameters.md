...
description: In dit artikel wordt uitgelegd hoe u Human Resources-parameters instelt voor alle rechtspersonen.
author: twheeloc
ms.date: 10/28/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8906177"
---
# <a name="configure-shared-parameters"></a>Gedeelde parameters configureren

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

U moet gedeelde parameters instellen voor records die tussen bedrijven worden gedeeld, zoals **Positie** records. In dit artikel wordt uitgelegd hoe u Human Resources-parameters instelt voor alle rechtspersonen.
