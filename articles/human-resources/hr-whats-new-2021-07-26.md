...
description: In dit artikel worden de functies beschreven die nieuw of gewijzigd zijn in Microsoft Dynamics 365 Human Resources voor 26 juli 2021.
author: marcelbf
ms.date: 07/12/2021
ms.topic: article
ms.prod: ''
...
| --- | --- | --- |
| Platformupdate 10.0.20 | -- | [Platformupdates voor versie 10.0.20 van apps voor financiën en bedrijfsactiviteiten (augustus 2021)](/dynamics365/fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-20) |
