...
- <span data-ttu-id="08e1c-111">HRM-gegevens</span><span class="sxs-lookup"><span data-stu-id="08e1c-111">Human resources data</span></span>
...
## <a name="configure-your-data"></a><span data-ttu-id="08e1c-142">Uw gegevens configureren</span><span class="sxs-lookup"><span data-stu-id="08e1c-142">Configure your data</span></span> 
...
##### <a name="benefits"></a><span data-ttu-id="08e1c-159">Vergoedingen</span><span class="sxs-lookup"><span data-stu-id="08e1c-159">Benefits</span></span>
...
<span data-ttu-id="08e1c-188">Zie de volgende artikelen voor meer informatie over het definiëren en beheren van een vergoedingsprogramma:</span><span class="sxs-lookup"><span data-stu-id="08e1c-188">For more information about how to define and manage a benefits program, see the following articles:</span></span>
...
- [<span data-ttu-id="08e1c-206">Een werknemer inschrijven voor een vaste honoreringsregeling</span><span class="sxs-lookup"><span data-stu-id="08e1c-206">Enroll an employee in a fixed compensation plan</span></span>](/dynamics365/unified-operations/fin-and-ops/hr/tasks/enroll-employee-fixed-compensation-plan)
...
- <span data-ttu-id="08e1c-228">Standaard financiële dimensie: kostenplaats (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-228">Default financial dimension – Cost center (required)</span></span>
...
#### <a name="earning-codes"></a><span data-ttu-id="08e1c-258">Inkomstencodes</span><span class="sxs-lookup"><span data-stu-id="08e1c-258">Earning codes</span></span>
...
<span data-ttu-id="08e1c-274">Wanneer u informatie over een werknemer invoert, moet u rekening houden met de volgende gegevens en configuraties die worden gebruikt in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-274">When you enter worker information, keep in mind the following data and configurations that are used in Dayforce.</span></span>
...
#### <a name="contact-information"></a><span data-ttu-id="08e1c-297">Gegevens contactpersoon</span><span class="sxs-lookup"><span data-stu-id="08e1c-297">Contact information</span></span> 
...
- <span data-ttu-id="08e1c-345">Ingangsdatum (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-345">Effective Date (required)</span></span>
...
- <span data-ttu-id="08e1c-387">Plaats (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-387">City (required)</span></span>
...
<span data-ttu-id="08e1c-402">De volgende functietypen en omschrijvingen zijn vereist.</span><span class="sxs-lookup"><span data-stu-id="08e1c-402">The following job types and descriptions are required.</span></span>
...
| <span data-ttu-id="08e1c-435">OTHER</span><span class="sxs-lookup"><span data-stu-id="08e1c-435">OTHER</span></span>          | <span data-ttu-id="08e1c-436">Andere redenen</span><span class="sxs-lookup"><span data-stu-id="08e1c-436">Other Reasons</span></span>    | <span data-ttu-id="08e1c-437">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-437">Terminate worker</span></span>     |
...
<span data-ttu-id="08e1c-471">In de volgende tabel wordt aangegeven hoe geslachtsaanduidingen worden toegewezen aan Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-471">The following table shows how gender designations are mapped to Dayforce.</span></span>
...
- <span data-ttu-id="08e1c-501">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-501">2N4OFMTH</span></span>
...
<span data-ttu-id="08e1c-515">De identificatie van specifieke codes voor land of regio, staat en district (gemeente) vereist specifieke indelingen die door Dayforce en providers in het land of in de regio kunnen worden herkend.</span><span class="sxs-lookup"><span data-stu-id="08e1c-515">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="08e1c-516">Hoewel de indeling voor plaatsen flexibel is, moet elke plaats worden gekoppeld aan een staat.</span><span class="sxs-lookup"><span data-stu-id="08e1c-516">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="08e1c-517">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-517">Human Resources</span></span>          | <span data-ttu-id="08e1c-518">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-518">Dayforce</span></span>              |
|-----------------|-----------------------|
| <span data-ttu-id="08e1c-519">Land/regio</span><span class="sxs-lookup"><span data-stu-id="08e1c-519">Country/Region</span></span>  | <span data-ttu-id="08e1c-520">Landcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-520">Country Code</span></span>          |
| <span data-ttu-id="08e1c-521">Postcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-521">Zip/Postal Code</span></span> | <span data-ttu-id="08e1c-522">Postcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-522">Postal Code</span></span>           |
| <span data-ttu-id="08e1c-523">Provincie</span><span class="sxs-lookup"><span data-stu-id="08e1c-523">State</span></span>           | <span data-ttu-id="08e1c-524">Staatcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-524">State Code</span></span>            |
| <span data-ttu-id="08e1c-525">Plaats</span><span class="sxs-lookup"><span data-stu-id="08e1c-525">City</span></span>            | <span data-ttu-id="08e1c-526">Plaats</span><span class="sxs-lookup"><span data-stu-id="08e1c-526">City</span></span>                  |
| <span data-ttu-id="08e1c-527">District</span><span class="sxs-lookup"><span data-stu-id="08e1c-527">County</span></span>          | <span data-ttu-id="08e1c-528">District (gemeente)</span><span class="sxs-lookup"><span data-stu-id="08e1c-528">County (Municipality)</span></span> |
| <span data-ttu-id="08e1c-529">Adres</span><span class="sxs-lookup"><span data-stu-id="08e1c-529">Street</span></span>          | <span data-ttu-id="08e1c-530">Adresregel 1</span><span class="sxs-lookup"><span data-stu-id="08e1c-530">Address Line 1</span></span>        |

### <a name="tax-regions"></a><span data-ttu-id="08e1c-531">Belastingregio's</span><span class="sxs-lookup"><span data-stu-id="08e1c-531">Tax regions</span></span>

<span data-ttu-id="08e1c-532">Belastingregio's worden gebruikt om de juiste belasting te bepalen die moet worden gebruikt bij het genereren van salarissen.</span><span class="sxs-lookup"><span data-stu-id="08e1c-532">Tax regions are used to determine the appropriate tax that should be applied during payroll generation.</span></span> <span data-ttu-id="08e1c-533">Belastingregio's worden aan Dayforce toegewezen als locatieadressen.</span><span class="sxs-lookup"><span data-stu-id="08e1c-533">Tax regions are mapped to Dayforce as location addresses.</span></span> <span data-ttu-id="08e1c-534">De standaardbelastingregio moet aan de actieve positie van de werknemer worden gekoppeld.</span><span class="sxs-lookup"><span data-stu-id="08e1c-534">The default tax region must be associated with the worker's active position.</span></span> 

- <span data-ttu-id="08e1c-535">Belastingregio (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-535">Tax region (required)</span></span>
- <span data-ttu-id="08e1c-536">Land/regio (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-536">Country/Region (required)</span></span>
- <span data-ttu-id="08e1c-537">Staat (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-537">State (required)</span></span>
- <span data-ttu-id="08e1c-538">District</span><span class="sxs-lookup"><span data-stu-id="08e1c-538">County</span></span> 
- <span data-ttu-id="08e1c-539">Plaats (vereist)</span><span class="sxs-lookup"><span data-stu-id="08e1c-539">City (required)</span></span>

## <a name="configure-your-data-to-generate-payroll-in-mexico"></a><span data-ttu-id="08e1c-540">Uw gegevens configureren voor het genereren van salarissen in Mexico</span><span class="sxs-lookup"><span data-stu-id="08e1c-540">Configure your data to generate payroll in Mexico</span></span>

<span data-ttu-id="08e1c-541">Als u salarissen genereert voor werknemers in Mexico, moeten de volgende elementen worden geconfigureerd:</span><span class="sxs-lookup"><span data-stu-id="08e1c-541">If you're generating pay for employees in Mexico, the following elements must be configured:</span></span>

- <span data-ttu-id="08e1c-542">Afdelingen zijn vereist voor posities.</span><span class="sxs-lookup"><span data-stu-id="08e1c-542">Departments are required on positions.</span></span>
- <span data-ttu-id="08e1c-543">Kostenplaatsen moeten worden ingesteld als financiële dimensies en moeten het eerste element in de standaardtekenreeks voor de financiële dimensie vormen.</span><span class="sxs-lookup"><span data-stu-id="08e1c-543">Cost centers must be set as financial dimensions and must be the first element in the Default Financial Dimension string.</span></span>

### <a name="job-types"></a><span data-ttu-id="08e1c-544">Taaktypen</span><span class="sxs-lookup"><span data-stu-id="08e1c-544">Job types</span></span>

<span data-ttu-id="08e1c-545">Functietypen worden gebruikt om vergelijkbare functies in categorieën te groeperen.</span><span class="sxs-lookup"><span data-stu-id="08e1c-545">Job types are used to group similar jobs into categories.</span></span> <span data-ttu-id="08e1c-546">Functietypen zijn vereist voor het verwerken van salarissen in Mexico.</span><span class="sxs-lookup"><span data-stu-id="08e1c-546">Job types are required in order to process payroll in Mexico.</span></span> <span data-ttu-id="08e1c-547">Voorbeelden van functietypen zijn onder anderen fulltime en parttime of salaris en uurtarief.</span><span class="sxs-lookup"><span data-stu-id="08e1c-547">Examples of job types include full-time and part-time, or salary and hourly pay.</span></span> <span data-ttu-id="08e1c-548">Functietypen worden toegewezen aan Dayforce als salaristypen die aangeven of een werknemer per uur wordt betaald of een salaris ontvangt.</span><span class="sxs-lookup"><span data-stu-id="08e1c-548">Job types are mapped to Dayforce as pay types that indicate whether an employee is hourly or salaried.</span></span>

<span data-ttu-id="08e1c-549">De volgende functietypen en omschrijvingen zijn vereist.</span><span class="sxs-lookup"><span data-stu-id="08e1c-549">The following job types and descriptions are required.</span></span>

| <span data-ttu-id="08e1c-550">Functietype</span><span class="sxs-lookup"><span data-stu-id="08e1c-550">Job type</span></span>   | <span data-ttu-id="08e1c-551">Omschrijving</span><span class="sxs-lookup"><span data-stu-id="08e1c-551">Description</span></span> |
|------------|-------------|
| <span data-ttu-id="08e1c-552">Per uur</span><span class="sxs-lookup"><span data-stu-id="08e1c-552">Hourly</span></span>     | <span data-ttu-id="08e1c-553">MX Per uur</span><span class="sxs-lookup"><span data-stu-id="08e1c-553">MX Hourly</span></span>   |
| <span data-ttu-id="08e1c-554">Bezoldigd</span><span class="sxs-lookup"><span data-stu-id="08e1c-554">Salaried</span></span>   | <span data-ttu-id="08e1c-555">MX Bezoldigd</span><span class="sxs-lookup"><span data-stu-id="08e1c-555">MX Salaried</span></span> |

### <a name="position-types"></a><span data-ttu-id="08e1c-556">Positietypen</span><span class="sxs-lookup"><span data-stu-id="08e1c-556">Position types</span></span> 

<span data-ttu-id="08e1c-557">U gebruikt positietypen om te beschrijven of de positie fulltime, parttime of iets anders is.</span><span class="sxs-lookup"><span data-stu-id="08e1c-557">You use position types to describe whether the position is full-time, part-time, or something else.</span></span> <span data-ttu-id="08e1c-558">Positietypen worden toegewezen aan Dayforce als betalingsklassen die aangeven of een werknemer een fulltime of parttime dienstverband heeft.</span><span class="sxs-lookup"><span data-stu-id="08e1c-558">Position types are mapped to Dayforce as pay classes that indicate whether an employee is full-time or part-time.</span></span>

<span data-ttu-id="08e1c-559">De volgende positietypen en omschrijvingen zijn vereist.</span><span class="sxs-lookup"><span data-stu-id="08e1c-559">The following position types and descriptions are required.</span></span>

| <span data-ttu-id="08e1c-560">Positietype</span><span class="sxs-lookup"><span data-stu-id="08e1c-560">Position type</span></span>   | <span data-ttu-id="08e1c-561">Omschrijving</span><span class="sxs-lookup"><span data-stu-id="08e1c-561">Description</span></span>        |
|-----------------|--------------------|
| <span data-ttu-id="08e1c-562">Voltijd</span><span class="sxs-lookup"><span data-stu-id="08e1c-562">Full-time</span></span>       | <span data-ttu-id="08e1c-563">Voltijdse werknemer</span><span class="sxs-lookup"><span data-stu-id="08e1c-563">Full time employee</span></span> |
| <span data-ttu-id="08e1c-564">Deeltijd</span><span class="sxs-lookup"><span data-stu-id="08e1c-564">Part-time</span></span>       | <span data-ttu-id="08e1c-565">Werknemer in deeltijd</span><span class="sxs-lookup"><span data-stu-id="08e1c-565">Part time employee</span></span> |

### <a name="reason-codes"></a><span data-ttu-id="08e1c-566">Redencodes</span><span class="sxs-lookup"><span data-stu-id="08e1c-566">Reason codes</span></span>

<span data-ttu-id="08e1c-567">Redencodes bieden informatie over de status van een werknemer.</span><span class="sxs-lookup"><span data-stu-id="08e1c-567">Reason codes provide information about the status of an employee.</span></span> <span data-ttu-id="08e1c-568">Redencodes worden toegewezen aan Dayforce als statusredenen die de reden voor wijzigingen in de positie of de status van het dienstverband van een werknemer aangeven.</span><span class="sxs-lookup"><span data-stu-id="08e1c-568">Reason codes are mapped to Dayforce as status reasons that indicate the reason for changes to an employee's position or employment status.</span></span>

<span data-ttu-id="08e1c-569">De volgende redencodes en omschrijvingen zijn vereist.</span><span class="sxs-lookup"><span data-stu-id="08e1c-569">The following reason codes and descriptions are required.</span></span>

| <span data-ttu-id="08e1c-570">Redencode</span><span class="sxs-lookup"><span data-stu-id="08e1c-570">Reason code</span></span>            | <span data-ttu-id="08e1c-571">Omschrijving</span><span class="sxs-lookup"><span data-stu-id="08e1c-571">Description</span></span>                    | <span data-ttu-id="08e1c-572">Toepasselijke scenario's</span><span class="sxs-lookup"><span data-stu-id="08e1c-572">Applicable scenarios</span></span> |
|------------------------|--------------------------------|----------------------|
| <span data-ttu-id="08e1c-573">DEPARTUREBEFOREPAYMENT</span><span class="sxs-lookup"><span data-stu-id="08e1c-573">DEPARTUREBEFOREPAYMENT</span></span> | <span data-ttu-id="08e1c-574">Vertrek voor eerste salaris</span><span class="sxs-lookup"><span data-stu-id="08e1c-574">Departure before first payroll</span></span> | <span data-ttu-id="08e1c-575">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-575">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-576">RESIGNATION</span><span class="sxs-lookup"><span data-stu-id="08e1c-576">RESIGNATION</span></span>            | <span data-ttu-id="08e1c-577">Ontslag</span><span class="sxs-lookup"><span data-stu-id="08e1c-577">Resignation</span></span>                    | <span data-ttu-id="08e1c-578">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-578">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-579">PENSION</span><span class="sxs-lookup"><span data-stu-id="08e1c-579">PENSION</span></span>                | <span data-ttu-id="08e1c-580">Pensioen</span><span class="sxs-lookup"><span data-stu-id="08e1c-580">Pension</span></span>                        | <span data-ttu-id="08e1c-581">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-581">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-582">TERMINATION</span><span class="sxs-lookup"><span data-stu-id="08e1c-582">TERMINATION</span></span>            | <span data-ttu-id="08e1c-583">Beëindiging</span><span class="sxs-lookup"><span data-stu-id="08e1c-583">Termination</span></span>                    | <span data-ttu-id="08e1c-584">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-584">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-585">RETIREMENT</span><span class="sxs-lookup"><span data-stu-id="08e1c-585">RETIREMENT</span></span>             | <span data-ttu-id="08e1c-586">Pensionering</span><span class="sxs-lookup"><span data-stu-id="08e1c-586">Retirement</span></span>                     | <span data-ttu-id="08e1c-587">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-587">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-588">ABSENTEE</span><span class="sxs-lookup"><span data-stu-id="08e1c-588">ABSENTEE</span></span>               | <span data-ttu-id="08e1c-589">Verzuim</span><span class="sxs-lookup"><span data-stu-id="08e1c-589">Absentee</span></span>                       | <span data-ttu-id="08e1c-590">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-590">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-591">OTHER</span><span class="sxs-lookup"><span data-stu-id="08e1c-591">OTHER</span></span>                  | <span data-ttu-id="08e1c-592">Andere redenen</span><span class="sxs-lookup"><span data-stu-id="08e1c-592">Other Reasons</span></span>                  | <span data-ttu-id="08e1c-593">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-593">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-594">CLOSURE</span><span class="sxs-lookup"><span data-stu-id="08e1c-594">CLOSURE</span></span>                | <span data-ttu-id="08e1c-595">Bedrijfssluiting</span><span class="sxs-lookup"><span data-stu-id="08e1c-595">Business Closure</span></span>               | <span data-ttu-id="08e1c-596">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-596">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-597">DEATH</span><span class="sxs-lookup"><span data-stu-id="08e1c-597">DEATH</span></span>                  | <span data-ttu-id="08e1c-598">Overlijden</span><span class="sxs-lookup"><span data-stu-id="08e1c-598">Death</span></span>                          | <span data-ttu-id="08e1c-599">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-599">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-600">LEAVEOFABSENCE</span><span class="sxs-lookup"><span data-stu-id="08e1c-600">LEAVEOFABSENCE</span></span>         | <span data-ttu-id="08e1c-601">Verlof of verzuim</span><span class="sxs-lookup"><span data-stu-id="08e1c-601">Leave of Absence</span></span>               | <span data-ttu-id="08e1c-602">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-602">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-603">CONTRACTEND</span><span class="sxs-lookup"><span data-stu-id="08e1c-603">CONTRACTEND</span></span>            | <span data-ttu-id="08e1c-604">Einde van contract</span><span class="sxs-lookup"><span data-stu-id="08e1c-604">End of Contract</span></span>                | <span data-ttu-id="08e1c-605">Medewerker ontslaan</span><span class="sxs-lookup"><span data-stu-id="08e1c-605">Terminate worker</span></span>     |
| <span data-ttu-id="08e1c-606">SALARYCHANGE</span><span class="sxs-lookup"><span data-stu-id="08e1c-606">SALARYCHANGE</span></span>           | <span data-ttu-id="08e1c-607">Salariswijziging</span><span class="sxs-lookup"><span data-stu-id="08e1c-607">Change of Salary</span></span>               | <span data-ttu-id="08e1c-608">Compensatie</span><span class="sxs-lookup"><span data-stu-id="08e1c-608">Compensation</span></span>         |

### <a name="terms-of-employment"></a><span data-ttu-id="08e1c-609">Arbeidsvoorwaarden</span><span class="sxs-lookup"><span data-stu-id="08e1c-609">Terms of employment</span></span>

<span data-ttu-id="08e1c-610">Arbeidsvoorwaarden worden gebruikt om categorieën met arbeidsvoorwaarden te maken.</span><span class="sxs-lookup"><span data-stu-id="08e1c-610">Terms of employment are used to create categories of employment terms.</span></span> <span data-ttu-id="08e1c-611">De voorwaarden worden toegewezen aan Dayforce als indicatorwaarden voor het dienstverband.</span><span class="sxs-lookup"><span data-stu-id="08e1c-611">The terms are mapped to Dayforce as employment indicator values.</span></span>

<span data-ttu-id="08e1c-612">De volgende arbeidsvoorwaarden en omschrijvingen zijn vereist.</span><span class="sxs-lookup"><span data-stu-id="08e1c-612">The following terms of employment and descriptions are required.</span></span>

| <span data-ttu-id="08e1c-613">Arbeidsvoorwaarden</span><span class="sxs-lookup"><span data-stu-id="08e1c-613">Terms of employment</span></span>   | <span data-ttu-id="08e1c-614">Omschrijving</span><span class="sxs-lookup"><span data-stu-id="08e1c-614">Description</span></span> |
|-----------------------|-------------|
| <span data-ttu-id="08e1c-615">Normaal</span><span class="sxs-lookup"><span data-stu-id="08e1c-615">Regular</span></span>               | <span data-ttu-id="08e1c-616">Normaal</span><span class="sxs-lookup"><span data-stu-id="08e1c-616">Regular</span></span>     |
| <span data-ttu-id="08e1c-617">Direct</span><span class="sxs-lookup"><span data-stu-id="08e1c-617">Direct</span></span>                | <span data-ttu-id="08e1c-618">Direct</span><span class="sxs-lookup"><span data-stu-id="08e1c-618">Direct</span></span>      |
| <span data-ttu-id="08e1c-619">Stage</span><span class="sxs-lookup"><span data-stu-id="08e1c-619">Internship</span></span>            | <span data-ttu-id="08e1c-620">Stage</span><span class="sxs-lookup"><span data-stu-id="08e1c-620">Internship</span></span>  |
| <span data-ttu-id="08e1c-621">Permanent</span><span class="sxs-lookup"><span data-stu-id="08e1c-621">Permanent</span></span>             | <span data-ttu-id="08e1c-622">Permanent</span><span class="sxs-lookup"><span data-stu-id="08e1c-622">Permanent</span></span>   |

### <a name="marital-status"></a><span data-ttu-id="08e1c-623">Burgerlijke staat</span><span class="sxs-lookup"><span data-stu-id="08e1c-623">Marital status</span></span>

<span data-ttu-id="08e1c-624">De waarden voor de burgerlijke staat worden toegewezen aan Dayforce en, waar nodig, vertaald naar de geaccepteerde waarden bij integratie.</span><span class="sxs-lookup"><span data-stu-id="08e1c-624">Marital status values are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="08e1c-625">In de volgende tabel wordt aangegeven hoe de waarden voor de burgerlijke staat worden toegewezen aan Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-625">The following table shows how marital status values are mapped to Dayforce.</span></span>

| <span data-ttu-id="08e1c-626">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-626">Human Resources</span></span>                 | <span data-ttu-id="08e1c-627">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-627">Dayforce</span></span>                  |
|------------------------|---------------------------|
| <span data-ttu-id="08e1c-628">Gehuwd</span><span class="sxs-lookup"><span data-stu-id="08e1c-628">Married</span></span>                | <span data-ttu-id="08e1c-629">Gehuwd</span><span class="sxs-lookup"><span data-stu-id="08e1c-629">Married</span></span>                   |
| <span data-ttu-id="08e1c-630">Eén</span><span class="sxs-lookup"><span data-stu-id="08e1c-630">Single</span></span>                 | <span data-ttu-id="08e1c-631">Eén</span><span class="sxs-lookup"><span data-stu-id="08e1c-631">Single</span></span>                    |
| <span data-ttu-id="08e1c-632">Weduwe/weduwnaar</span><span class="sxs-lookup"><span data-stu-id="08e1c-632">Widowed</span></span>                | <span data-ttu-id="08e1c-633">Weduwe/weduwnaar</span><span class="sxs-lookup"><span data-stu-id="08e1c-633">Widowed</span></span>                   |
| <span data-ttu-id="08e1c-634">Gescheiden</span><span class="sxs-lookup"><span data-stu-id="08e1c-634">Divorced</span></span>               | <span data-ttu-id="08e1c-635">Gescheiden</span><span class="sxs-lookup"><span data-stu-id="08e1c-635">Divorced</span></span>                  |
| <span data-ttu-id="08e1c-636">Geregistreerd partnerschap</span><span class="sxs-lookup"><span data-stu-id="08e1c-636">Registered Partnership</span></span> | <span data-ttu-id="08e1c-637">Binnenlands partnerschap</span><span class="sxs-lookup"><span data-stu-id="08e1c-637">Domestic Partnership</span></span>      |
| <span data-ttu-id="08e1c-638">None</span><span class="sxs-lookup"><span data-stu-id="08e1c-638">None</span></span>                   | <span data-ttu-id="08e1c-639">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-639">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="08e1c-640">Samenwonend</span><span class="sxs-lookup"><span data-stu-id="08e1c-640">Cohabiting</span></span>             | <span data-ttu-id="08e1c-641">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-641">*Not supported by Mexico*</span></span> |

### <a name="gender"></a><span data-ttu-id="08e1c-642">Geslacht</span><span class="sxs-lookup"><span data-stu-id="08e1c-642">Gender</span></span>

<span data-ttu-id="08e1c-643">Geslachtsaanduidingen worden toegewezen aan Dayforce en, waar nodig, vertaald naar de geaccepteerde waarden bij integratie.</span><span class="sxs-lookup"><span data-stu-id="08e1c-643">Gender designations are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="08e1c-644">In de volgende tabel wordt aangegeven hoe geslachtsaanduidingen worden toegewezen aan Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-644">The following table shows how gender designations are mapped to Dayforce.</span></span>

| <span data-ttu-id="08e1c-645">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-645">Human Resources</span></span>       | <span data-ttu-id="08e1c-646">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-646">Dayforce</span></span>                  |
|--------------|---------------------------|
| <span data-ttu-id="08e1c-647">Mannelijk</span><span class="sxs-lookup"><span data-stu-id="08e1c-647">Male</span></span>         | <span data-ttu-id="08e1c-648">Mannelijk</span><span class="sxs-lookup"><span data-stu-id="08e1c-648">Male</span></span>                      |
| <span data-ttu-id="08e1c-649">Vrouwelijk</span><span class="sxs-lookup"><span data-stu-id="08e1c-649">Female</span></span>       | <span data-ttu-id="08e1c-650">Vrouwelijk</span><span class="sxs-lookup"><span data-stu-id="08e1c-650">Female</span></span>                    |
| <span data-ttu-id="08e1c-651">Niet-specifiek</span><span class="sxs-lookup"><span data-stu-id="08e1c-651">Non-specific</span></span> | <span data-ttu-id="08e1c-652">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-652">*Not supported by Mexico*</span></span> |

### <a name="payment-method"></a><span data-ttu-id="08e1c-653">Betalingsmethode</span><span class="sxs-lookup"><span data-stu-id="08e1c-653">Payment method</span></span>

<span data-ttu-id="08e1c-654">Betalingsmethoden bieden de werknemer en het bedrijf een manier om te beschrijven hoe werknemers worden uitbetaald.</span><span class="sxs-lookup"><span data-stu-id="08e1c-654">Payment methods give the employee and the company a way to describe how employees will be paid.</span></span> <span data-ttu-id="08e1c-655">Betalingsmethoden worden toegewezen aan Dayforce en, waar nodig, vertaald naar de geaccepteerde waarden bij integratie.</span><span class="sxs-lookup"><span data-stu-id="08e1c-655">Payment methods are mapped to Dayforce and translated, as appropriate, to the accepted values upon integration.</span></span>

<span data-ttu-id="08e1c-656">In de volgende tabel wordt aangegeven hoe betalingsmethoden worden toegewezen aan Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-656">The following table shows how payment methods are mapped to Dayforce.</span></span>

| <span data-ttu-id="08e1c-657">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-657">Human Resources</span></span>             | <span data-ttu-id="08e1c-658">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-658">Dayforce</span></span>                  |
|--------------------|---------------------------|
| <span data-ttu-id="08e1c-659">Contant geld</span><span class="sxs-lookup"><span data-stu-id="08e1c-659">Cash</span></span>               | <span data-ttu-id="08e1c-660">Contant geld</span><span class="sxs-lookup"><span data-stu-id="08e1c-660">Cash</span></span>                      |
| <span data-ttu-id="08e1c-661">Elektronische betaling</span><span class="sxs-lookup"><span data-stu-id="08e1c-661">Electronic Payment</span></span> | <span data-ttu-id="08e1c-662">Overboeking</span><span class="sxs-lookup"><span data-stu-id="08e1c-662">Transfer</span></span>                  |
| <span data-ttu-id="08e1c-663">Controleren</span><span class="sxs-lookup"><span data-stu-id="08e1c-663">Check</span></span>              | <span data-ttu-id="08e1c-664">Cheque</span><span class="sxs-lookup"><span data-stu-id="08e1c-664">Cheque</span></span>                    |
| <span data-ttu-id="08e1c-665">Bankcheque</span><span class="sxs-lookup"><span data-stu-id="08e1c-665">Bank Draft</span></span>         | <span data-ttu-id="08e1c-666">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-666">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="08e1c-667">Overig</span><span class="sxs-lookup"><span data-stu-id="08e1c-667">Other</span></span>              | <span data-ttu-id="08e1c-668">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-668">*Not supported by Mexico*</span></span> |

### <a name="bank-account-type"></a><span data-ttu-id="08e1c-669">Bankrekeningtype</span><span class="sxs-lookup"><span data-stu-id="08e1c-669">Bank account type</span></span>

<span data-ttu-id="08e1c-670">Bankrekeningtypen worden gebruikt voor elektronische betalingen aan werknemers.</span><span class="sxs-lookup"><span data-stu-id="08e1c-670">Bank account types are used for electronic payments to employees.</span></span> <span data-ttu-id="08e1c-671">Bankrekeningtypen worden toegewezen aan Dayforce als overdrachtrekeninggegevens.</span><span class="sxs-lookup"><span data-stu-id="08e1c-671">Bank account types are mapped to Dayforce as transfer account information.</span></span> <span data-ttu-id="08e1c-672">De bankrekeningtypen worden, waar nodig, vertaald naar de geaccepteerde waarden bij integratie.</span><span class="sxs-lookup"><span data-stu-id="08e1c-672">The bank account types are translated, as appropriate, to the accepted values upon integration.</span></span>

| <span data-ttu-id="08e1c-673">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-673">Human Resources</span></span>            | <span data-ttu-id="08e1c-674">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-674">Dayforce</span></span>                  |
|-------------------|---------------------------|
| <span data-ttu-id="08e1c-675">Betaalrekening</span><span class="sxs-lookup"><span data-stu-id="08e1c-675">Checking Account</span></span>  | <span data-ttu-id="08e1c-676">CheckingAccount</span><span class="sxs-lookup"><span data-stu-id="08e1c-676">CheckingAccount</span></span>           |
| <span data-ttu-id="08e1c-677">Salarisrekening</span><span class="sxs-lookup"><span data-stu-id="08e1c-677">Payroll Account</span></span>   | <span data-ttu-id="08e1c-678">PayrollAccount</span><span class="sxs-lookup"><span data-stu-id="08e1c-678">PayrollAccount</span></span>            |
| <span data-ttu-id="08e1c-679">Spaarrekening</span><span class="sxs-lookup"><span data-stu-id="08e1c-679">Savings Account</span></span>   | <span data-ttu-id="08e1c-680">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-680">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="08e1c-681">BankGirot-rekening</span><span class="sxs-lookup"><span data-stu-id="08e1c-681">BankGirot account</span></span> | <span data-ttu-id="08e1c-682">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-682">*Not supported by Mexico*</span></span> |
| <span data-ttu-id="08e1c-683">PlusGirot-rekening</span><span class="sxs-lookup"><span data-stu-id="08e1c-683">PlusGirot account</span></span> | <span data-ttu-id="08e1c-684">*Niet ondersteund door Mexico*</span><span class="sxs-lookup"><span data-stu-id="08e1c-684">*Not supported by Mexico*</span></span> |

### <a name="earning-codes"></a><span data-ttu-id="08e1c-685">Inkomstencodes</span><span class="sxs-lookup"><span data-stu-id="08e1c-685">Earning codes</span></span>

<span data-ttu-id="08e1c-686">Inkomstencodes bieden een unieke identificatie van elk type inkomsten dat medewerkers ontvangen.</span><span class="sxs-lookup"><span data-stu-id="08e1c-686">Earning codes uniquely identify every type of earnings that workers receive.</span></span> <span data-ttu-id="08e1c-687">De codes bevatten verschillende parameters die betrekking hebben op inkomsten, zoals boekhoudkundige regels, belastingwetgeving, rapportagevereisten en mogelijkheden voor gebruik van brutowaarden.</span><span class="sxs-lookup"><span data-stu-id="08e1c-687">The codes cover several parameters that are related to earnings, such as accounting rules, tax laws, reporting requirements, and gross-up capability.</span></span> <span data-ttu-id="08e1c-688">Als een niet-ondersteunde frequentie wordt gebruikt, wordt standaard de frequentie **Elke betaling** gebruikt voor de berekening.</span><span class="sxs-lookup"><span data-stu-id="08e1c-688">If an unsupported frequency is used, the **Every Pay** frequency is used by default for the calculation.</span></span>

#### <a name="supported-frequencies"></a><span data-ttu-id="08e1c-689">Ondersteunde frequenties</span><span class="sxs-lookup"><span data-stu-id="08e1c-689">Supported frequencies</span></span>

- <span data-ttu-id="08e1c-690">Alles</span><span class="sxs-lookup"><span data-stu-id="08e1c-690">All</span></span>
- <span data-ttu-id="08e1c-691">EVERYPAY</span><span class="sxs-lookup"><span data-stu-id="08e1c-691">EVERYPAY</span></span>
- <span data-ttu-id="08e1c-692">EACHPAYPERIOD</span><span class="sxs-lookup"><span data-stu-id="08e1c-692">EACHPAYPERIOD</span></span>
- <span data-ttu-id="08e1c-693">EVRYOTHRPAYODD</span><span class="sxs-lookup"><span data-stu-id="08e1c-693">EVRYOTHRPAYODD</span></span>
- <span data-ttu-id="08e1c-694">EVRYOTHRPAYEVN</span><span class="sxs-lookup"><span data-stu-id="08e1c-694">EVRYOTHRPAYEVN</span></span>
- <span data-ttu-id="08e1c-695">1OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-695">1OFMTH</span></span>
- <span data-ttu-id="08e1c-696">LASTOFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-696">LASTOFMTH</span></span>
- <span data-ttu-id="08e1c-697">2OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-697">2OFMTH</span></span>
- <span data-ttu-id="08e1c-698">3OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-698">3OFMTH</span></span>
- <span data-ttu-id="08e1c-699">4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-699">4OFMTH</span></span>
- <span data-ttu-id="08e1c-700">5OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-700">5OFMTH</span></span>
- <span data-ttu-id="08e1c-701">1N2OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-701">1N2OFMTH</span></span>
- <span data-ttu-id="08e1c-702">3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-702">3N4OFMTH</span></span>
- <span data-ttu-id="08e1c-703">1N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-703">1N3OFMTH</span></span>
- <span data-ttu-id="08e1c-704">1N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-704">1N4OFMTH</span></span>
- <span data-ttu-id="08e1c-705">2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-705">2N3OFMTH</span></span>
- <span data-ttu-id="08e1c-706">2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-706">2N4OFMTH</span></span>
- <span data-ttu-id="08e1c-707">1N2N3OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-707">1N2N3OFMTH</span></span>
- <span data-ttu-id="08e1c-708">1N2N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-708">1N2N4OFMTH</span></span>
- <span data-ttu-id="08e1c-709">1N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-709">1N3N4OFMTH</span></span>
- <span data-ttu-id="08e1c-710">2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-710">2N3N4OFMTH</span></span>
- <span data-ttu-id="08e1c-711">1N2N3N4OFMTH - 1N2N3N4OFMTH</span><span class="sxs-lookup"><span data-stu-id="08e1c-711">1N2N3N4OFMTH - 1N2N3N4OFMTH</span></span>
- <span data-ttu-id="08e1c-712">2N3N4N5OFMth - 2N3N4N5OFMth</span><span class="sxs-lookup"><span data-stu-id="08e1c-712">2N3N4N5OFMth - 2N3N4N5OFMth</span></span>
- <span data-ttu-id="08e1c-713">1OFQTR - 1OFQTR</span><span class="sxs-lookup"><span data-stu-id="08e1c-713">1OFQTR - 1OFQTR</span></span>
- <span data-ttu-id="08e1c-714">LASTOFQTR – LASTOFQTR</span><span class="sxs-lookup"><span data-stu-id="08e1c-714">LASTOFQTR – LASTOFQTR</span></span>
- <span data-ttu-id="08e1c-715">LASTMTHOFQTR – LASTMTHOFQTR</span><span class="sxs-lookup"><span data-stu-id="08e1c-715">LASTMTHOFQTR – LASTMTHOFQTR</span></span>
- <span data-ttu-id="08e1c-716">1OFYEAR - 1OFYEAR</span><span class="sxs-lookup"><span data-stu-id="08e1c-716">1OFYEAR - 1OFYEAR</span></span>
- <span data-ttu-id="08e1c-717">LASTOFYEAR – LASTOFYEAR</span><span class="sxs-lookup"><span data-stu-id="08e1c-717">LASTOFYEAR – LASTOFYEAR</span></span>
- <span data-ttu-id="08e1c-718">NOVNDECOFYEAR - NOVNDECOFYEAR</span><span class="sxs-lookup"><span data-stu-id="08e1c-718">NOVNDECOFYEAR - NOVNDECOFYEAR</span></span>

### <a name="addresses"></a><span data-ttu-id="08e1c-719">Adressen</span><span class="sxs-lookup"><span data-stu-id="08e1c-719">Addresses</span></span>

<span data-ttu-id="08e1c-720">De identificatie van specifieke codes voor land of regio, staat en district (gemeente) vereist specifieke indelingen die door Dayforce en providers in het land of in de regio kunnen worden herkend.</span><span class="sxs-lookup"><span data-stu-id="08e1c-720">The identification of specific country or region, state, and county (municipality) codes requires specific formats that Dayforce and in-country/in-region providers can recognize.</span></span> <span data-ttu-id="08e1c-721">Hoewel de indeling voor plaatsen flexibel is, moet elke plaats worden gekoppeld aan een staat.</span><span class="sxs-lookup"><span data-stu-id="08e1c-721">Although the format for cities is flexible, every city must be associated with a state.</span></span>

| <span data-ttu-id="08e1c-722">Human resources</span><span class="sxs-lookup"><span data-stu-id="08e1c-722">Human Resources</span></span>              | <span data-ttu-id="08e1c-723">Dayforce</span><span class="sxs-lookup"><span data-stu-id="08e1c-723">Dayforce</span></span>              |
|---------------------|-----------------------|
| <span data-ttu-id="08e1c-724">Land/regio</span><span class="sxs-lookup"><span data-stu-id="08e1c-724">Country/Region</span></span>      | <span data-ttu-id="08e1c-725">Landcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-725">Country Code</span></span>          |
| <span data-ttu-id="08e1c-726">Postcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-726">Zip/Postal Code</span></span>     | <span data-ttu-id="08e1c-727">Postcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-727">Postal Code</span></span>           |
| <span data-ttu-id="08e1c-728">Provincie</span><span class="sxs-lookup"><span data-stu-id="08e1c-728">State</span></span>               | <span data-ttu-id="08e1c-729">Staatcode</span><span class="sxs-lookup"><span data-stu-id="08e1c-729">State Code</span></span>            |
| <span data-ttu-id="08e1c-730">Plaats</span><span class="sxs-lookup"><span data-stu-id="08e1c-730">City</span></span>                | <span data-ttu-id="08e1c-731">Plaats</span><span class="sxs-lookup"><span data-stu-id="08e1c-731">City</span></span>                  |
| <span data-ttu-id="08e1c-732">District</span><span class="sxs-lookup"><span data-stu-id="08e1c-732">County</span></span>              | <span data-ttu-id="08e1c-733">District (gemeente)</span><span class="sxs-lookup"><span data-stu-id="08e1c-733">County (Municipality)</span></span> |
| <span data-ttu-id="08e1c-734">Adres</span><span class="sxs-lookup"><span data-stu-id="08e1c-734">Street</span></span>              | <span data-ttu-id="08e1c-735">Adresregel 1</span><span class="sxs-lookup"><span data-stu-id="08e1c-735">Address Line 1</span></span>        |
| <span data-ttu-id="08e1c-736">Huisnummer</span><span class="sxs-lookup"><span data-stu-id="08e1c-736">Street Number</span></span>       | <span data-ttu-id="08e1c-737">Adresregel 2</span><span class="sxs-lookup"><span data-stu-id="08e1c-737">Address Line 2</span></span>        |
| <span data-ttu-id="08e1c-738">Gebouwtoevoeging</span><span class="sxs-lookup"><span data-stu-id="08e1c-738">Building Complement</span></span> | <span data-ttu-id="08e1c-739">Adresregel 5</span><span class="sxs-lookup"><span data-stu-id="08e1c-739">Address Line 5</span></span>        |

### <a name="passport-number"></a><span data-ttu-id="08e1c-740">Paspoortnummer</span><span class="sxs-lookup"><span data-stu-id="08e1c-740">Passport number</span></span>

<span data-ttu-id="08e1c-741">Werknemers kunnen paspoortgegevens opgeven.</span><span class="sxs-lookup"><span data-stu-id="08e1c-741">Employees can declare passport information.</span></span> <span data-ttu-id="08e1c-742">Deze informatie is van het identificatietype **Paspoort** en wordt in Dayforce geïntegreerd als onderdeel van de Mexico-specifieke informatie van een werknemer.</span><span class="sxs-lookup"><span data-stu-id="08e1c-742">This information is of the **Passport** identification type and is integrated into Dayforce as part of an employee's Mexico-specific information.</span></span>

- <span data-ttu-id="08e1c-743">Identificatietype = 'Paspoort'</span><span class="sxs-lookup"><span data-stu-id="08e1c-743">Identification Type = "Passport"</span></span>
- <span data-ttu-id="08e1c-744">Uitgiftedatum</span><span class="sxs-lookup"><span data-stu-id="08e1c-744">Issued Date</span></span>
- <span data-ttu-id="08e1c-745">Vervaldatum</span><span class="sxs-lookup"><span data-stu-id="08e1c-745">Expiration Date</span></span>

<span data-ttu-id="08e1c-746">Werknemers kunnen meerdere identificatienummers van het identificatietype **Paspoort** opgeven.</span><span class="sxs-lookup"><span data-stu-id="08e1c-746">Employees can declare multiple identification numbers of the **Passport** identification type.</span></span> <span data-ttu-id="08e1c-747">Echter alleen de huidige actieve paspoortvermelding wordt geïntegreerd in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-747">However, only the current active passport entry is integrated into Dayforce.</span></span> <span data-ttu-id="08e1c-748">Als alle paspoortvermeldingen zijn verlopen, wordt het paspoort dat als laatste is uitgegeven geïntegreerd in Dayforce.</span><span class="sxs-lookup"><span data-stu-id="08e1c-748">If all passport entries are expired, the passport that was most recently issued is integrated into Dayforce.</span></span>
