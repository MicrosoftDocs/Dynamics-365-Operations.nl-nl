...
ms.locfileid: "6057401"
---
# <a name="example-query-for-recruiting-request"></a><span data-ttu-id="bc3a4-103">Voorbeeldquery voor wervingsaanvraag</span><span class="sxs-lookup"><span data-stu-id="bc3a4-103">Example query for Recruiting request</span></span>

[!include [Applies to Human Resources](../includes/applies-to-hr.md)]

<span data-ttu-id="bc3a4-104">Dit onderwerp geeft een voorbeeldquery voor de entiteit Wervingsaanvraag in Dynamics 365 Human Resources.</span><span class="sxs-lookup"><span data-stu-id="bc3a4-104">This topic provides an example query for the Recruiting request entity in Dynamics 365 Human Resources.</span></span>

<span data-ttu-id="bc3a4-105">De volgende query laat zien hoe u de optie $expand query in een GET-bewerking kunt gebruiken om een opgegeven wervingsaanvraagrecord op te halen en alle gekoppelde functies, vereiste vaardigheden en opleidingsvereisten voor de opgegeven aanvraag.</span><span class="sxs-lookup"><span data-stu-id="bc3a4-105">The following query shows how you can use the $expand query option in a GET operation to retrieve a specified recruiting request record and all associated positions, required skills, and educational requirements for the specified request.</span></span> <span data-ttu-id="bc3a4-106">In het voorbeeld wordt een wervingsaanvraag voor twee functies en de vereiste vaardigheden en opleiding voor de aangevraagde functies gegeven.</span><span class="sxs-lookup"><span data-stu-id="bc3a4-106">The example response shows a recruiting request for two positions, and the required skills and education for the requested positions.</span></span>

<span data-ttu-id="bc3a4-107">**Aanvragen**</span><span class="sxs-lookup"><span data-stu-id="bc3a4-107">**Request**</span></span>
...
<span data-ttu-id="bc3a4-108">**Antwoord**</span><span class="sxs-lookup"><span data-stu-id="bc3a4-108">**Response**</span></span>
...
## <a name="see-also"></a><span data-ttu-id="bc3a4-109">Zie ook</span><span class="sxs-lookup"><span data-stu-id="bc3a4-109">See also</span></span>

[<span data-ttu-id="bc3a4-110">Integratie-API voor sollicitantenvolgsysteem - Inleiding</span><span class="sxs-lookup"><span data-stu-id="bc3a4-110">Applicant Tracking System integration API introduction</span></span>](hr-admin-integration-ats-api-introduction.md)<br>
