...
description: Dit artikel bevat een API en een verwijzing naar aangepaste velden. Ook vindt u hier informatie over integratie met andere apps.
author: twheeloc
ms.date: 02/03/2020
ms.topic: overview
ms.prod: ''
...
Dit artikel bevat een API en een verwijzing naar aangepaste velden. Ook vindt u hier informatie over integratie met andere apps.

- [Overzicht](hr-developer-overview.md)

- [Uitbreiden met Power Apps en Power Automate](hr-developer-power-apps.md)

- [Human Resources-entiteiten in Dataverse](hr-developer-entities.md)

- [Aangepaste velden](hr-developer-custom-fields.md)
