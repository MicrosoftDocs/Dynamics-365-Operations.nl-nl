...
description: In dit artikel wordt uitgelegd hoe u prestaties optimaliseert wanneer u de BYOD-functie (Uw eigen database gebruiken) gebruikt met Microsoft Dynamics 365 Human Resources.
author: twheeloc
ms.date: 08/17/2020
ms.topic: article
ms.prod: ''
...
In dit artikel wordt uitgelegd hoe u prestaties optimaliseert wanneer u de BYOD-functie (Uw eigen database gebruiken) gebruikt. Meer informatie over BYOD vindt u in [Uw eigen database gebruiken (BYOD)](../fin-ops-core/dev-itpro/analytics/export-entities-to-your-own-database.md?toc=%2fdynamics365%2fhuman-resources%2ftoc.json).
