...
Wijzigingen die worden beschreven in deze sectie, gelden voor buildnummer 8.1.2604. De getallen tussen haakjes in sommige koppen verwijzen naar ondersteuningsnummers in Microsoft Dynamics Lifecycle Services (LCS).

### <a name="office-location-isnt-updated-via-excel-workbook-369727"></a>Kantoorlocatie wordt niet bijgewerkt via Excel-werkmap (369727)

Met deze wijziging kunt u de kantoorlocatie nu bijwerken met de ontwerper voor Office-werkmappen.
