...
> [!NOTE]
> Webcrawlers hebben geen gedefinieerde periode voor het crawlen van webpagina's of het bijwerken van zoekresultaten.
...
Met het werkgebied **Functiebeheer** in **Systeembeheer** kunt u functies weergeven, inschakelen, uitschakelen en plannen die in elke release zijn geleverd. Nieuwe functies zijn standaard uitgeschakeld. U kunt het werkgebied **Functiebeheer** gebruiken om deze in te schakelen en de bijbehorende documenten weer te geven.
...
De entiteit Uitgifteagentschap ondersteunt nu aangepaste velden.

### <a name="new-common-data-service-entities"></a>Nieuwe Common Data Service-entiteiten

De entiteit Taakgroep is toegevoegd.
...
### <a name="view-extended-information-about-report-performance-in-manager-self-service"></a>Uitgebreide informatie over prestaties van ondergeschikten in de selfservice-functionaliteit voor managers weergeven
