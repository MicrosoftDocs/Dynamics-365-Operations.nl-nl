...
ms.locfileid: "1616471"
---
# <a name="whats-new-or-changed-in-dynamics-365-for-talent-may-28-2019"></a>Wat is nieuw of gewijzigd in Dynamics 365 for Talent (28 mei 2019)
...
Wijzigingen die worden beschreven in deze sectie, gelden voor buildnummer 8.1.2319.
...
In deze versie bieden de volgende Common Data Service-entiteiten nu ondersteuning voor aangepaste velden: Details berekeningstarief vergoeding, Werkkalender feestdag en Aanstelling.

### <a name="copy-position-now-includes-payroll-details"></a>Positie kopiëren omvat nu salarisgegevens
Wanneer u **Positie kopiëren** gebruikt en alle opties selecteert, worden de salarisdetails nu opgenomen in de gekopieerde gegevens. 
...
Organisaties kunnen veel verschillende verloftypen aanbieden aan werknemers. Sommige van deze typen verlof zijn mogelijk niet geschikt voor werknemers en worden in plaats daarvan beheerd door Human Resources (HR). In deze versie kunt u configureren voor welke typen verlof werknemers verlofaanvragen kunnen indienen. 

### <a name="new-page-to-validate-position-hierarchy-data"></a>Nieuwe pagina voor validatie van positiehiërarchiegegevens

Human Resources en beheerders kunnen de managementhiërarchie valideren voor kringverwijzingen die onbedoeld zijn geïmporteerd. U kunt deze nieuwe pagina openen vanuit **Organisatiebeheer > Koppelingen > Posities > Validatie van positiehiërarchie**.
