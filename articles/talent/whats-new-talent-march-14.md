...
### <a name="performance-management-not-working-in-all-scenarios-when-using-duplicate-security-roles"></a>Prestatiebeheer werkt niet in alle scenario's bij het gebruik van dubbele beveiligingsrollen
Wijzigingen die zijn aangebracht in deze versie, maken prestatiebeheerscenario's mogelijk bij het gebruik van de out-of-the-box of dubbele rollen.
...
### <a name="office-location-update-switches-the-context-to-the-top-of-the-worker-list"></a>Met de kantoorlocatie-update wordt de context boven aan de lijst met werknemers geplaatst
Met de huidige versie wordt de context van de werknemer die u weergeeft bij het toewijzen van een kantoorlocatie, niet meer verplaatst.

### <a name="position-assignment-end-date-doesnt-display-correctly-on-worker-hire-and-transfer-actions"></a>De einddatum van positietoewijzing wordt niet correct weergegeven bij acties voor aanstelling en overplaatsing van werknemers
Einddatums voor positietoewijzing worden nu correct weergegeven op basis van de voorkeurstijdzone van de gebruiker bij het gebruik van acties.

### <a name="common-data-service-job-entity-doesnt-allow-job-type-and-job-function-fields-to-update"></a>Met de Common Data Service-taakentiteit kunnen de velden Taaktype en Taakfunctie niet worden bijgewerkt
Common Data Service-entiteiten worden nu correct gesynchroniseerd wanneer ze worden bijgewerkt met de Common Data Service.
