...
U kunt de bijgehouden gegevens bekijken in Power BI met de OData-connector. Zie [Verbinding maken met OData-feeds in Power BI Desktop](https://docs.microsoft.com/en-us/power-bi/desktop-connect-odata) voor meer informatie.
