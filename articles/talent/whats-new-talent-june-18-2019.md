...
---
# <a name="whats-new-or-changed-in-dynamics-365-talent-june-18-2019"></a>Nieuwe of gewijzigde functies in Dynamics 365 Talent (18 juni 2019)
...
De wijzigingen die worden beschreven in deze sectie, gelden voor buildnummer 8.1.2347.

### <a name="confirmation-of-course-participants-causes-an-error"></a>De bevestiging van cursisten veroorzaakt een fout

Het dialoogvenster voor het afdrukken van het rapport over cursisten is verwijderd. Dit rapport wordt niet ondersteund in Talent.

### <a name="the-compensation-section-of-the-transfer-worker-page-isnt-available-in-some-scenarios"></a>De sectie Compensatie van de pagina Medewerker overdragen is niet beschikbaar in sommige scenario's

Door deze wijziging kunnen gebruikers compensatiegegevens invoeren bij het invullen van de pagina **Medewerker overdragen**.
...
De volgende entiteiten ondersteunen aangepaste velden: Salarisinkomstencode en Compensatiereferentiepunt. 
