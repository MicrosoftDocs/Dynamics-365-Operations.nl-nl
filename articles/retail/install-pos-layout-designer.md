...
- Het programma wordt gestart en u wordt gevraagd contact op te nemen met de leverancier.
    ...
    **Oplossing:** Voeg in Internet Explorer de URL van Dynamics 365 for Retail toe aan uw vertrouwde sites. Klik op **Instelling** &gt; **Opties** &gt; **Beveiliging** &gt; **Vertrouwde sites** &gt; **Sites** &gt; **Toevoegen**.
