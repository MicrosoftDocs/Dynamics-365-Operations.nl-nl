...
- Online gegevens van de detailhandlestransactiegegevens ophalen in HQ.
- Orders synchroniseren voor het maken van verkooporders in HQ.

U kunt de gegevens van de online detailhandelstransactie ophalen door de P-taak handmatig uit te voeren of door een periodieke batchtaak te maken.

### <a name="manually-running-the-p-job"></a>De P-taak hand matiguitvoeren

1. Ga naar Alle werkgebieden > IT detailhandel.
...
3. Selecteer in het veld Organisatiehiërarchie 'Detailhandelwinkels per regio'.
