...
<span data-ttu-id="8a70d-105">Recency-/frequentie-/monetaire (RFM)-analyse is een marketinghulpmiddel dat uw organisatie kan gebruiken om de gegevens te beoordelen die door klantaankopen worden gegenereerd.</span><span class="sxs-lookup"><span data-stu-id="8a70d-105">Recency, frequency, and monetary (RFM) analysis is a marketing tool that your organization can use to evaluate the data that is generated by customer purchases.</span></span> <span data-ttu-id="8a70d-106">Nadat u RFM analyse instelt, krijgen klanten een berekende RFM-score wanneer ze aankopen doen.</span><span class="sxs-lookup"><span data-stu-id="8a70d-106">After you set up RFM analysis, customers are assigned a calculated RFM score as they make purchases.</span></span> <span data-ttu-id="8a70d-107">De RFM-score kan een beoordeling zijn met drie cijfers of een samengeteld cijfer zijn, zijn afhankelijk van hoe uw organisatie RFM-analyse heeft geconfigureerd.</span><span class="sxs-lookup"><span data-stu-id="8a70d-107">The RFM score can be a three-digit rating or an aggregate number, depending on how your organization has configured RFM analysis.</span></span> <span data-ttu-id="8a70d-108">Als uw organisatie een beoordeling met drie cijfers voor de score gebruikt, werkt dit als volgt:</span><span class="sxs-lookup"><span data-stu-id="8a70d-108">Here’s how the rating works if your organization uses a three-digit rating for the score:</span></span>

- <span data-ttu-id="8a70d-109">Het eerste cijfer is de recencybeoordeling, waarmee wordt aangegeven hoe recent de klant een aankoop heeft gedaan bij uw organisatie.</span><span class="sxs-lookup"><span data-stu-id="8a70d-109">The first digit is the customer's recency rating, which is how recently the customer made a purchase from your organization.</span></span> 
- <span data-ttu-id="8a70d-110">Het tweede cijfer is de frequentiebeoordeling, waarmee wordt aangegeven hoe vaak de klant iets aanschaft van uw organisatie.</span><span class="sxs-lookup"><span data-stu-id="8a70d-110">The second digit is the customer's frequency rating, which is how often the customer makes purchases from your organization.</span></span> 
- <span data-ttu-id="8a70d-111">Het derde cijfer is de monetaire beoordeling, waarmee wordt aangegeven hoeveel de klant uitgeeft wanneer deze iets aanschaft van uw organisatie.</span><span class="sxs-lookup"><span data-stu-id="8a70d-111">The third digit is the customer's monetary rating, which is how much the customer spends when he makes purchases from your organization.</span></span> 

<span data-ttu-id="8a70d-112">Uw organisatie heeft bijvoorbeeld de beoordelingen op een schaal van 1 tot 5 ingesteld, waar 5 het hoogste cijfer is.</span><span class="sxs-lookup"><span data-stu-id="8a70d-112">For example, your organization has set the ratings on a scale of 1 through 5, where 5 is the highest rating.</span></span> <span data-ttu-id="8a70d-113">In dit geval geeft een klantbeoordeling van 535 u de volgende informatie over de klant:</span><span class="sxs-lookup"><span data-stu-id="8a70d-113">In this case, a customer rating of 535 tells you the following information about the customer:</span></span>

-   <span data-ttu-id="8a70d-114">**Recencyscore van 5** – De klant heeft onlangs een aankoop gedaan.</span><span class="sxs-lookup"><span data-stu-id="8a70d-114">**Recency rating of 5** – The customer recently made a purchase.</span></span>
-   <span data-ttu-id="8a70d-115">**Frequentiebeoordeling van 3** – De klant koopt redelijk vaak producten van uw organisatie.</span><span class="sxs-lookup"><span data-stu-id="8a70d-115">**Frequency rating of 3** – The customer purchases products from your organization moderately often.</span></span>
-   <span data-ttu-id="8a70d-116">**Monetaire score van 5** - Wanneer de klant een inkoop doet, geeft deze een aanzienlijk bedrag uit.</span><span class="sxs-lookup"><span data-stu-id="8a70d-116">**Monetary rating of 5** – When the customer makes a purchase, he spends a significant amount of money.</span></span>

<span data-ttu-id="8a70d-117">Als uw organisatie een samengeteld cijfer gebruikt voor de score, worden de individuele beoordelingen samengevoegd.</span><span class="sxs-lookup"><span data-stu-id="8a70d-117">If your organization uses an aggregate number for the score, the individual ratings are added together.</span></span> <span data-ttu-id="8a70d-118">Voor hetzelfde voorbeeld heeft de klant een beoordeling van 13 (5 + 3 + 5).</span><span class="sxs-lookup"><span data-stu-id="8a70d-118">For the same example, the customer has a rating of 13 (5 + 3 + 5).</span></span>

## <a name="to-set-up-rfm-analysis-for-the-customers-in-your-organization"></a><span data-ttu-id="8a70d-119">RFM-analyse voor de klanten in uw organisatie instellen</span><span class="sxs-lookup"><span data-stu-id="8a70d-119">To set up RFM analysis for the customers in your organization.</span></span>

1.  <span data-ttu-id="8a70d-120">Ga naar **Callcenter** > **Periodiek** > **RFM-analyse**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-120">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="8a70d-121">Op de pagina **RFM-analyse** selecteert u **Nieuw**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-121">On **RFM analysis** page, select **New**.</span></span> <span data-ttu-id="8a70d-122">Voer in het veld **RFM-definitie** een naam voor de RFM-definitie in.</span><span class="sxs-lookup"><span data-stu-id="8a70d-122">In the **RFM definition** field, enter a name for the RFM definition.</span></span> <span data-ttu-id="8a70d-123">U kunt bijvoorbeeld, kunt u de definitie RFM-A noemen.</span><span class="sxs-lookup"><span data-stu-id="8a70d-123">For example, you could call the definition RFM-A.</span></span>

3.  <span data-ttu-id="8a70d-124">Voer een begin- en einddatum voor deze RFM-definitie in.</span><span class="sxs-lookup"><span data-stu-id="8a70d-124">Enter a start date and end date for this RFM definition.</span></span>

4.  <span data-ttu-id="8a70d-125">Doe op het sneltabblad **Algemeen** het volgende:</span><span class="sxs-lookup"><span data-stu-id="8a70d-125">On the **General** FastTab, do the following:</span></span> 
...
1.  <span data-ttu-id="8a70d-156">Ga naar **Callcenter** > **Journalen** > **Klantenservice**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-156">Go to **Call center** > **Journals** > **Customer service**.</span></span> 

2.  <span data-ttu-id="8a70d-157">Selecteer op de pagina **Klantenservice** in het deelvenster **Klantenservice** in de zoekvelden het type trefwoord om op te zoeken en voer de zoektekst in.</span><span class="sxs-lookup"><span data-stu-id="8a70d-157">On the **Customer service** page, in the **Customer service** pane, in the search fields, select the keyword type to search on and enter the search text.</span></span>

3.  <span data-ttu-id="8a70d-158">Selecteer **Zoeken**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-158">Select **Search**.</span></span>

4.  <span data-ttu-id="8a70d-159">Selecteer op de pagina **Klant zoeken** de gewenste klantrecord en klik op **Klant selecteren**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-159">On the **Customer search** page, select the customer record that you want, and then click **Select customer**.</span></span> 

<span data-ttu-id="8a70d-160">De RFM-score wordt weergegeven in de groep **Orderhistorie** rechts op de pagina **Klantenservice**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-160">The RFM score is displayed in the **Order history** group on the right side of the **Customer service** page.</span></span> 

## <a name="view-or-clear-the-history-of-an-rfm-analysis-record"></a><span data-ttu-id="8a70d-161">Weergeef of wis de historie van een RFM-analyserecord</span><span class="sxs-lookup"><span data-stu-id="8a70d-161">View or clear the history of an RFM analysis record</span></span>
<span data-ttu-id="8a70d-162">Met deze procedure kunt u de historie van een FRM-analyse record weergeven of wissen.</span><span class="sxs-lookup"><span data-stu-id="8a70d-162">Use this procedure to view or clear the history of an RFM analysis record.</span></span> 

1.  <span data-ttu-id="8a70d-163">Ga naar **Callcenter** > **Periodiek** > **RFM-analyse**.</span><span class="sxs-lookup"><span data-stu-id="8a70d-163">Go to **Call center** > **Periodic** > **RFM analysis**.</span></span>

2.  <span data-ttu-id="8a70d-164">Selecteer op de pagina **RFM-analyse** de record die u wilt weergeven.</span><span class="sxs-lookup"><span data-stu-id="8a70d-164">On the **RFM analysis** page, select the record that you want to view.</span></span>

3.  <span data-ttu-id="8a70d-165">Selecteer het sneltabblad **Historie** om de recordhistorie te bekijken.</span><span class="sxs-lookup"><span data-stu-id="8a70d-165">To view the record history, select the **History** FastTab.</span></span>

4.  <span data-ttu-id="8a70d-166">Selecteer **Historie wissen** om de recordhistorie te wissen.</span><span class="sxs-lookup"><span data-stu-id="8a70d-166">To clear the history of the record, select **Clear history**.</span></span>
