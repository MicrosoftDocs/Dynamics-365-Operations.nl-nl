...
In dit scenario wordt uitgelegd wat er gebeurt als de optie **Naar rato verdelen voor overeenkomende verkoopregels** is ingesteld op **Nee** in de instellingen voor automatische toeslagen. (De werking is gelijk aan de werking van toeslagen op koptekstniveau in eerdere Retail-versies dan versie 10.0.1.)
...
2. Er wordt gezocht naar de configuratie van automatische toeslagen op koptekstniveau die overeenkomt met de instellingen voor klant en leveringsmethode voor elke groep artikelen. Als de configuratie wordt gevonden, wordt gezocht in de gelaagde configuratie om de toeslagen te vinden die moeten worden toegepast, gebaseerd op de totale productwaarde van artikelen in de leveringsmethodegroep.
    ...
    **Leveringsmethode 11**
    ...
    - Totale productwaarde detailhandel = € 70
    - **Toeslagwaarde = € 7**

    **Leveringsmethode 99**

    - Totale productwaarde detailhandel = € 80
    - **Toeslagwaarde = € 15**

    **Leveringsmethode 21**

    - Totale productwaarde detailhandel = € 15
