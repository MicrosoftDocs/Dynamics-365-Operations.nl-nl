...
# <a name="work-with-call-center-order-holds"></a>Werken met callcenterorderwachtstanden

[!include [banner](includes/banner.md)]

Dit onderwerp beschrijft de functies voor orderwachtstanden die Microsoft Dynamics 365 for Retail heeft voor callcenterorders.
...
Als u een optionele reeks wachtstandredencodes wilt maken, gaat u naar **Detailhandel** \> **Afzetkanaalinstellingen** \> **Infocodes**. Deze informatiecodes kunnen worden gebruikt als een secundaire redencode om de hoofdwachtstandcode verder te definiëren. Selecteer **Nieuw** om een redencodeset te maken en selecteer vervolgens **Subcodes** om de lijst met extra redenen te definiëren. Als u informatiecodes die u definieert, wilt koppelen aan het callcenterkanaal, gaat u naar **Detailhandel** \> **Afzetkanalen** \> **Callcenters** \> **Alle callcenters**. Stel op het sneltabblad **Algemeen** het veld **Wachtstandcode** in.

## <a name="putting-orders-on-hold"></a>Verkooporders in de wachtstand plaatsen

Orders die callcentergebruikers maken in het back-office Retail-programma, kunnen handmatig in de wachtstand worden geplaatst of automatisch in bepaalde situaties.
...
Als u alle orders wilt weergeven die handmatig of automatisch in de wachtstand zijn gezet, gaat u naar **Detailhandel** \> **Klanten** \> **Orderwachtstanden**.
...
Ga naar **Detailhandel** \> **Query's en rapporten** \> **Callcenterrapporten** \> **Rapport Orderwachtstanden** als u een rapport wilt uitvoeren over orderwachtstanden op datumbereik, wachtstandcode of andere gerelateerde criteria.
