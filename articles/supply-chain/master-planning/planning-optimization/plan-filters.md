...
description: In dit artikel wordt uitgelegd hoe u filters gebruikt voor een plan wanneer de functionaliteit Planningsoptimalisatie wordt gebruikt.
author: t-benebo
ms.date: 01/08/2020
ms.topic: article
ms.prod: ''
