...
description: In dit artikel wordt uitgelegd hoe u producten opneemt op basis van de levenscyclusstatus wanneer de functie Planningsoptimalisatie wordt gebruikt.
author: t-benebo
ms.date: 11/13/2020
ms.topic: article
ms.prod: ''
