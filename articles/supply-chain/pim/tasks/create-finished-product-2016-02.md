...
---
# <a name="create-a-finished-product-february-2016"></a>Een eindproduct maken (februari 2016)
...
3. Typ een waarde in het veld Productnummer.
    * Typ voor de demonstratie: 'Stuklijst_1'.  
...
11. Selecteer in het veld Standaardordertype: 'Productie'.
    * Omdat dit een eindproduct is dat wordt geproduceerd, selecteert u 'Productie'.  
12. Typ of selecteer een waarde in het veld Inkoopvestiging.
    * Selecteer voor de demonstratie: 'Locatie 1'.  
