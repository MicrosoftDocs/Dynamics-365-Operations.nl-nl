...
description: In dit artikel wordt beschreven hoe u een productnummernomenclatuur instelt om de vaste indeling [productmodelnummer - configuratie - maat - kleur - stijl] te vervangen.
author: t-benebo
ms.date: 11/03/2017
ms.topic: article
ms.prod: ''
