...
description: Dit artikel bevat informatie over de verschillende entiteiten die kunnen worden gebruikt voor het importeren en exporteren van productgegevens.
author: t-benebo
ms.date: 01/07/2020
ms.topic: article
ms.prod: ''
