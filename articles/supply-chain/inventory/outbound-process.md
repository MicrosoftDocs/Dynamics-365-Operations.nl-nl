...
description: Dit artikel biedt een overzicht van het uitgaande proces in Voorraadbeheer.
author: yufeihuang
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
ms.locfileid: "8852471"
---
# <a name="outbound-process-overview"></a>Overzicht van uitgaand proces

[!include [banner](../includes/banner.md)]

Dit artikel biedt een overzicht van het uitgaande proces in Voorraadbeheer.
