...
1. Maak afzonderlijke werkklassen voor de werkordertypen _Kwaliteit artikelbemonstering_ en _Kwaliteitsorder_. Op deze manier zorgt u ervoor dat het juiste werk automatisch kan worden gegenereerd op basis van de twee werkordertypen en dat dit werk vervolgens kan worden uitgevoerd met de magazijnapp.
...
Terwijl werknemers artikelen ontvangen met de magazijnapp, controleert het systeem of er een kwaliteitskoppeling is ingesteld voor elk binnenkomend artikel. Als er een kwaliteitskoppeling is ingesteld, gebruikt het systeem de artikelbemonsterings record die voor die kwaliteitskoppeling is geconfigureerd om te bepalen hoe kwaliteitsorders, bemonsteringswerk voor kwaliteitsartikelen en werk voor inkooporders worden gemaakt.
...
|---|---|---|---|---|---|---|
| Order | Volledige nummerplaat | Ja _(vergrendeld/niet bewerkbaar)_ | <p>Locatie: Ja</p><p>Nummerplaat: Ja _(vergrendeld/niet bewerkbaar)_</p> | No | 3 | <p>**Hoeveelheid orderregel: 100 EA**</p><ol><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 20 EA</p><p>Kwaliteitsorder 1 voor 20 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP2<p>Inkooporderwerk voor 20 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP3<p>Inkooporderwerk voor 20 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP4<p>Bemonsteringswerk van kwaliteitsartikel voor 20 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP5<p>Inkooporderwerk voor 20 EA (opslag)</p></li></ol> |
| Order | Vaste hoeveelheid = 1 | Ja | <p>Locatie: Ja</p><p>Nummerplaat: Ja</p> | No | Niet van toepassing | <p>**Hoeveelheid orderregel: 100**</p><ol><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 1 EA</p><p>Kwaliteitsorder 1 voor 1 EA</p><p>Inkooporderwerk voor 19 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP2<p>Bemonsteringswerk van kwaliteitsartikel voor 1 EA</p><p>Kwaliteitsorder 1 voor 1 EA</p><p>Inkooporderwerk voor 19 (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP3<p>Bemonsteringswerk van kwaliteitsartikel voor 1 EA</p><p>Kwaliteitsorder 1 voor 1 EA</p><p>Inkooporderwerk voor 19 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP4<p>Bemonsteringswerk van kwaliteitsartikel voor 1 EA</p><p>Kwaliteitsorder 1 voor 1 EA</p><p>Inkooporderwerk voor 19 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 20 EA, LP5<p>Bemonsteringswerk van kwaliteitsartikel voor 1 EA</p><p>Kwaliteitsorder 1 voor 1 EA</p><p>Inkooporderwerk voor 19 EA (opslag)</p></li></ol> |
| Order | Procent = 10 | No | <p>Locatie: Nee</p><p>Nummerplaat: Nee</p> | No | Niet van toepassing | <p>**Hoeveelheid orderregel: 100 EA**</p><ol><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 10 EA</p><p>Kwaliteitsorder 1 voor 10 EA</p><p>Inkooporderwerk voor 40 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP2<p>Inkooporderwerk voor 50 EA (opslag)</p></li></ol> |
| Inlezen | Procent = 5 | Ja _(vergrendeld/niet bewerkbaar)_ | <p>Locatie: Nee</p><p>Nummerplaat: Nee</p> | No | Niet van toepassing | <p>**Hoeveelheid orderregel: 500 EA**</p><p>**Twee ladingen: eerste lading 200 EA, tweede lading 300 EA**</p><ol><li>Registreer de ontvangst in de magazijnapp voor de eerste lading voor 100 EA<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 95 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor de eerste lading voor 100 EA<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 95 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor de tweede lading voor 300 EA<p>Bemonsteringswerk van kwaliteitsartikel voor 15 EA</p><p>Kwaliteitsorder 1 voor 15 EA</p><p>Inkooporderwerk voor 285 EA (opslag)</p></li></ol> |
| Order | Procent = 10 | No | <p>Locatie: Ja</p><p>Nummerplaat: Ja</p> | No | Niet van toepassing | <p>**Hoeveelheid orderregel: 100**</p><ol><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 45 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP2<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 45 (opslag)</p></li></ol> |
| Inlezen | Volledige nummerplaat | Ja _(vergrendeld/niet bewerkbaar)_ | <p>Locatie: Ja</p><p>Nummerplaat: Ja _(vergrendeld/niet bewerkbaar)_</p> | No | 3 | <p>**Twee artikelen:**</p><ul><li>**Hoeveelheid voor orderregel voor artikel A: 120 EA (4 pallets)**</li><li>**Hoeveelheid voor orderregel voor artikel B: 90 EA (3 pallets)**</li></ul><p>**Eén lading, twee laadregels met elke orderregel**</p><ol><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP2<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP3<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP4<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel B, 30 EA, LP5<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel B, 30 EA, LP6<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP7<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li></ol> |
| Inlezen | Volledige nummerplaat | Ja _(vergrendeld/niet bewerkbaar)_ | <p>Locatie: Ja</p><p>Nummerplaat: Ja _(vergrendeld/niet bewerkbaar)_</p> | Ja | 3 | <p>**Twee artikelen:**</p><ul><li>**Hoeveelheid voor orderregel voor artikel A: 120 EA (4 pallets)**</li><li>**Hoeveelheid voor orderregel voor artikel B: 90 EA (3 pallets)**</li></ul><p>**Eén lading, twee laadregels met elke orderregel**</p><ol><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP2<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP3<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP4<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel B, 30 EA, LP5<p>Bemonsteringswerk van kwaliteitsartikel voor 30 EA</p><p>Kwaliteitsorder 1 voor 30 EA</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel B, 30 EA, LP6<p>Inkooporderwerk voor 30 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor artikel A, 30 EA, LP7<p>Inkooporderwerk voor 30 EA (opslag)</p></li></ol> |
| Inlezen | Procent = 10 | Ja _(vergrendeld/niet bewerkbaar)_ | <p>Locatie: Nee</p><p>Nummerplaat: Nee</p> | No | Niet van toepassing | <p>**Hoeveelheid orderregel: 100 EA**</p><p>**Er worden geen ladingen gemaakt. Orderbereik wordt toegepast.**</p><ol><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP1<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 45 EA (opslag)</p></li><li>Registreer de ontvangst in de magazijnapp voor 50 EA, LP2<p>Bemonsteringswerk van kwaliteitsartikel voor 5 EA</p><p>Kwaliteitsorder 1 voor 5 EA</p><p>Inkooporderwerk voor 45 EA (opslag)</p></li></ol> |
...
Er is nu een inkooporder voor een hoeveelheid van 10 stuks van artikel A0001 gemaakt voor leverancier 104. Vervolgens wordt met behulp van de magazijnapp een inkooporderregel met een hoeveelheid van 10 als ontvangen geregistreerd op één nummerplaat. Hier volgt het resultaat:
...
1. Ga naar een mobiel apparaat of emulator waarin de magazijnapp wordt uitgevoerd en meld u aan bij magazijn 51 met *51* als gebruikers-id en *1* als wachtwoord.
...
1. Meld u af bij de magazijnapp.
