...
description: In dit artikel wordt beschreven hoe u testvariabelen maakt die kunnen worden gebruikt voor het kwalitatief testen van kwaliteitsorders in Microsoft Dynamics 365 Supply Chain Management.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8857629"
---
# <a name="quality-management-test-variables"></a>Testvariabelen voor kwaliteitsbeheer

[!include [banner](../includes/banner.md)]

In dit artikel wordt beschreven hoe u testvariabelen maakt die kunnen worden gebruikt voor het kwalitatief testen van kwaliteitsorders in Microsoft Dynamics 365 Supply Chain Management.
