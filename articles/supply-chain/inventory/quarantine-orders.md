...
description: In dit artikel wordt beschreven hoe quarantaineorders kunnen worden gebruikt om voorraad te blokkeren.
author: yufeihuang
ms.date: 03/23/2021
ms.topic: article
ms.prod: ''
...
In dit artikel wordt beschreven hoe quarantaineorders kunnen worden gebruikt om voorraad te blokkeren.
