...
description: In dit artikel wordt het proces voor het onboarden van nieuwe leveranciers beschreven. Hier wordt uitgelegd welke acties vereist zijn voor de verschillende rollen tijdens dit proces.
...
Voor een snelle demonstratie van het onboardingproces van leveranciers, bekijkt u deze korte YouTube-video: [Een nieuwe leverancier onboarden in apps voor financiën en bedrijfsactiviteiten](https://www.youtube.com/watch?v=0KUc3AGaTKk).
