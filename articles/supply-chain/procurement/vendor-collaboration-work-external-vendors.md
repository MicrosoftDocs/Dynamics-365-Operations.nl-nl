...
In deze sectie wordt de interactie tussen klanten en leveranciers tijdens het proces voor offerteaanvragen beschreven. Ook wordt uitgelegd hoe informatie wordt overgebracht naar de leveranciers. Zie voor een algemeen overzicht van ondersteuning voor het proces voor offerteaanvragen [Offerteaanvragen (RFQ's)](request-quotations.md).
