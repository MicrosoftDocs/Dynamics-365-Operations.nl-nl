...
description: In dit artikel wordt beschreven hoe u kortingsbeheergroepen instelt. Kortingsbeheergroepen kunnen worden gebruikt tijdens kortingsberekeningen en kunnen aan een hoofdrecord worden gekoppeld.
author: sherry-zheng
ms.date: 02/19/2021
ms.topic: article
ms.prod: ''
