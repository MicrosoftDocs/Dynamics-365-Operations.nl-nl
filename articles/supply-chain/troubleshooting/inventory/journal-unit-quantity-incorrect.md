...
1. Zorg er in het werkgebied **Functiebeheer** voor dat de functie *Maateenheid en hoeveelheid per eenheid in voorraadjournalen gebruiken* is ingeschakeld. Met deze functie voegt u de velden **Eenheid** en **Hoeveelheid per eenheid** aan het journaal toe. (Vanaf Supply Chain Management versie 10.0.21 is deze functie standaard ingeschakeld.)
