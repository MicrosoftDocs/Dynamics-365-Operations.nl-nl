...
description: In dit artikel wordt beschreven hoe u algemene waarden instelt die worden gebruikt voor parameters in verschillende onderdelen van technisch wijzigingsbeheer.
author: t-benebo
ms.date: 09/28/2020
ms.topic: article
ms.prod: ''
