...
De werkelijke waarde van het actieve ingrediënt voor een batch zoeken en bewerken:
1. Ga naar **Voorraadbeheer \> Query's en rapporten \> Traceerdimensies \> Batches**.
1. Selecteer een batchnummer in het raster.
1. Open in het actievenster het tabblad **Weergeven** en selecteer **Voorraadbatchkenmerken**.
...
| None | V | 20 | Liter |
| Actief | B | 30 | Liter |
| Compenseren | C | 10 | Liter |
| Opvulling | D | 40 | Liter |

In de volgende tabel vindt u een overzicht van de resultaten van elk voorbeeld.
...
| C | Compenseren | 10 | 14.72 | | Liter | |
| D | Opvulling | 40 | 39.57 | | Liter | |

### <a name="active-ingredients"></a>Actieve ingrediënten
...
#### <a name="active-ingredient-example"></a>Voorbeeld van actief ingrediënt
...
### <a name="none-ingredients"></a>Geen ingrediënten
...
#### <a name="none-ingredient-example"></a>Voorbeeld van geen ingrediënt
...
### <a name="compensating-ingredients"></a>Compensatie-ingrediënten
...
1. Selecteer **Productiegegevensbeheer \> Stuklijsten en formules \> Formules**.
1. Open een formuleregel en selecteer **Ingrediënten** om de pagina **Compensatiemethode** te openen.
1. Selecteer de regel die een compensatiemethode aangeeft en selecteer vervolgens het actieve ingrediënt om te compenseren.
...
#### <a name="compensating-ingredient-example"></a>Voorbeeld van compensatie-ingrediënt
...
1. Het resultaat wordt vermenigvuldigd door de compensatiefactor:  
    4,29 × 1.10 = –4,72

1. De geraamde hoeveelheid van de compensatie wordt verminderd met –4,72 om de verdeelde compensatiehoeveelheid te bepalen :  
    10 – (–4,72) = 14,72
...
### <a name="filler-ingredients"></a>Vul-ingrediënten
...
#### <a name="filler-ingredient-example"></a>Voorbeeld van vul-ingrediënt
...
1. Bevestigen en de formule vrijgeven
