...
## <a name="turn-on-new-features-in-feature-management"></a>Nieuwe functies in Functiebeheer inschakelen

Een aantal van de instellingen die in dit onderwerp worden beschreven, moet op uw systeem worden ingeschakeld voordat deze voor u beschikbaar zijn. Gebruik de pagina [Functiebeheer](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) om desgewenst een of meer van de volgende functies in te schakelen.
...
Als u deze functie beschikbaar wilt maken, schakelt u de volgende functie in [Functiebeheer](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md) in:
