...
| **Opmerking**                                                                                                                                                                                                                      |
|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Aan een werknemer kunnen automatisch de tijdregistraties worden toegewezen die voor een bepaalde machine op de werkvloer zijn gemaakt, als de werknemer ervoor kiest als assistent van de machine te werken wanneer hij/zij de productietaak start. |
