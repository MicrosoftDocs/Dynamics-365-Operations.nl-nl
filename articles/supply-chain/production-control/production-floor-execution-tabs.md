...
description: In dit artikel wordt beschreven hoe u de inhoud van de gebruikersinterface ontwerpt voor elke configuratie.
...
1. Geef de koptekst van de pagina de volgende instellingen:
    ...
    - **Hoofdweergave**: maak een selectie uit de vooraf gedefinieerde takenlijsten (*Actieve taken*, *Alle taken*, *Mijn taken* en *Mijn machine*).
