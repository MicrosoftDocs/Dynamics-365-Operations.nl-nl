...
In de volgende afbeelding is (a) de stuklijst voor het product H en de onderdelen F en G, en is (b) het routeblad voor product H en onderdeel F.

![Voorbeeld van een stuklijststructuur op twee niveaus.](media/product-H-part-F.png)
...
![De technische stuklijst voor product H.](media/product-H-part-B.png)
...
![Het phantom-regeltype dat wordt gebruikt in stuklijststructuren met meerdere niveaus.](media/product-G-route-sheet-G.png)
...
![Voorbeeld van een routenetwerk dat wordt gebruikt in een stuklijst met meerdere niveaus.](media/product-G-part-F.png)
...
![De stuklijst voor product G en deel F en het routeblad voor product G en deel F.](media/product-G-part-F-with-route-sheet.png)
