...
## <a name="create-property"></a>Eigenschap maken
1. Klik op Nieuw.
2. Typ een waarde in het veld Eigenschap.
3. Typ een waarde in het veld Naam.

## <a name="create-property-values"></a>Eigenschapswaarden maken
