---
title: Opslag van voorraadverouderingsrapporten
description: In dit artikel wordt de functionaliteit beschreven waarmee u een naar ouderdom gerangschikt voorraadrapport kunt uitvoeren en de uitvoer beschikbaar kunt maken als een formulier en een grafiek.
author: JennySong-SH
ms.date: 11/11/2019
ms.topic: article
ms.prod: ''
