...
ms.locfileid: "9334980"
---
# <a name="compare-item-prices-storage-report"></a>Rapport Opslag artikelprijzen vergelijken

[!include [banner](../includes/banner.md)]

In dit artikel wordt uitgelegd hoe u een rapport **Opslag van artikelprijzen vergelijken** kunt uitvoeren en de uitvoer in digitale vorm beschikbaar kunt maken, als een interactieve pagina in Dynamics 365 Supply Chain Management of als een geëxporteerd document in verschillende indelingen.
...
## <a name="turn-the-compare-item-prices-storage-feature-on-or-off"></a>De functie Opslag van artikelprijzen vergelijken in- of uitschakelen

Voordat u de functie kunt gebruiken, moet deze zijn ingeschakeld voor uw systeem. Vanaf Supply Chain Management versie 10.0.29 is de functie verplicht en deze functie kan niet worden uitgeschakeld. Als u een versie ouder dan 10.0.29 gebruikt, kunnen beheerders deze functionaliteit in- of uitschakelen door te zoeken naar de functie *Opslag van artikelprijzen vergelijken* in de werkruimte [Functiebeheer](../../fin-ops-core/fin-ops/get-started/feature-management/feature-management-overview.md).
