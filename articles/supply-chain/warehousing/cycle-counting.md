...
<tr class="odd">
<td>Artikel</td>
<td>Het artikel moet ingeschakeld zijn voor magazijnbeheerprocessen (WMS).</td>
</tr>
<tr class="even">
<td>Magazijn</td>
<td>Het magazijn moet ingeschakeld zijn voor magazijnbeheerprocessen (WMS). Om het magazijn in te schakelen voor WMS, selecteert u het magazijn op de pagina <strong>Magazijnen</strong> en selecteert u vervolgens de optie <strong>Magazijnbeheerprocessen gebruiken</strong>. Als u wilt dat werknemers palleten kunnen verplaatsen tijdens een cyclustelling, schakelt u op het sneltabblad <strong>Magazijnbeheer</strong> de optie <strong>Palletverplaatsingen gedurende cyclustelling toestaan</strong> in.</td>
</tr>
<tr class="odd">
<td>Werkgroepen</td>
