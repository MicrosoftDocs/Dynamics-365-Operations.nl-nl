...
description: Dit artikel biedt informatie over de pagina Details werkregel, waarin een uitgebreide, sorteerbare en filterbare lijst met afzonderlijke werkregels in het systeem wordt weergegeven.
author: Mirzaab
ms.date: 07/01/2020
ms.topic: article
ms.prod: ''
