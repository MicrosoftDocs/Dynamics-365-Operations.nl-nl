...
1. Stel op de nieuwe regel de volgende waarden in:
    ...
    - **Maateenheid niveau:** _EaBoxPl_
        ...
        Dit veld bepaalt de maateenheden van vraag die geldig zijn voor de regel. (Voor meer informatie, zie de sectie [Niveaus van maateenheden maken voor vakken](#unit-tiers) eerder in dit artikel.)
