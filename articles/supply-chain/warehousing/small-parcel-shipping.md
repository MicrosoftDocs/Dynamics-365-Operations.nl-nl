...
Zie de volgende artikelen voor informatie over het maken en implementeren van functionele tarief-engines zodat deze kunnen worden gebruikt in een productie- of testomgeving:
...
In dit voorbeeldscenario wordt getoond hoe u de functie voor verzending van kleine pakketten kunt instellen en gebruiken nadat u het systeem hebt voorbereid, zoals eerder in dit artikel is beschreven. Dit scenario gebruikt de eerder genoemde demonstratietarief-engine.
...
1. Als u nog geen ZPL-printerdefinitie hebt ingesteld, gebruikt u de toepassing Documentrouteringsagent om deze in te stellen. Zie [Overzicht van Documenten afdrukken](../../fin-ops-core/dev-itpro/analytics/print-documents.md) en gerelateerde artikelen voor meer informatie.
