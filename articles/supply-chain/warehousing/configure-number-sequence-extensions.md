...
description: In dit artikel komt aan de orde welke functies nummerreeksuitbreidingen bieden voor nummerplaat-id's, wavelabel-id's, container-id's en vrachtbrief-id's.
author: Mirzaab
ms.date: 06/10/2020
ms.topic: article
ms.prod: ''
...
- De configuratie van de id-nummers van nummerplaten is flexibel. U kunt bijvoorbeeld toepassings-id's (AI) opnemen of uitsluiten, zoals voorloopnullen (00).
