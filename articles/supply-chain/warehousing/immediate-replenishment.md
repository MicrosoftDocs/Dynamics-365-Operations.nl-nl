...
description: In dit artikel wordt beschreven hoe u directe aanvulling kunt gebruiken voor het aanvullen van voorraad wanneer met een richtlijn van de locatie voorraad niet kan worden toegewezen.
author: Mirzaab
ms.date: 03/15/2017
ms.topic: article
ms.prod: ''
