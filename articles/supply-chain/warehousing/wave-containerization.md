...
description: In dit artikel wordt beschreven hoe u de containervorming van ladingen kunt automatiseren. Bij automatische containervorming worden containers gecreëerd en wordt de orderverzameling uitgevoerd voor zendingen wanneer een wave wordt verwerkt.
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8880417"
---
# <a name="containerization"></a>Containervorming

[!include [banner](../includes/banner.md)]

In dit artikel wordt beschreven hoe u de containervorming van ladingen kunt automatiseren. Bij automatische containervorming worden containers gecreëerd en wordt de orderverzameling uitgevoerd voor zendingen wanneer een wave wordt verwerkt.
