...
ms.locfileid: "8671473"
---
# <a name="consolidate-shipments-by-using-shipment-consolidation-policies"></a>Zendingen consolideren met consolidatiebeleid voor zendingen

[!include [banner](../includes/banner.md)]

In de volgende scenario's wordt u door het consolidatieproces voor zendingen geleid waarbij wordt gebruikgemaakt van consolidatiebeleid voor zendingen tijdens automatische en handmatig vrijgave naar het magazijn:
