...
description: In dit artikel wordt beschreven hoe u gebruikersaccounts instelt en beheert waarmee werknemers zich kunnen aanmelden en de magazijn-app kunnen gebruiken.
author: Mirzaab
ms.date: 09/15/2021
ms.topic: article
ms.search.form: ''
