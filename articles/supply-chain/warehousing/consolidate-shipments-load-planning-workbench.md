...
---
# <a name="consolidate-shipments-by-using-release-to-warehouse-from-the-load-planning-workbench"></a>Zendingen consolideren met Vrijgave naar magazijn vanuit de workbench voor ladingplanning
