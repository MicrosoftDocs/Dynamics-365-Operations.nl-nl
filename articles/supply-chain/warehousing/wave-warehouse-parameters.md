...
description: In dit artikel wordt beschreven hoe u magazijnparameters instelt voor waveverwerking. U kunt waveverwerking gebruiken om verzamelwerk voor meerdere werkorders in een enkele wave te groeperen.
author: Mirzaab
ms.date: 03/08/2021
ms.topic: article
ms.prod: ''
...
In dit artikel wordt beschreven hoe u magazijnparameters instelt voor waveverwerking. U kunt waveverwerking gebruiken om verzamelwerk voor meerdere werkorders in een enkele wave te groeperen.
