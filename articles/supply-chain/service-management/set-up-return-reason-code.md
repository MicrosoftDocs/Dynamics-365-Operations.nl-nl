...
4.  Typ in het veld **Beschrijving** een korte omschrijving om aan te geven hoe deze groep wordt gebruikt.
...
3.  Voer in het veld **Redencode retour** tekst in om deze retourredencode te identificeren.

4.  Voer in het veld **Beschrijving** tekst in om de retourredencode te beschrijven.

5.  Via de vervolgkeuzelijst **Redencodegroep retour** kunt u de code toevoegen aan een retourredencodegroep.

## <a name="see-also"></a>Zie ook

[Groepen redencode retour (formulier)](https://technet.microsoft.com/en-us/library/hh209604\(v=ax.60\))

[Redencodes retour (formulier)](https://technet.microsoft.com/en-us/library/hh227372\(v=ax.60\))
