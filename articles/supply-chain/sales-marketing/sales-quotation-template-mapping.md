...
- Ga naar **Instellingen** &gt; **Beheer** &gt; **Systeeminstellingen** &gt; **Sales** en controleer of het veld **Berekeningsmethode korting** is ingesteld op **Per eenheid**. Deze instelling zorgt ervoor dat de regelitemkorting uit Sales overeenkomt met de instelling in Finance and Operations. Anders is de korting niet juist in Finance and Operations, omdat Finance and Operations de korting leest als korting per eenheid zelfs als dit een korting per regel is in Sales.

### <a name="setup-in-finance-and-operations"></a>Instellingen In Finance and Operations

- Ga naar **Klanten** &gt; **Instellingen** &gt; **Parameters van module Klanten**. Selecteer op het tabblad **Nummerreeks** de nummerreeks voor verkoopoffertes en klik vervolgens op **Details weergeven**. Stel vervolgens onder **Algemene instelling** het veld **Handmatig** in op **Ja**.
- Ga naar **Klanten** &gt; **Instellingen** &gt; **Parameters van module Klanten**. Stel vervolgens op het tabblad **Zendingen** het veld **Controle leveringsdatum** in op **Geen**. Met deze instelling voorkomt u dat de synchronisatie voor verkoopoffertes mislukt.
