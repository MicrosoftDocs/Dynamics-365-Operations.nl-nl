...
- [Verkoopoffertes vanuit Sales direct synchroniseren naar Finance and Operations (sjabloon in afwachting van vrijgave)](sales-quotation-template-mapping-sales-fin.md)
...
2. Zorg ervoor dat het zipbestand niet wordt geblokkeerd. Anders wordt mogelijk het foutbericht Er zijn geen importpakketten gevonden weergegeven wanneer u het oplossingspakket installeert. Als u het zipbestand wilt deblokkeren, klikt u er met de rechtermuisknop op en selecteert u **Eigenschappen**. Selecteer **Deblokkeren**.
