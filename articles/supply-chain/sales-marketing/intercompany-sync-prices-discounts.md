...
description: In dit onderwerp wordt de synchronisatie van prijzen en kortingen voor intercompany-verkooporders en -inkooporders uitgelegd.
author: Henrikan
ms.date: 09/01/2021
ms.topic: article
