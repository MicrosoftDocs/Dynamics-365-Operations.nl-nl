...
description: In dit artikel vindt u een overzicht van de integratie met Microsoft Dynamics 365 Field Service.
author: Henrikan
ms.date: 07/25/2019
ms.topic: overview
ms.prod: ''
...
- Dynamics 365 Finance and Operations versie 8.1.2 (december 2018) is uitgebracht in december 2018 en heeft buildnummer 8.1.195 met platformupdate 22 (7.0.5095). 
