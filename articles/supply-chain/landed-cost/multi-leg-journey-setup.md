...
description: In dit artikel wordt beschreven hoe u trajecten met meerdere etappes kunt instellen voor de module Francoprijzen.
author: Weijiesa
ms.date: 12/04/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8905829"
---
# <a name="multi-leg-journey-setup"></a>Een traject met meerdere etappes instellen

[!include [banner](../../includes/banner.md)]

In dit artikel wordt beschreven hoe u trajecten met meerdere etappes kunt instellen voor de module **Francoprijzen**.
