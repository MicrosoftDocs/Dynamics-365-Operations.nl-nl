...
description: In dit artikel wordt beschreven hoe u de taak Bijhouden van updates voor wegzetten kunt instellen en uitvoeren om periodieke taken weg te zetten.
author: Weijiesa
ms.date: 08/02/2021
ms.topic: article
ms.search.form: ''
