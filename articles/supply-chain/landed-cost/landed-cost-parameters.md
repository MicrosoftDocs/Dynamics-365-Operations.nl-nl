...
description: In dit artikel wordt beschreven hoe u algemene gegevens en configuratie-instellingen kunt instellen die in de hele module Francoprijzen worden gebruikt voor boekingen, statusupdates, nummerreeksen en gedrag.
author: Weijiesa
ms.date: 12/07/2020
ms.topic: article
ms.prod: ''
