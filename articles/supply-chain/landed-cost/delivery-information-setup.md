...
description: In dit artikel wordt beschreven hoe u leveringsgegevens kunt instellen voor de module Francoprijzen.
author: Weijiesa
ms.date: 12/09/2020
ms.topic: article
ms.prod: ''
...
In dit artikel wordt beschreven hoe u leveringsgegevens kunt instellen voor de module **Francoprijzen**.
