...
description: In dit artikel wordt beschreven hoe u de verschillende typen rapporten kunt opzoeken en gebruiken die beschikbaar zijn voor de module Francoprijzen.
author: Weijiesa
ms.date: 02/01/2021
ms.topic: article
ms.prod: ''
