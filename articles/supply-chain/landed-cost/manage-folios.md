...
description: In dit artikel wordt beschreven hoe u met folio's werkt. Een folio bestaan uit goederen van één leverancier voor één entiteit of bedrijf per zending. De goederen in een folio kunnen zich in één container bevinden of zijn verdeeld over meerdere containers.
author: Weijiesa
ms.date: 12/14/2020
ms.topic: article
ms.prod: ''
...
Het sneltabblad **Folio** in de weergave **Regels** bevat informatie over het folio. De meeste informatie wordt ook weergegeven in de weergave **Header**, zoals eerder in dit artikel is beschreven.
