...
| Verkoopbeheer en marketing | Verkooporderhistorie voor update opschonen | Met deze functie kunt u tijdelijke historische records opschonen die zijn gerelateerd aan updates van verkooporders. Hiermee wordt een nieuwe knop met de naam **Verkoophistorie voor update opschonen** toegevoegd aan het actievenster van de detail- en lijstpagina´s voor verkooporders. |
