...
|---|---|---|---|
| Planning | [Optimalisatieondersteuning voor capaciteitstoewijzing van bronnen plannen](/dynamics365-release-plan/2021wave2/finance-operations/dynamics365-supply-chain-management/planning-optimization-support-capability-based-resource-allocation) | [Plannen met onbeperkte capaciteit](../master-planning/planning-optimization/infinite-capacity-planning.md) | Functiebeheer: *Onbeperkte capaciteitsplanning voor Planningsoptimalisatie* |
