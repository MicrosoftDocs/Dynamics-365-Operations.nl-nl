...
description: In dit artikel worden de functies beschreven die in Dynamics 365 Supply Chain Management 10.0.13 nieuw of gewijzigd zijn.
author: kamaybac
ms.date: 07/31/2020
ms.topic: article
ms.prod: ''
...
In dit artikel worden de functies beschreven die nieuw of gewijzigd zijn in Microsoft Dynamics 365 Supply Chain Management 10.0.13. Deze versie heeft een buildnummer van 10.0.569 en is als volgt beschikbaar:
...
Microsoft Dynamics 365 Supply Chain Management 10.0.13 bevat platform updates. Zie voor meer informatie [Platformupdates voor versie 10.0.13 van apps voor financiën en bedrijfsactiviteiten (oktober 2020)](../../fin-ops-core/dev-itpro/get-started/whats-new-platform-updates-10-0-13.md).
