...
description: In dit onderwerp worden abonnementsmodules beschreven en wordt aangegeven hoe u deze toevoegt aan sitepagina's in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
...
ms.locfileid: "6638797"
---
# <a name="subscribe-module"></a>Abonnementsmodule

[!include [banner](includes/banner.md)]

In dit onderwerp worden abonnementsmodules beschreven en wordt aangegeven hoe u deze toevoegt aan sitepagina's in Microsoft Dynamics 365 Commerce.
...
1. Selecteer in het dialoogvenster **Module toevoegen** de module **Abonneren** en selecteer vervolgens **OK**.
