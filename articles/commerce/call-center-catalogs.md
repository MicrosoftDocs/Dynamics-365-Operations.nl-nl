...
description: In dit artikel wordt de callcenterspecifieke functionaliteit voor catalogi in Dynamics 365 Commerce beschreven.
author: josaw1
ms.date: 05/15/2018
ms.topic: article
ms.prod: ''
...
In dit artikel wordt de callcenterspecifieke functionaliteit beschreven die is gekoppeld aan de catalogusmogelijkheden in Dynamics 365 Commerce.
...
Nadat de validatie is bevestigd, klikt u op **Werkstroom** in het menu om de goedkeuringswerkstroom te starten. Klik op **Indienen** in het menu **Werkstroom** om de procedure uit te voeren. Configureer de stappen en gemachtigde gebruikers voor de werkstroom vanuit **Retail en Commerce** \> **Headquarters instellen** \> **Commerce-werkstromen**. De werkstroom definieert de stappen die nodig zijn om de catalogus de status **Goedgekeurd** te geven. Wanneer de catalogus de status **Goedgekeurd** heeft, kunt u klikken op de optie **Publiceren** in het menu **Catalogus** om de procedure te voltooien. Nadat de catalogus de status **Gepubliceerd** heeft gekregen, kan deze worden gebruikt bij callcenterorderinvoer en catalogusverzendprocessen.
