...
description: Dit artikel bevat een overzicht van de functionaliteit waarmee detailhandelaren kortingen voor specifieke betalingstypen kunnen configureren.
author: bebeale
ms.date: 10/30/2019
ms.topic: article
ms.prod: ''
