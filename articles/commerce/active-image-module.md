...
description: In dit artikel wordt beschreven wat modules voor actieve afbeeldingen zijn en hoe u deze toevoegt aan sitepagina's in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 05/18/2022
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8853845"
---
# <a name="active-image-module"></a>Module voor actieve afbeeldingen

[!include [banner](includes/banner.md)]

In dit artikel wordt beschreven wat modules voor actieve afbeeldingen zijn en hoe u deze toevoegt aan sitepagina's in Microsoft Dynamics 365 Commerce.
...
1. Selecteer in het dialoogvenster **Modules selecteren** de module **Actieve afbeelding** en selecteer vervolgens **OK**.
