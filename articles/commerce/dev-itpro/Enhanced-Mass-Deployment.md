...
| --Install | Een parameter waarmee wordt opgegeven of het onderdeel dat door dit installatieprogramma wordt geleverd, moet worden geïnstalleerd. Deze parameter is niet verplicht. |
