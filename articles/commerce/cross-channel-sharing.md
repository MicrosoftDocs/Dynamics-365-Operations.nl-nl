...
description: In dit artikel wordt beschreven hoe u de functie voor het delen van inhoud door meerdere kanalen in Microsoft Dynamics 365 Commerce Site Builder kunt inschakelen en gebruiken.
author: josaw1
ms.date: 10/16/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9270068"
---
# <a name="enable-and-use-cross-channel-sharing"></a>Het delen van inhoud door meerdere kanalen inschakelen en gebruiken

[!include [banner](includes/banner.md)]

In dit artikel wordt beschreven hoe u de functie voor het delen van inhoud door meerdere kanalen in Microsoft Dynamics 365 Commerce Site Builder kunt inschakelen en gebruiken.
