...
description: In dit artikel worden de basisconcepten toegelicht van assortimentsbeheer in Dynamics 365 Commerce en overwegingen bij de implementatie voor uw project.
author: josaw1
ms.date: 03/12/2018
ms.topic: article
ms.prod: ''
