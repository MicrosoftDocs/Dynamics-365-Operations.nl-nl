---
title: Subtotaal van orderoverzicht bevat geen belastingen op toeslagen bij het gebruik van aangepaste modules voor orderoverzichten
description: Dit onderwerp biedt richtlijnen voor het oplossen van problemen die kunnen helpen als u aangepaste orderoverzichtmodules gebruikt en het subtotaal van het orderoverzicht geen belastingen op toeslagen bevat in het scenario 'Prijs inclusief btw'.
...
ms.locfileid: "8767948"
---
# <a name="order-summary-subtotal-doesnt-include-taxes-on-charges-when-using-customized-order-summary-modules"></a>Subtotaal van orderoverzicht bevat geen belastingen op toeslagen bij het gebruik van aangepaste modules voor orderoverzichten

Dit onderwerp biedt richtlijnen voor het oplossen van problemen die kunnen helpen als u aangepaste orderoverzichtmodules gebruikt en het subtotaal van het orderoverzicht geen belastingen op toeslagen bevat in het scenario 'Prijs inclusief btw'.
