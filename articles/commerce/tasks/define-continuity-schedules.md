...
description: In dit artikel worden de stappen besproken voor het instellen van een continuïteitsprogramma (ook wel aangeduid als terugkerende orders).
author: josaw1
ms.date: 08/29/2018
...
ms.locfileid: "8885079"
---
# <a name="define-continuity-schedules"></a> Continuïteitsplanningen definiëren

[!include [banner](../includes/banner.md)]

In dit artikel worden de stappen besproken voor het instellen van een continuïteitsprogramma (ook wel aangeduid als terugkerende orders). In dit artikel wordt het demobedrijf USRT gebruikt.
