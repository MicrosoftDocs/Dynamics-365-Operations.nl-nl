...
Deze procedure geeft aan hoe u de instellingen van het functionaliteitsprofiel van een winkel configureert dat van toepassing is op verkopers die het demobedrijf USRT gebruiken.

1. Ga naar Retail en Commerce > Kanaalinstellingen > POS-instellingen > POS-profielen > Functionaliteitsprofielen.
2. Klik op Bewerken.
3. Vouw de sectie Functies uit.
    * U kunt de instellingen van het functionaliteitprofiel gebruiken om POS te configureren op het automatisch toevoegen van de standaardverkoopgroep van de kassier, op vragen om verkoopgroepen en verkoopgroepen vereisen.  
