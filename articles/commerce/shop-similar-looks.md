---
title: Aanbevelingen voor 'winkelen voor vergelijkbaar uitziende artikelen' inschakelen
description: In dit artikel wordt beschreven hoe u productaanbevelingen voor 'winkelen voor vergelijkbaar uitziende artikelen' kunt inschakelen in Microsoft Dynamics 365 Commerce.
author: bebeale
ms.date: 08/06/2020
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9282045"
---
# <a name="enable-shop-similar-looks-recommendations"></a>Aanbevelingen voor vergelijkbare artikelen inschakelen

[!include [banner](includes/banner.md)]

In dit artikel wordt beschreven hoe u productaanbevelingen voor vergelijkbare artikelen kunt inschakelen in Microsoft Dynamics 365 Commerce.
