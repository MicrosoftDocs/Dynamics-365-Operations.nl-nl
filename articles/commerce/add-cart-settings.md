...
description: In dit artikel worden instellingen voor 'Product toevoegen aan winkelwagen' beschreven en hoe deze worden toegepast in Microsoft Dynamics 365 Commerce.
author: anupamar-ms
ms.date: 07/08/2021
ms.topic: article
ms.prod: ''
