...
description: Dit artikel biedt een overzicht van de selectie van btw-groepen voor verschillende typen online orders in Dynamics 365 Commerce.
...
ms.locfileid: "9819264"
---
# <a name="configure-sales-tax-for-online-orders"></a>Btw voor online orders configureren

[!include [banner](includes/banner.md)]

Dit artikel bevat een overzicht van de selectie van btw-groepen voor verschillende online ordertypen met belastinginstellingen op basis van bestemming of klantrekening. 
...
De configuratie voor **Op retailbestemming gebaseerde btw** is te vinden in de sectie **Btw-module > Indirecte belastingen > Btw > Btw-groepen**.
