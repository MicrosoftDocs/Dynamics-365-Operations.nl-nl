...
| Inzichten  |  Geef operationele inzichten van het verkooppunt (POS) door naar uw Application Insights-account. | [Toegang tot logboeken in Application Insights](../dev-itpro/retail-component-events-diagnostics-troubleshooting.md#enable-diagnostic-events-in-application-insights)   |  Aanmelden voor IT-pro/ontwikkelaar   |
