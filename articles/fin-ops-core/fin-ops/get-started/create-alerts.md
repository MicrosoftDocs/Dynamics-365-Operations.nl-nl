...
description: In dit artikel vindt u informatie over waarschuwingen en wordt uitgelegd hoe u een waarschuwingsregel kunt maken.
author: RichdiMSFT
ms.date: 10/08/2020
ms.topic: article
ms.prod: ''
