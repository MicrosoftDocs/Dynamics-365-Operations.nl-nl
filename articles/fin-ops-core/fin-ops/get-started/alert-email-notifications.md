...
description: Dit artikel biedt informatie over het instellen van regels die e-mailberichten verzenden wanneer vooraf gedefinieerde gebeurtenissen optreden.
author: RichdiMSFT
ms.date: 09/20/2019
ms.topic: article
ms.prod: ''
