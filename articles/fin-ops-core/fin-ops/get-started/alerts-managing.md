...
ms.locfileid: "2180801"
---
# <a name="batch-processing-of-alerts"></a>Batchverwerking van waarschuwingen

[!include [banner](../includes/banner.md)]

Waarschuwingen worden verwerkt met de functionaliteit voor batchverwerking. Stel batchverwerking in voordat waarschuwingen kunnen worden verzonden.

Er worden twee gebeurtenistypen ondersteund:
