...
- [Verwijderde of afgeschafte functies in Lifecycle Services (LCS)](../../dev-itpro/lifecycle-services/removed-deprecated-features.md)
...
- [Belangrijke wijzigingen (afschaffingen) die komen in Power Apps, Power Automate en apps voor klantbetrokkenheid](https://docs.microsoft.com/power-platform/important-changes-coming)
