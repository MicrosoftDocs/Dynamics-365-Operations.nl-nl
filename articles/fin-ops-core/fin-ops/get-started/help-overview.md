...
Als u zich wilt abonneren op een RSS-feed van alle updates op de inhoud, gebruikt u de volgende koppeling vanuit een browser die RSS-feeds ondersteunt, zoals Internet Explorer of een RSS-feedmanager:
...
U kunt bijdragen aan en wijzigingen aanbrengen in de documentatie. Om te beginnen, klikt u op de knop **Bewerken** (potlood) op een onderwerp. In de volgende video ziet u hoe u aan onze documentatie kunt bijdragen.
...
Voor toegang tot de Help-inhoud klikt u op het pictogram **Help** (**?**) en kiest u vervolgens Help of drukt u op Ctrl+Shift+?. In beide gevallen wordt het deelvenster Help geopend. Via het deelvenster Help kunt u artikelen of taakbegeleidingen openen.
...
> - Het is niet mogelijk verbinding maken met een LCS-bibliotheek vanuit een exemplaar van de app dat wordt uitgevoerd op een lokale virtuele harde schijf (VHD).
...
Vertaalde taakbegeleidingen worden vrijgegeven in bibliotheken waarvan de titel "Alle talen" bevat. Als u gelokaliseerde Help met taakbegeleiding wilt zien, moet u ervoor zorgen dat u bent verbonden met de bijbehorende bibliotheek. De taal waarin een taakbegeleiding wordt weergegeven, wordt voor elke gebruiker bepaald door de instellingen voor taal onder **Opties** &gt; **Voorkeuren**.
...
| [Lifecycle Services](https://lcs.dynamics.com/)\*                                              | Biedt een ruimte voor samenwerking in de cloud die klanten en hun partners kunnen gebruiken om projecten te beheren van pre-sales naar implementatie en bewerkingen. Deze site is handig in alle fasen van een implementatie. |
| [Ondersteuningsblog](https://aka.ms/AXSupportBlog)                                                    | Geeft tips en trucs die door het ondersteuningsteam worden geplaatst. |
...
| [CustomerSource](https://mbs.microsoft.com/customersource/)\*                                  | Host trainingsresources, downloadbare rapporten en whitepapers en is de primaire ondersteuningssite voor serviceplanhouders. Kan een serviceplan vereisen om toegang te krijgen tot bepaalde bronnen op de site. |
