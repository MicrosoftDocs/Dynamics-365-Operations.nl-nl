...
> [!NOTE]
> De RSS-feed retourneert een lijst met de 100 onderwerpen die het laatst zijn bijgewerkt. De lijst wordt gesorteerd op datum, maar het kan een week duren voordat de meest recent bijgewerkte artikelen in de lijst worden opgenomen.  
