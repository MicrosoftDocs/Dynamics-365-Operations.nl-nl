...
- Gebruik de knop **Een PowerApp toevoegen** om een app in te sluiten die met Microsoft PowerApps op de pagina is gemaakt. Zie [PowerApps-apps insluiten](embed-power-apps.md) voor gedetailleerde informatie over het insluiten van een PowerApps-app in een pagina.
