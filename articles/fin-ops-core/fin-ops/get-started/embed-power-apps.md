...
U kunt op drie manieren een canvas-app in een Finance and Operations-app insluiten. U kunt de aanpak gebruiken die het beste bij uw scenario past. 
...
U wilt een canvas-app mogelijk vanuit het dashboard insluiten als de app niet is gekoppeld aan een bestaande pagina of als u de app alleen maar als een volledige pagina wilt weergeven in de Finance and Operations-app.
...
- **Context invoeren voor de app**: u kunt eventueel het veld selecteren met de gegevens die u als invoer wilt doorgeven aan de app. Meer informatie over hoe apps toegang kunnen krijgen tot de gegevens die vanuit Finance and Operations-apps worden verzonden, vindt u de sectie [Een app bouwen die gebruikmaakt van gegevens die vanuit Finance and Operations-apps zijn verzonden](#building-a-canvas-app-that-uses-data-that-is-sent-from-finance-and-operations-apps) verderop in dit onderwerp.
