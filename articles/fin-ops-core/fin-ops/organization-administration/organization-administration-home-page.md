...
description: Dit artikel verwijst naar resources die u helpen in uw organisatie.
author: sericks007
ms.date: 08/18/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "8882044"
---
# <a name="organization-administration-home-page"></a>Startpagina van Organisatiebeheer

[!include [banner](../includes/banner.md)]

Dit artikel verwijst naar inhoud die hoofdgebruikers en beheerders helpt het systeem te configureren zodat dit vloeiend en effectief werkt voor uw organisatie en zakelijke activiteiten.
