...
description: Dit artikel biedt informatie over de primitieve gegevenstypen die worden ondersteund in ER-formules (Elektronische rapportage).
author: NickSelin
ms.date: 06/02/2021
...
Dit artikel biedt informatie over de primitieve gegevenstypen die worden ondersteund in expressies voor [Elektronische rapportage (ER)](general-electronic-reporting.md). Hier volgt een lijst van de primitieve gegevenstypen:
