...
description: Dit artikel bevat informatie over het configureren van een archiefbestemming voor elke map- of bestandscomponent van een ER-indeling (Electronic Reporting).
author: NickSelin
ms.date: 11/30/2020
ms.topic: article
ms.prod: ''
