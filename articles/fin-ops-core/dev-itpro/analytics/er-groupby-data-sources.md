...
description: In dit artikel wordt uitgelegd hoe u gegevensbronnen van het type GROUPBY kunt gebruiken in elektronische rapportage (ER).
author: NickSelin
ms.date: 03/18/2022
ms.topic: article
ms.prod: ''
