...
description: In dit artikel wordt de Werknemersontwikkeling Power BI-inhoud besproken.
author: jcart1106
ms.date: 12/19/2017
ms.topic: article
ms.prod: ''
...
ms.locfileid: "9206538"
---
# <a name="employee-development-power-bi-content"></a>Werknemersontwikkeling Power BI-inhoud

[!include [banner](../includes/banner.md)]

In dit artikel wordt de **Werknemersontwikkeling** Microsoft Power BI-inhoud besproken.
