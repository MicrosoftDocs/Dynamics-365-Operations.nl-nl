...
description: In dit artikel wordt uitgelegd hoe u grote documenten kunt comprimeren die worden gegenereerd door een ER-indeling (elektronische rapportage).
author: NickSelin
ms.date: 09/11/2020
ms.topic: article
ms.prod: ''
