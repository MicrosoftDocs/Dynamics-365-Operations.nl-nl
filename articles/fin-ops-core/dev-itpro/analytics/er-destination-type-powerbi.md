...
ms.locfileid: "3745532"
---
# <a name="power-bi-destination"></a>Bestemming voor Power BI

[!include [banner](../includes/banner.md)]

U kunt een Microsoft Power BI-bestemming configureren voor elke map- of bestandcomponent van een ER-indeling (elektronische rapportage) die wordt geconfigureerd voor het genereren van uitgaande documenten. Op basis van de instelling van de bestemming wordt een gegenereerd document opgeslagen in een eerder geconfigureerde SharePoint-map.
