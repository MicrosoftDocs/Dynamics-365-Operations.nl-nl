...
De video [Een nieuw bedrijfsdocument maken met Bedrijfsdocumentbeheer](https://youtu.be/gAIYl-mM_pw) (hierboven weergegeven) is opgenomen in de [afspeellijst voor Finance + Operations](https://www.youtube.com/playlist?list=PLcakwueIHoT_SYfIaPGoOhloFoCXiUSyW) die beschikbaar is op YouTube.
