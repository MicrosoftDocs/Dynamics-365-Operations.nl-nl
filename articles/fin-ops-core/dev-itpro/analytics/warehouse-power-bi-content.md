...
ms.locfileid: "6750545"
---
# <a name="warehouse-performance-power-bi-content"></a>Power BI-inhoud Magazijnprestaties

[!include [banner](../includes/banner.md)]

In dit onderwerp wordt beschreven wat is opgenomen in de Microsoft Power BI-inhoud **Magazijnprestaties**. U vindt hier een uitleg hoe u toegang krijgt tot de Power BI-rapporten en informatie over het gegevensmodel en de entiteiten waarmee de inhoud is samengesteld.
