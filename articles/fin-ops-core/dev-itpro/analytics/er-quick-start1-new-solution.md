...
description: In dit artikel wordt uitgelegd hoe u een oplossing voor elektronische rapportering (ER) kunt ontwerpen om een aangepast rapport af te drukken.
author: kfend
ms.date: 08/10/2020
ms.topic: article
ms.prod: ''
...
Zie [Overzicht van Elektronische rapporten (ER)](general-electronic-reporting.md) voor meer informatie over versiebeheer voor ER-configuraties.
