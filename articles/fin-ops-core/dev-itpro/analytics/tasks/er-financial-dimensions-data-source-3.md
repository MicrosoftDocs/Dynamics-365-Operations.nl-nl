...
description: In dit artikel wordt beschreven hoe u een ER-model (Electronic Reporting) configureert om financiële dimensies te gebruiken als gegevensbron voor ER-rapporten. (Deel 3)
author: kfend
ms.date: 05/27/2020
