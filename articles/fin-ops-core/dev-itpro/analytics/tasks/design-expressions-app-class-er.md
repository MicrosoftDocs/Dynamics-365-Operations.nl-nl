...
1. Ga naar Organisatiebeheer > Werkruimten > Elektronische rapportage.
    ...
    * U ontwerpt een proces voor het parseren van inkomende bankafschriften voor het bijwerken van toepassingsgegevens. U ontvangt de inkomende bankafschriften als TXT-bestanden die IBAN-codes bevatten. Als onderdeel van het importproces van het bankafschrift moet u de juistheid van deze IBAN-codes valideren met behulp van de logica die al beschikbaar is.   
