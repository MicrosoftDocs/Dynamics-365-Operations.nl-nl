...
description: In dit artikel worden functies voor geavanceerde opmaak beschreven, waaronder filters, beperkingen, niet-afdrukrijen en voorwaardelijke instructies in berekeningen.
author: panolte
ms.date: 04/26/2019
ms.topic: article
ms.prod: ''
