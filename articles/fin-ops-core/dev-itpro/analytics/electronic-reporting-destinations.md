...
> [!NOTE]
> Er moet een SMTP-server (Simple Mail Transfer Protocol) worden geconfigureerd en beschikbaar besteld. U kunt uw SMTP-server opgeven onder **Systeembeheer** &gt; **Instellingen** &gt; **E-mail** &gt; **E-mailparameters**.
...
> [!NOTE]
> U kunt een documenttype voor het taakarchief selecteren via **Organisatiebeheer** &gt; **Werkgebieden** &gt; **Elektronische aangifte** &gt; **Elektronische rapportparameters**.
