...
description: In dit artikel wordt beschreven hoe u gegevens importeert met Excel-gegevensentiteitsjablonen in apps voor financiën en bedrijfsactiviteiten.
author: peakerbl
ms.date: 01/01/2018
ms.topic: article
ms.prod: ''
