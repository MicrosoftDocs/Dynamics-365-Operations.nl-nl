...
Apps voor financiële en bedrijfsactiviteiten | Andere Dynamics 365-apps | Description
-----------------------|--------------------------------|---
[Alle producten](mapping-reference.md#138) | msdyn_globalproducts | De tabel met alle producten bevat alle producten die beschikbaar zijn in apps voor financiële en bedrijfsactiviteiten, zowel de vrijgegeven producten als de niet-vrijgegeven producten.
...
[Vrijgegeven producten V2](mapping-reference.md#189) | msdyn\_sharedproductdetails | De tabel **msdyn\_sharedproductdetails** bevat de kolommen van apps voor financiële en bedrijfsactiviteiten die het product definiëren en die de financiële en beheergegevens van het product bevatten.
...
De synchronisatie van producten gebeurt vanuit de app voor financiële en bedrijfsactiviteiten naar Dataverse. Dit betekent dat de waarden van de producttabelkolommen kunnen worden gewijzigd in Dataverse, maar dat bij activering van de synchronisatie (wanneer een productkolom wordt gewijzigd in een app voor financiële en bedrijfsactiviteiten), de waarden in Dataverse worden overschreven.
...
Het concept voor maateenheden is geïntegreerd tussen de apps voor financiële en bedrijfsactiviteiten en de andere Dynamics 365-apps. Voor elke eenheidsklasse in een app voor financiële en bedrijfsactiviteiten wordt een eenhedengroep gemaakt in een Dynamics 365-app, die de eenheden bevat die bij de eenheidsklasse horen. Er wordt ook een standaard basiseenheid voor elke eenhedengroep gemaakt.
...
Als twee keer wegschrijven is ingeschakeld, worden eenheden uit apps voor financiële en bedrijfsactiviteiten gesynchroniseerd met andere Dynamics 365-apps. De eenhedengroepen die vanuit apps voor financiële en bedrijfsactiviteiten worden gesynchroniseerd in Dataverse, hebben een markering ingesteld die aangeeft dat ze extern worden onderhouden.
...
Allereerst is het belangrijk te weten dat de integratiesleutel voor eenheid msdyn_symbol is. Daarom moet deze waarde uniek zijn in Dataverse of andere Dynamics 365-apps. Omdat in andere Dynamics 365-apps via de combinatie van "Eenhedengroep-id" en "Naam" de uniekheid van een eenheid wordt gedefinieerd, moet u rekening houden met verschillende scenario's voor het afstemmen van eenheidsgegevens tussen apps voor financiële en bedrijfsactiviteiten en Dataverse.

Voor eenheden die overeenkomen met of overlappen in apps voor financiële en bedrijfsactiviteiten en andere Dynamics 365-apps:

+ **De eenheid behoort tot een eenhedengroep in andere Dynamics 365-apps die overeenkomt met de bijbehorende eenheidsklasse in apps voor financiële en bedrijfsactiviteiten**. In dit geval moet de kolom msdyn_symbol in andere Dynamics 365-apps worden ingevuld met het eenheidssymbool uit apps voor financiële en bedrijfsactiviteiten. Dus wanneer de gegevens worden afgestemd, wordt de eenhedengroep ingesteld op Extern onderhouden in andere Dynamics 365-apps.
+ **De eenheid behoort tot een eenhedengroep in andere Dynamics 365-apps die niet overeenkomen met de bijbehorende eenheidsklasse in apps voor financiële en bedrijfsactiviteiten (geen bestaande eenheidsklasse in apps voor financiële en bedrijfsactiviteiten voor de eenheidsklasse in andere Dynamics 365-apps).** In dit geval moet een willekeurige tekenreeks worden ingevuld bij msdyn_symbol. Let op: deze waarde moet uniek zijn in andere Dynamics 365-apps.

Voor eenheden en eenheidsklassen in apps voor financiële en bedrijfsactiviteiten die niet bestaan in andere Dynamics 365-apps:

Als onderdeel van het twee keer wegschrijven worden de eenhedengroepen van apps voor financiële en bedrijfsactiviteiten en de bijbehorende eenheden gemaakt en gesynchroniseerd in andere Dynamics 365-apps en Dataverse en wordt de eenhedengroep ingesteld op "Extern onderhouden". Er is geen extra inspanning voor bootstrapping vereist.

Voor eenheden in andere Dynamics 365-apps die niet bestaan in apps voor financiële en bedrijfsactiviteiten:

De kolom msdyn_symbol moet worden ingevuld voor alle eenheden. De eenheden kunnen altijd worden gemaakt in apps voor financiële en bedrijfsactiviteiten in de bijbehorende eenheidsklasse (indien aanwezig). Als de eenheidsklasse niet bestaat, moet deze eerst worden gemaakt (houd er rekening mee dat u geen eenheidsklasse kunt maken in apps voor financiële en bedrijfsactiviteiten behalve via uitbreiding als u de enum uitbreidt) die overeenkomt met de andere eenhedengroep voor Dynamics 365-apps. U kunt vervolgens de eenheid maken. Houd er rekening mee dat het eenheidssymbool in apps voor financiële en bedrijfsactiviteiten het msdyn_symbol moet zijn dat eerder is opgegeven in andere Dynamics 365-apps voor de eenheid.
...
Als twee keer wegschrijven is ingeschakeld, worden producten uit apps voor financiële en bedrijfsactiviteiten gesynchroniseerd met Dataverse en Customer Engagement-apps. Producten die zijn gemaakt in Dataverse en andere Dynamics 365-apps vóór de release van twee keer wegschrijven, worden niet bijgewerkt of komen niet overeen met productgegevens uit apps voor financiële en bedrijfsactiviteiten.
