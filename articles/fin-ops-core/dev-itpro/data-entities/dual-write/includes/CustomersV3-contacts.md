## <a name="customers-v3-to-contacts"></a>Klanten V3 naar contacts

Deze sjabloon synchroniseert gegevens tussen Finance and Operations-apps en Common Data Service.

Bronfilter: ((PartyType = = "Person"))

Omgekeerde bronfilter: msdyn_sellable eq true and msdyn_contactpersonid ne ''

Finance and Operations-veld | Toewijzingstype | Ander Dynamics 365-veld | Standaardwaarde
---|---|---|---
geen | >> | msdyn_sellable | True
PARTYTYPE | << | geen | Person
...
ADDRESSLOCATIONROLES | << | geen | Business
...
geen | >> | address1_addresstypecode | 3
