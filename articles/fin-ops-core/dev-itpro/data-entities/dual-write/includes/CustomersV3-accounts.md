## <a name="customers-v3-to-accounts"></a>Klanten V3 naar accounts

Deze sjabloon synchroniseert gegevens tussen Finance and Operations-apps en Common Data Service.

Bronfilter: ((PartyType = = "Organization"))

Omgekeerde bronfilter: customertypecode eq 3
...
geen | >> | address1_addresstypecode | 2
geen | >> | customertypecode | 3
PARTYTYPE | << | geen | Organization
