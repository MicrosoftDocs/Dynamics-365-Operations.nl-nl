...
description: In dit artikel worden de functies beschreven die zijn verwijderd of die gepland zijn om te verwijderen uit Dynamics 365 for Finance and Operations en eerdere versies.
author: sericks007
ms.date: 02/16/2021
ms.topic: article
ms.prod: ''
