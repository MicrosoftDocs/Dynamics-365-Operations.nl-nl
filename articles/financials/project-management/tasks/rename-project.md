...
1. <span data-ttu-id="2c769-110">Ga naar Projectbeheer- en boekhouding > Instellingen > Projectbeheer- en boekhoudingsparameters.</span><span class="sxs-lookup"><span data-stu-id="2c769-110">Go to Project management and accounting > Setup > Project management and accounting parameters.</span></span>
2. <span data-ttu-id="2c769-111">Klik op het tabblad Projectfase.</span><span class="sxs-lookup"><span data-stu-id="2c769-111">Click the Project stage tab.</span></span>
3. <span data-ttu-id="2c769-112">Selecteer in het veld Taal de taal die u wilt gebruiken voor de naam van de nieuwe projectfase.</span><span class="sxs-lookup"><span data-stu-id="2c769-112">In the Language field, select the language that you want to use for the new project stage name.</span></span>
4. <span data-ttu-id="2c769-113">Selecteer in de lijst de vooraf gedefinieerde of door de gebruiker gedefinieerde fase die u wilt wijzigen.</span><span class="sxs-lookup"><span data-stu-id="2c769-113">In the list, select the predefined or user-defined stage that you want to modify.</span></span> 
5. <span data-ttu-id="2c769-114">Geef de nieuwe naam op in het veld Projectfase.</span><span class="sxs-lookup"><span data-stu-id="2c769-114">In the Project stage field, enter the new name.</span></span>
6. <span data-ttu-id="2c769-115">Klik op Opslaan.</span><span class="sxs-lookup"><span data-stu-id="2c769-115">Click Save.</span></span>
