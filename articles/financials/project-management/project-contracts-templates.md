...
# <a name="synchronize-project-contracts-and-projects-from-project-service-automation-directly-to-project-contracts-and-projects-in-finance-and-operations"></a>Projectcontracten en projecten vanuit Project Service Automation rechtstreeks synchroniseren met projectcontracten en projecten in Finance and Operations
...
> [!NOTE]
> Voordat u de oplossing Project Service Automation-integratie met Finance and Operations gebruiken kunt, moet u bekend zijn met de functie Gegevensintegratie van Dynamics 365.
...
| Projectcontractregelmijlpalen | Integratie-entiteit voor projectcontractregelmijlpaal. |
...
Tijd en materiaal en vaste-prijsprojecten worden beheerd in Project Service Automation en worden gesynchroniseerd naar Finance and Operations als projecten. Als onderdeel van de sjabloonintegratie kunt u de integratiebron instellen in Finance and Operations voor het project.

Projectcontractregels worden beheerd in Project Service Automation en worden gesynchroniseerd naar Finance and Operations als projectcontractfactureringsregels. De synchronisatie werkt het projecttype voor het contractregelproject en de projectgroep bij als de factureringsmethode afwijkt van het standaardprojecttype.
...
- Voordat synchronisatie van projectcontracten en projecten kan optreden, moet u rekeningen synchroniseren.
- Voeg in uw verbindingsset een toewijzing van een integratiesleutelveld toe voor **msdyn\_organizationalunits** naar **msdyn\_name \[name\]**. Mogelijk moet u eerst een project toevoegen aan de verbindingsset. Zie voor meer informatie over integratiesleutels Dynamics 365 Gegevensintegratie.
- Voeg in uw verbindingsset een toewijzing van een integratiesleutelveld toe voor **msdyn\_projects** naar **msdynce\_projectnumber \[Project Number\]**. Mogelijk moet u eerst een project toevoegen aan de verbindingsset. Zie voor meer informatie over integratiesleutels Dynamics 365 Gegevensintegratie.
...
U moet Microsoft Power Query gebruiken om gegevens te filteren als aan de volgende voorwaarden wordt voldaan:
...
- De sjabloon Projectcontracten (PSA naar Fin and Ops) heeft een standaardfilter dat alleen verkooporders bevat van het type **Werkitem (msdyn\_ordertype = 192350001)**. Dit filter zorgt ervoor dat projectcontracten niet worden gemaakt voor verkooporders in Finance and Operations. Als u uw eigen sjabloon maakt, moet u dit filter toevoegen.
