...
Er zijn veel posts over financieel beheer beschikbaar op de [blog van het Microsoft Dynamics AX-productteam](https://blogs.msdn.microsoft.com/dax/). Hoewel sommige van deze berichten zijn geschreven voor een oudere versie van het product, zijn dezelfde concepten nog steeds van toepassing en komen ook de procedures overeen in de huidige versie.
