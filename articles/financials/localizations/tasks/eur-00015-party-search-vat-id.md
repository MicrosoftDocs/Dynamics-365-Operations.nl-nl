...
3. Klik op Toevoegen.
4. Typ of selecteer een waarde in het veld Registratietype.
    * Selecteer bijvoorbeeld Btw-id als u partijen wilt vinden met een registratie-id van het type Btw-id.  
5. Typ of selecteer een waarde in het veld Land/regio.
    * Voer bijvoorbeeld DEU in.  
