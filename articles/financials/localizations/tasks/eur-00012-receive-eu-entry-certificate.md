...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="eur-00012-receive-eu-entry-certificate.md" target-language="nl-NL">
    <header>
    ...
    <body>
      <group extype="content" id="content">
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">EUR-00012 Een EU-invoercertificaat ontvangen</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Deze procedure begeleidt u bij het registreren van een EU-invoercertificaat dat is uitgegeven door derden en van uw klant is ontvangen.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Het demobedrijf dat wordt gebruikt om deze procedure te maken is DEMF.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="106">
          <source>Go to Accounts receivable &gt; Inquiries and reports &gt; Entry certificate journal.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Ga naar Klanten &gt; Query's en rapporten &gt; Invoercertificaatlogboek.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Typ een waarde in het veld Invoercertificaat.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="109">
          <source>In the Customer account field, click the drop-down button to open the lookup.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Klik in het veld Klantrekening op de vervolgkeuzeknop om de zoekopdracht te openen.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Koppel extra informatie aan het journaal.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="113">
          <source>For example, attach a scanned image of the EU Entry certificate to the journal.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Koppel bijvoorbeeld een gescande afbeelding van het EU-invoercertificaat aan het journaal.</target></trans-unit>
      </group>
    </body>
  </file>
</xliff>