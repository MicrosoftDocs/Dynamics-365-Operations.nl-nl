...
Wanneer u een gedeeltelijke betaling uitvoert, wilt u mogelijk een volgende gedeeltelijke betaling doen om de factuur volledig te vereffenen. Om een contantkorting voor een gedeeltelijke betaling aan te nemen, moet u de optie <strong>Contantkortingen berekenen voor gedeeltelijke betalingen** instellen op **Ja</strong> op de pagina <strong>Leverancierparameters</strong>. 
