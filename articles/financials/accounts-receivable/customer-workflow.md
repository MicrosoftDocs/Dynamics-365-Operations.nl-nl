...
De klantenworkflow is toegevoegd aan Microsoft Dynamics 365 for Finance and Operations versie 8.0.4. U kunt specifieke velden voor een klant wijzigen en deze wijzigingen ter goedkeuring verzenden via de workflow voordat ze worden toegevoegd aan de klant.
...
De workflow volgt het standaard workflowproces in Finance and Operations. De fiatteur wordt doorgestuurd naar de pagina **Klant**, waar de wijzigingen op de pagina **Voorgestelde wijzigingen** kunnen worden bekeken en **Workflow \> Goedkeuren** kan worden geselecteerd om de werkstroom goed te keuren. Nadat alle goedkeuringen zijn voltooid, worden de velden bijgewerkt met de voorgestelde waarden.
