...
# <a name="add-new-location-roles-and-party-relationship-types"></a>Nieuwe locatierollen en partijrelatietypen toevoegen 

## <a name="add-new-location-roles"></a>Nieuwe locatierollen toevoegen
...
## <a name="add-new-party-relationship-types"></a>Nieuwe partijrelatietypen toevoegen 
