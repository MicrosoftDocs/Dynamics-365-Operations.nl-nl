...
<xliff xmlns:logoport="urn:logoport:xliffeditor:xliff-extras:1.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns="urn:oasis:names:tc:xliff:document:1.2" xmlns:xliffext="urn:microsoft:content:schema:xliffextensions" version="1.2" xsi:schemaLocation="urn:oasis:names:tc:xliff:document:1.2 xliff-core-1.2-transitional.xsd">
  <file datatype="xml" source-language="en-US" original="balance-sheet-financial-reports.md" target-language="nl-NL">
    <header>
    ...
    <body>
      <group extype="content" id="content">
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Financiële rapporten balans</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="102" restype="x-metadata">
          <source>This article describes the default reports for balance sheets.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">In dit artikel worden de standaardrapporten voor balansen beschreven.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="103" restype="x-metadata">
          <source>It also describes the building blocks that are associated with these reports.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Hierin worden ook de bouwstenen beschreven die aan deze rapporten zijn gekoppeld.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Standaardbalansrapporten</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="108">
          <source>There are two default balance sheet reports.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Er zijn twee standaardbalansrapporten.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="109">
          <source>On one report, the sections are stacked.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">In één rapport zijn de secties gestapeld.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="110">
          <source>On the other report, the sections are side by side.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">In het andere rapport worden de secties naast elkaar weergegeven.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Balans – Standaard</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="114">
          <source>Provides a view of the organization's financial position for the year.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Bevat een weergave van de financiële positie van de organisatie voor het jaar.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="115">
          <source>Side by Side Balance Sheet – Default</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Balans naast elkaar - Standaard</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="116">
          <source>Provides a view of the organization's financial position for the year.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Bevat een weergave van de financiële positie van de organisatie voor het jaar.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="117">
          <source>Assets and liability and shareholder’s equity are side by side.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Activa en passiva en het eigen vermogen van de aandeelhouder worden naast elkaar weergegeven.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">In de financiële rapporten van de balans worden de volgende bouwstenen gebruikt.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Jaar tot heden en afwijking: standaard</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Kolom Jaar tot heden: standaard</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">De rijdefinities voor beide balansrapporten bevatten secties voor elk onderdeel van een traditionele balans.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Het rapport waarin secties naast elkaar worden weergegeven, bevat een kolomeinde, zodat de passiva en het eigen vermogen van de eigenaar naast activa worden weergegeven.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="132">
          <source>The Main Account Category dimension is used to build both row definitions.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">De dimensie Categorie van hoofdrekening wordt gebruikt om beide rijdefinities te maken.</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="133">
          <source>Therefore, anyone can generate the reports without having to make any modifications.</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm">Zo kan iedereen de rapporten genereren zonder wijzigingen te hoeven aanbrengen.</target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>Jaar tot heden en afwijking: standaardkolomtypen:<ept id="p1">**</ept></target></trans-unit>
        ...
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>FD<ept id="p1">**</ept>: financiële gegevens voor jaar tot heden voor het huidige jaar</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="139">
          <source><bpt id="p1">**</bpt>FD<ept id="p1">**</ept> – Year-to-date financial data for the last year</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>FD<ept id="p1">**</ept>: financiële gegevens voor jaar tot heden voor het afgelopen jaar</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="140">
          <source><bpt id="p1">**</bpt>CALC<ept id="p1">**</ept> – The variance from subtracting last year from this year</source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>CALC<ept id="p1">**</ept>: de afwijking na aftrek van afgelopen jaar van dit jaar</target></trans-unit>
        <trans-unit xml:space="preserve" translate="yes" id="141">
          <source><bpt id="p1">**</bpt>Year to Date Column – Default:<ept id="p1">**</ept></source>
        <target logoport:matchpercent="101" state="translated" state-qualifier="leveraged-tm"><bpt id="p1">**</bpt>Kolom Jaar tot heden: standaard:<ept id="p1">**</ept></target></trans-unit>
