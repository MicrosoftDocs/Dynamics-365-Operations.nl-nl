...
Maak gebruik van projecten met massale inhuur wanneer u in één keer meerdere werknemers aanneemt, zoals bij het aannemen van mensen om te voldoen aan een seizoengebonden vraag. Het maken van een project met massale inhuur is handig, omdat u tegelijkertijd functieregistraties, werknemerregistraties en werknemertoewijzingen voor functies kunt maken. Wanneer u functies voor een project met massale inhuur maakt, kunt u de volgende informatie opgeven:
-   Het aantal te maken functies
-   Het type werknemer van de mensen die u voor de functies wilt aanstellen
-   De afdeling en de taak die aan de functies zijn gekoppeld
-   De full-time equivalentwaarde van de functie
...
<tr class="odd">
<td>Gemaakt</td>
<td>U kunt gegevens maken en wijzigen, maar geen functies voor het project maken. Dit is de standaardstatus voor nieuwe projecten.</td>
</tr>
<tr class="even">
<td>Openstaand</td>
<td>U kunt de projectdetails wijzigen, functies voor het project met massale inhuur maken en mensen voor de functies aanstellen. Dit is de status voor actieve projecten.</td>
</tr>
<tr class="odd">
<td>Gesloten</td>
...
<tbody>
<tr class="odd">
<td>Voordat u een project met massale inhuur kunt sluiten, moeten alle functies in het project de status Gemaakt of Afgesloten hebben.</td>
</tr>
</tbody>
</table>
</div></td>
