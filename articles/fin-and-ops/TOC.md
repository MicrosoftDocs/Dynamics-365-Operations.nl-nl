...
#### [AX 2012-functies die nog niet zijn geïmplementeerd](get-started/ax-2012-features-not-implemented-but-not-deprecated.md)
...
#### [Kostenboekingen voor een kostenobject weergeven](../supply-chain/cost-management/tasks/view-cost-entries-cost-object.md)
...
#### [Een inkooporder maken die wordt geregeld door een budget](../supply-chain/cost-management/tasks/create-purchase-order-governed-by-budget.md)
#### Stuklijstberekeningen met behulp van het kostenblad
##### [Een eindproduct maken (uitsluitend februari 2016)](../supply-chain/pim/tasks/create-finished-product-2016-02.md)
##### [Een halffabrikaatproduct maken (uitsluitend februari 2016)](../supply-chain/pim/tasks/create-semi-finished-product-2016-02.md)
##### [Grondstoffen maken (uitsluitend februari 2016)](../supply-chain/pim/tasks/create-raw-materials-2016-02.md)
##### [Stuklijsten maken (uitsluitend februari 2016)](../supply-chain/pim/tasks/create-boms-2016-02.md)
##### [Routes maken (uitsluitend februari 2016)](../supply-chain/pim/tasks/create-routes-2016-02.md)
...
##### [Een stuklijst berekenen met behulp van een structuur met meerdere niveaus (uitsluitend februari 2016)](../supply-chain/cost-management/tasks/calculate-bom-multilevel-structure-2016-02.md)


## Gegevensbeheer en -integratie

### [Gegevensentiteiten, projecten en pakketten](../dev-itpro/data-entities/data-entities.md)
#### [Raamwerk gegevensentiteiten en pakketten](../dev-itpro/data-entities/data-entities-data-packages.md)
...
##### [Een nieuwe record maken met behulp van een recordsjabloon](../dev-itpro/data-entities/tasks/use-record-template-new-record.md)
...
#### [Aan de slag](../financials/cost-accounting/get-started.md)
##### [Terminologie voor kostprijsboekhouding](../financials/cost-accounting/terms-cost-accounting.md)
#### [Basisentiteiten configureren](../financials/cost-accounting/configure-base-entities.md)
##### [Valuta (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Wisselkoersen (eLearning)](https://mbspartner.microsoft.com/AX/CourseModules/1215.md) 
##### [Fiscale kalenders, boekjaren en boekperioden](../financials/budgeting/fiscal-calendars-fiscal-years-periods.md)
##### [Financiële dimensies](../financials/general-ledger/financial-dimensions.md)
...
##### [Mobiel werkgebied voor kostenbeheer (video)](https://youtu.be/imsuTg8rUVk.md)
...
##### [Werkgebied voor kostenbeheer gebruiken voor rapportage (Video)](https://youtu.be/imsuTg8rUVk.md)
##### [Vermeldingen exporteren naar Excel (video)](https://youtu.be/-HKHYdClvx8.md)
...
#### [Entiteiten exporteren naar uw eigen Azure SQL-database](../dev-itpro/analytics/export-entities-to-your-own-database.md)
#### [Analytische rapporten opstellen met behulp van Power BI Desktop](../dev-itpro/analytics/author-distribute-power-bi-reports.md)
#### [Analytische toepassingen publiceren op Power BI](../dev-itpro/analytics/publish-apps-powerbi.md)


## Voorraadbeheer
### [Inkomend proces](../supply-chain/inventory/arrival-overview.md)
#### [Aankomstoverzicht](../supply-chain/inventory/arrival-overview.md)
...
### Consignatievoorraad
#### [Consignatie](../supply-chain/inventory/consignment.md)
#### [Consignatie instellen](../supply-chain/inventory/set-up-consignment.md)
...
#### [Consignmentvoorraad bewaken door middel van leverancierssamenwerking (taakbegeleiding)](../supply-chain/inventory/tasks/monitor-consignment-inventory-vendor-collaboration.md)
### [Kwaliteitsbeheer](../supply-chain/inventory/quality-management-processes.md)
...
## Hoofdplanning
### Vraagprognose maken
#### [Overzicht van vraagprognose](../supply-chain/master-planning/introduction-demand-forecasting.md)
...
#### [Hoofdplannen](../supply-chain/master-planning/master-plans.md)
...
#### [Samenwerken met leveranciers met behulp van de leveranciersportal](../supply-chain/procurement/collaborate-vendors-vendor-portal.md)
#### [Mobiel werkgebied voor leverancierssamenwerking](../supply-chain/procurement/vendor-collaboration-mobile-workspace.md)
#### [Gebruikersbeveiliging in leveranciersportal](../supply-chain/procurement/configure-security-vendor-portal-users.md)
...
#### Productietaken
##### [Een kanbanberekeningsbeleid aan een kanbanregel toevoegen](../supply-chain/production-control/tasks/add-kanban-quantity-calculation-policy-kanban-rule.md)
##### [Suggesties voor kanbanhoeveelheid berekenen](../supply-chain/production-control/tasks/calculate-kanban-quantity-suggestions.md)
##### [Kanbanregels wijzigen voor een procestaak](../supply-chain/production-control/tasks/change-kanban-rules-process-job.md)
##### [Een kanbanregel voor gebeurtenis stuklijstregel maken](../supply-chain/production-control/tasks/create-bom-line-event-kanban-rule.md)
##### [Een kanbanregel met vaste hoeveelheid maken voor productie](../supply-chain/production-control/tasks/create-fixed-quantity-kanban-rule-manufacturing.md)
##### [Een kanbanregel maken met een kanbanregelgebeurtenis](../supply-chain/production-control/tasks/create-kanban-rule-kanban-line-event.md)
##### [Een kanbanregel maken met een gebeurtenis minimale voorraad](../supply-chain/production-control/tasks/create-kanban-rule-minimum-stock-event.md)
##### [Een kanbanregel maken voor meerdere activiteiten](../supply-chain/production-control/tasks/create-kanban-rule-multiple-activities.md)
##### [Een nieuwe kanbanregel maken door een bestaande kanbanregel te dupliceren](../supply-chain/production-control/tasks/create-new-kanban-rule-duplicating-existing-kanban-rule.md)
##### [Een vervangende kanbanregel maken](../supply-chain/production-control/tasks/create-replacement-kanban-rule.md)
##### [Een kanbanregel voor verkoopgebeurtenis maken](../supply-chain/production-control/tasks/create-sales-event-kanban-rule.md)
##### [Een opnamekanbanregel maken](../supply-chain/production-control/tasks/create-withdrawal-kanban-rule.md)
##### [Kanbanprocestaken uitvoeren](../supply-chain/production-control/tasks/execute-kanban-process-jobs.md)
##### [Geplande kanbantaken verplaatsen](../supply-chain/production-control/tasks/move-scheduled-kanban-jobs.md)
##### [Een proceskanbantaak voorbereiden wanneer de materialen voor de werkcel beschikbaar zijn](../supply-chain/production-control/tasks/prepare-kanban-job-materials.md)
##### [Een proceskanbantaak voorbereiden wanneer de materialen niet beschikbaar zijn voor de werkcel](../supply-chain/production-control/tasks/prepare-process-kanban-job-materials-not-available.md)
##### [Een kanbantaak uit de planning verwijderen](../supply-chain/production-control/tasks/remove-kanban-job-schedule.md)
##### [Kanbantaakstatus terugdraaien](../supply-chain/production-control/tasks/revert-kanban-job-status.md)
##### [Kanbantaken plannen](../supply-chain/production-control/tasks/schedule-kanban-jobs.md)
##### [Materialen overboeken met kanbantaken (uitsluitend februari 2016)](../supply-chain/production-control/tasks/transfer-materials-kanban-jobs.md)
##### [Kanbanstatus bijwerken](../supply-chain/production-control/tasks/update-kanban-status.md)

##### [Procesactiviteiten maken voor lean manufacturing](../supply-chain/production-control/tasks/create-process-activities-lean-manufacturing.md)
##### [Overboekingsactiviteiten maken voor lean manufacturing](../supply-chain/production-control/tasks/create-transfer-activities-lean-manufacturing.md)
##### [Werkcellen voor lean manufacturing definiëren](../supply-chain/production-control/tasks/define-lean-manufacturing-work-cells.md)
##### [Kanbanschemagroepen definiëren](../supply-chain/production-control/tasks/define-lean-schedule-groups.md)
##### [Lean tracering van de behoefte vanuit verkooporders](../supply-chain/production-control/tasks/lean-pegging-sales-orders.md)
##### [Een uitbestede werkcel voor lean manufacturing maken](../supply-chain/production-control/tasks/create-subcontracted-work-cell-lean-manufacturing.md)


##### [Resourcegroep voor afzonderlijke productie definiëren](../supply-chain/production-control/tasks/define-discrete-manufacturing-resource-group.md)

##### [Een productiestroomversie activeren](../supply-chain/production-control/tasks/activate-production-flow-version.md)
##### [Een bestaande activiteit toevoegen aan een productiestroomversie](../supply-chain/production-control/tasks/add-existing-activity-production-flow-version.md)
##### [Een voorafgaande taak toevoegen aan een productiestroomactiviteit](../supply-chain/production-control/tasks/add-predecessor-production-flow-activity.md)
##### [Een productiestroomversie maken](../supply-chain/production-control/tasks/create-production-flow-version.md)
##### [Een productiestroomversie deactiveren](../supply-chain/production-control/tasks/deactivate-production-flow-version.md)
##### [Een vervaldatum voor een productiestroomversie definiëren](../supply-chain/production-control/tasks/define-expiry-date-production-flow-version.md)
##### [Modellen voor productiestroom definiëren](../supply-chain/production-control/tasks/define-production-flow-models.md)
##### [Een productiestroom en -versie valideren](../supply-chain/production-control/tasks/validate-production-flow-version.md)

##### [Eigenschappen van werktijdplanningen maken](../supply-chain/production-control/tasks/create-working-time-scheduling-properties.md)
##### [Werktijdsjablonen maken](../supply-chain/production-control/tasks/create-working-time-templates.md)

##### [Een productieorder maken](../supply-chain/production-control/tasks/create-production-order.md)
##### [Een productieorder beëindigen](../supply-chain/production-control/tasks/end-production-order.md)
##### [Een productieorder ramen](../supply-chain/production-control/tasks/estimate-production-order.md)
##### [Een productieorder vrijgeven](../supply-chain/production-control/tasks/release-production-order.md)
##### [Een productieorder gereedmelden](../supply-chain/production-control/tasks/report-production-order-finished.md)
##### [Een productieorder plannen](../supply-chain/production-control/tasks/schedule-production-order.md)
##### [Een productieorder plannen met bewerkingen en taakplanning](../supply-chain/production-control/tasks/schedule-production-order-operations-job-scheduling.md)
##### [Een productieorder starten](../supply-chain/production-control/tasks/start-production-order.md)

##### [Coproducten uit een bestaande formuleversie kopiëren](../supply-chain/production-control/tasks/copy-co-products-existing-formula-version.md)
##### [Een formule kopiëren](../supply-chain/production-control/tasks/copy-formula.md)
##### [Een formule maken door uit een bestaande formule te kopiëren](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)

##### [Levensduur van batchorder van aanmaakdatum tot startdatum](../supply-chain/production-control/tasks/batch-order-lifecycle-start.md)
##### [Een product door middel van categoriehiërarchiën classificeren](../supply-chain/pim/tasks/classify-product-category-hierarchies.md)
##### [Activiteitsrelatie maken: opvolgende activiteit](../supply-chain/production-control/tasks/create-activity-relation-successor.md)
##### [Een formule maken door uit een bestaande formule te kopiëren](../supply-chain/production-control/tasks/create-formula-copying-existing-formula.md)
##### [Bron voor bedrijfsactiviteiten maken](../supply-chain/production-control/tasks/create-operations-resource.md)
##### [Een waardestroom maken](../supply-chain/production-control/tasks/create-value-stream.md)
##### [Bronmogelijkheden definiëren](../supply-chain/production-control/tasks/define-resource-capabilities.md)
...
##### [Gereedmelden aan een locatie waar nummerplaten worden gecontroleerd ](../supply-chain/production-control/tasks/report-finished-non-license-plate-controlled-location-2016-11.md)
##### [Voortgang rapporteren op een mobiel taakapparaat](../supply-chain/production-control/tasks/report-progress-mobile-job-device.md)
##### [Volgorde voor productietaken bepalen voor procesfabricage](../supply-chain/production-control/tasks/sequence-production-jobs-process-manufacturing.md)
##### [Het veiligheidsvoorraadjournaal gebruiken om de minimumbehoefteplanning bij te werken](../supply-chain/production-control/tasks/use-safety-stock-journal-update-minimum-coverage.md)
...
#### Product voor geplande orders voorbereiden 
...
#### Kosten voor product ramen
##### [Stuklijstberekeningen](../supply-chain/cost-management/bom-calculations.md)
### Productconfiguratiemodellen
#### [Een productconfiguratiemodel opstellen](../supply-chain/pim/build-product-configuration-model.md)
...
##### [Op dimensie gebaseerde configuratie](../supply-chain/pim/dimension-based-product-configuration.md)
...
#### Op beperkingen gebaseerde configuratie maken
...
##### [Een configuratiemodel instellen](../supply-chain/pim/set-up-maintain-product-configuration-model.md)
