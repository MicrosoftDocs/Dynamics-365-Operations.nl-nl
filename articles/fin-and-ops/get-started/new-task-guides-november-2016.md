...
De APQC Unified Library (november 2016, alle talen) bevat de taakbegeleidingen die zijn bedoeld om te gebruiken voor Help bij Microsoft Dynamics 365 for Operations, Microsoft Dynamics 365 for Operations platformupdate 3, Microsoft Dynamics AX platformupdate 2, de Dynamics AX-update van mei 2016 en de Microsoft Dynamics AX-release van februari 2016. Zie voor meer informatie over deze versies [Wat is nieuw of gewijzigd](whats-new-changed.md). Gelokaliseerde versies van de taakbegeleidingen zijn beschikbaar in deze bibliotheek. Zie voor meer informatie over het verbinden van het Help-systeem met een bibliotheek met taakbegeleidingen het onderwerp [Aan de slag met Help](help-overview.md). <strong>Opmerking:</strong> een sterretje (<strong>\</strong>*) naast de titel van een BPM-regel (Business Process Modeler) geeft aan dat de taakbegeleiding voor dat bedrijfsproces is gemaakt voor de update van Microsoft Dynamics 365 for Operations van november 2016 en niet wordt ondersteund in eerdere versies van Microsoft Dynamics AX.

### <a name="accounts-payable"></a>Leveranciers    

| BPM-regel                                                                                           | Land/regio |
|----------------------------------------------------------------------------------------------------|----------------|
| Belangrijke factuurgegevens in leverancierssysteem met goedkeuringsjournaal                                               | Globaal         |
| Belangrijke factuurgegevens in AP-systeem door middel van de leveranciersfactuur (invoeren en boeken van een leveranciersfactuur met matching) | Globaal         |
...
| De ontvangst van een leverancierfactuur vastleggen en met ontvangen hoeveelheid matchen                           | Globaal         |
...
| Rente berekenen en rentenota's maken en afdrukken en boeken (rente verwerken) | Globaal         |
...
| Incassogegevens controleren                                                      | Globaal         |
...
| BPM-regel                    | Land/regio |
|-----------------------------|----------------|
| Een budgetplanindeling aanpassen | Globaal         |
...
| Overzicht van leveranciersbetalingen                                             | Globaal         |
...
|                                                <strong>\</strong>*Chinese controle van continuïteit van boekstuk                                                |               China               |
|                                         <strong>\</strong>* CN-00010 Chinese hiërarchie voor rekeningschema                                          |               China               |
|                                       <strong>\</strong>* CN-00016 Logboek met gebruikerbewerkingen door Chinese werkregel                                        |               China               |
|                                              <strong>\</strong>*Exportinstellingen voor Chinese industriële btw-integratie                                               |               China               |
|                                     <strong>\</strong>*Boekstukken boeken vanuit andere modules zoals verkoopfacturen                                      |               China               |
|                                             <strong>\</strong>*Boekstukken vanuit het algemeen journaal boeken                                             |               China               |
|                                         <strong>\</strong>*Een basaal belastingsintegratieprofiel voor China instellen                                         |               China               |
|                                                    <strong>\</strong>*Chinese boekstukken instellen                                                     |               China               |
|                                          Een klantfactuur maken en boeken voor een klant in de openbare sector                                          |              Denemarken              |
...
|                              DK-00007 FIK 752 giro-overboekingsstrook/Een vrije-tekstfactuur met een betalingsbon boeken                               |              Denemarken              |
|                               DK-00007 FIK 752 giro-overboekingsstrook/Een projectfactuur met een betalingsbon boeken                                |              Denemarken              |
...
|                                             <strong>\</strong>*EEU-00047 Vooruitbetaling aan werknemer                                              |          Oost-Europa           |
...
|                                           <strong>\</strong>*EE-00015 Tool voor genereren van betalingsverwijzingen                                           |              Europa               |
|                                                  EUR-00002 Een EU Intrastat-aangifte genereren                                                   |              Europa               |
|                             <strong>\</strong>*EUR-00002 Een vrachtadres opgeven voor een intracommunautaire transactie                              |              Europa               |
...
|                                              <strong>\</strong>*EUR-00015 Een partij zoeken door middel van het btw-id                                               |              Europa               |
|                                            <strong>\</strong>*EUR-00015 Registratie van het btw-id van een leverancier                                             |              Europa               |
|                                                    <strong>\</strong>*EUR-00015 Een btw-id instellen                                                     |              Europa               |
|                                               <strong>\</strong>* HU-00001 Wisselkoersberekening                                               |              Europa               |
...
|  <strong>\</strong>* LT-00003 Overboekingsdocument voor verplaatsing van goederen binnen een bedrijf/Een overboekingsdocument genereren voor een interne voorraadoverboeking  |              Europa               |
| <strong>\</strong>* LT 00003 Overboekingsdocument voor verplaatsing van goederen binnen een bedrijf/De overboekingsdocumenten instellen voor verplaatsing van goederen binnen een bedrijf |              Europa               |
|                                         <strong>\</strong>* NO-00002 Klantbetaling op basis van betalings-id                                          |              Europa               |
...
|                                                       FR-00002 Klant- en leveranciersrekeningen                                                        |              Frankrijk               |
...
|                           ER Indeling configureren voor tellen en totaliseren (deel 3: Berekeningen gebruiken om de uitvoer te maken)                            |              Duitsland              |
|                                        ER Indeling configureren voor tellen en totaliseren (deel 4: Indeling uitvoeren)                                        |              Duitsland              |
|                                             ER Een configuratieprovider maken en deze als actief markeren                                              |              Duitsland              |
...
|                                              <strong>\</strong>*EUR-00018 Btw-afstemmingsrapport                                               |              IJsland              |
...
|                                          Rekeningschema onderhouden/Verplichte betalingsverwijzingen instellen                                           |              IJsland              |
|                                              Een vast activum aanschaffen met de verplichtingen van activapensionering                                              |               Japan               |
|                                               Aanschaffen vaste activa, overheidssubsidie claimen                                                |               Japan               |
|                                              Correctie van schatting verplichte afschrijving activum                                               |               Japan               |
|                                Wijs de boekwaarde van gedeeld activum en goodwill aan kasstroomgenererende eenheden toe                                 |               Japan               |
...
|                                Een afschrijvingsprofiel en een boekingsprofiel configureren voor aanvullende afschrijving                                 |               Japan               |
|                                  Een afschrijvingsprofiel en een boekingsprofiel configureren voor speciale afschrijving                                  |               Japan               |
...
|                                                       Een materiaalgroep maken en toewijzen                                                        |               Japan               |
...
|                              JP-00011 Geconsolideerde factuur - AR - Een geconsolideerde factuur van klanten maken en bevestigen                              |               Japan               |
|                                                 JP-00027 Formulier 26 voor afschrijfbare belastingaangifte                                                  |               Japan               |
...
|                                                   De versnelde afschrijving voorstellen en boeken                                                   |               Japan               |
...
|                                            MY-00003 Debet- en creditnota's van klanten beheren voor GST                                            | Singapore, Maleisië en Thailand |
...
| Activa vanuit Leveranciers maken en aanschaffen           | Globaal         |
...
| Een journaalboeking maken met een sjabloon        | Globaal         |
...
| Sjablonen voor financiële dimensies onderhouden         | Globaal         |
| Groot aantal financiële perioden afsluiten                    | Globaal         |
| Journaalposten verwerken                        | Globaal         |
...
|                                          BPM-regel                                           | Land/regio |
|---------------------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Het eigendom van consignatievoorraad wijzigen op basis van de productievraag |     Globaal     |
|                 <strong>\</strong>*Een consignatieaanvullingsorder maken                 |     Globaal     |
|         <strong>\</strong>*Consignmentvoorraad bewaken door middel van leverancierssamenwerking         |     Globaal     |
...
|                                   BPM-regel                                    | Land/regio |
|-------------------------------------------------------------------------------|----------------|
| <strong>\</strong>*Toevoegen aan uw prestatiejournaal en lovende kritiek naar iemand verzenden |     Globaal     |
|                       <strong>\</strong>*Een doelactiviteit maken                        |     Globaal     |
|                <strong>\</strong>*Een prestatiebeoordeling maken                 |     Globaal     |
...
| \* Een productnummernomenclatuur maken voor vooraf bepaalde productvarianten | Globaal         |
| \* Een productnummernomenclatuur voor geconfigureerde productvarianten maken | Globaal         |
| \* Standaardorderinstellingen voor een artikel                            | Globaal         |
...
| Toegang tot inkoopovereenkomsten in Openbare sector beheren                      | Globaal         |
...
| Voorbladen en handtekeningpagina's voor betalingsrapporten voor de openbare sector maken   | Globaal         |
...
| Een fonds instellen voor de openbare sector                                            | Globaal         |
...
| <strong>\</strong>* Door machine learning aangestuurde productaanbevelingen configureren |     Globaal     |
|        Het functionaliteitsprofiel voor een verkoopvertegenwoordiger configureren         |     Globaal     |
|        <strong>\</strong>*Een visueel profiel voor POS maken (november 2016)         |     Globaal     |
...
|         <strong>\</strong>*Afzetkanaalcommunicatie definiëren (CDX)         |     Globaal     |
...
| Verkooporderwachtstanden beheren                   | Globaal         |
...
### <a name="supply-relationship-management"></a>Relatiebeheer leveranciers
...
| <strong>\</strong>*Een menuopdracht voor een mobiel apparaat maken ten behoeve van nummerplaatconsolidatie |     Globaal     |
...
|                           Een transportbetalingsmethode instellen                            |     Globaal     |
...
[Nieuwe of bijgewerkte taakbegeleidingen beschikbaar (augustus 2016)](new-updated-task-guides-available-august-2016.md)
