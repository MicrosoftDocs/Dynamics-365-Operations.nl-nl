...
> [!NOTE]
> Een sterretje (\*) naast de titel van een BPM-regel (Business Process Modeler) geeft aan dat de taakbegeleiding voor dat bedrijfsproces is gemaakt voor de update van Microsoft Dynamics 365 for Operations van november 2016 en niet wordt ondersteund in eerdere versies van Microsoft Dynamics AX.
...
| \*Chinese controle van continuïteit van boekstuk                                                                                               | China                             |
...
| \*EUR-00015 Een partij zoeken door middel van het btw-id                                                                                            | Europa                            |
| \*EUR-00015 Registratie van het btw-id van een leverancier                                                                                        | Europa                            |
...
| \*Een consignatieaanvullingsorder maken                                 | Globaal         |
| \*Consignmentvoorraad bewaken door middel van leverancierssamenwerking                 | Globaal         |
...
| \*Een nomenclatuur met productnummers maken voor vooraf gedefinieerde productvarianten | Globaal         |
| \*Een nomenclatuur met productnummers maken voor geconfigureerde productvarianten | Globaal         |
...
| \*Een visueel profiel voor POS maken (november 2016)                  | Globaal         |
