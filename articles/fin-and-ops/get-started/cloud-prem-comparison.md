...
| Intelligence| | Ja | Ja |
| | Elektronische rapportage (ER) - Integratie met LCS | Ja | Nee|
| | Elektronische rapportage (ER) - Integratie met SharePoint | Ja | Nee|
...
| Gebied | Functie | Cloud | On-premises|
|---|---|---|---|
| Alle detailhandelgebieden | Alle detailhandelsfuncties | Ja | Nee |
