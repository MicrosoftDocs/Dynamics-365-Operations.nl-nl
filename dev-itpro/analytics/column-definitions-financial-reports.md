...
-   Het koptekstgebied van de kolomdefinitie bevat de koptekst en opmaak die in het rapport wordt weergegeven. Een koptekst kunt toepassen op een enkele kolom met gegevens, kan betrekking hebben op meerdere kolommen of kunt toepassen op kolommen op basis van voorwaardelijke. De kolomdefinitie kan zoveel kolomkoptekstrijen als nodig is bevatten. **Opmerking:** De kolomkopteksten zijn van toepassing op elke kolom van gegevens in het rapport. Rapportkopteksten zijn van toepassing op het hele rapport. U definieert rapportkopteksten op het tabblad **Kop- en voetteksten** van de rapportdefinitie.
...
|-------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| SU                      | Het onderstrepingsteken voor een kolom onderdrukken wanneer een onderstrepingsteken (**---**) of een dubbel onderstrepingsteken (**===**) wordt ingevoerd in de rijdefinitie vermeld. U wilt misschien geen bedragen onderstrepen die door een percentageberekening zijn geproduceerd.                                                                        |
...
| Beschrijving periode (@FiscalPeriodName)  | Druk de omschrijving van de boekperiode af die in de financiële gegevens is geïdentificeerd.                                                                                                                                                                                                                    |
...
| Eenheidsnaam vanaf structuur (@UnitName)         | Als u een kolom beperkt tot een specifieke eenheid uit de rapportagestructuur, drukt u de naam van de eenheid af in de kolomkop.                                                                                                                                                                                     |
| Eenheidomschrijving (@UnitDesc)            | Als u een kolom beperkt tot een specifieke eenheid uit de rapportagestructuur, drukt u de omschrijving van de eenheid af in de kolomkop.                                                                                                                                                                              |
| Code van het adresboek (@BookCode)                   | Druk de boekcode af die is opgegeven in de kolom.                                                                                                                                                                                                                                             |
...
-   Als kolomkoppen opgeeft die overlappen, overlappen deze wanneer ze in het rapport worden afgedrukt. Het rapport wordt gegenereerd, maar de volgende waarschuwing wordt weergegeven in de **Rapportwachtrijstatus** veld: "kolomkopteksten die Base gebruiken snijden andere kolomkopteksten en kunnen er overlappende tekst." Bijvoorbeeld de koptekstdefinitie van de van kolom B B tot BASE + 1 is, en de koptekstdefinitie van de van kolom D is BASE + 1 tot en met F. In dit geval wordt de kop boven op elkaar worden afgedrukt en zijn onleesbaar. Wanneer BASE wordt gebruikt in een definitie **Verspreiden van/Verspreiden naar**, moet u het rapport dat wordt gegenereerd bekijken om te zien of de kopteksten overlappen.
...
-   Voor kolommen met voorwaardelijke afdrukken (**P&lt;B**, **P&gt;= B**), voorwaardelijke omspannende kopteksten gedragen zich als een gewone kolomkopdefinitie. Als de voorwaarde bijvoorbeeld onwaar is, start elke volgende kolom die voldoet aan de verspreidingsvoorwaarde met de afdruk van de koptekst.
...
3.  Selecteer een kolomtype in de lijst. In de volgende tabel worden de verschillende kolomtypen beschreven.
    ...
    <tr class="odd">
    <td>ATTR</td>
    <td>Als uw boekhoudsysteem kenmerken ondersteunt, een geeft u in de kolom een rekening- of transactiekenmerk weer. Een kenmerk, dat van toepassing moet zijn op één volledige rekening, pakt gegevens van een onderliggende rekening of transactie uit de financiële gegevens uit. Kenmerken op rekeningniveau weergegeven gegevens van de rekening en kenmerken op transactieniveau worden gegevens die zich hebben voorgedaan op het moment dat de transactie is geboekt. Als u <strong>ATTR</strong> opgeven als het kolomtype, de categorie van het kenmerk in de <strong>boekcode/Kenmerkcategorie</strong> detailrij van de kolomdefinitie.</td>
    </tr>
    </tbody>
    </table>
...
| BASE +\# | Gebruik van het jaar \#jaar na het basisjaar. Als u bijvoorbeeld het derde jaar na het basisjaar wilt gebruiken, voert u **BASE+3** in. |
| BASE:\# | Gebruik van het jaar \#jaar vóór het basisjaar. Als u bijvoorbeeld het vorige jaar wilt gebruiken, voert u **BASE-1** in.                 |
...
| BASE +\#         | Gebruik de periode die is \#perioden na de basisperiode. Als u bijvoorbeeld de derde periode na de basisperiode wilt gebruiken, voert u **BASE+3** in.                                                                                               |
| BASE:\#         | Gebruik de periode die is \#perioden vóór de basisperiode. Als u bijvoorbeeld de vorige periode wilt gebruiken, voert u **BASE-1** in.                                                                                                                 |
...
U kunt verder gaan dan de grenzen van het fiscaal jaar in elke periodespecificatie en u kunt jaren mengen in een bereik van perioden. Bijvoorbeeld het opgeven van de perioden als **BASE-5** (voor de laatste zes perioden) en uitvoeren van een rapport met een periode van 2. In dit geval worden de gegevens van het rapport worden voor de eerste twee perioden van het opgegeven boekjaar en de laatste vier perioden van het vorige boekjaar.
...
3.  Voer in de formulebalk boven in het navigatievenster of in de cel **Periode** de formule in. Vervang een hekje (\#) met de juiste waarde.
...
Een dimensiefilter wordt gebruikt om de **FD**-kolom te beperken tot specifieke dimensiewaarden. Het filter kan één dimensie, een bereik van dimensies of een groep van dimensies bevatten. Het filter kan ook verzamelingen van dimensiewaarden opnemen. Omdat dimensiewaarden variëren kunnen, een... \financial-dimensions\dimension-based systeem hoeft te komen overeen met een exacte lengte. Het filter wordt toegepast, ongeacht of het rapport een rapportagestructuur bevat. U kunt een jokerteken (\* of?) op elke positie. Wanneer u meerdere rekeningen opgeeft, plaatst u een komma tussen de rekeningen, zoals in het volgende voorbeeld: + rekening =\[1200\], + rekening =\[1100\], afdeling =\[01?\] Om alle afdelingen voor een bepaalde rekening te ontvangen, kunt u de dimensie voor de afdeling uit het dimensiefilter uitsluiten. Bijvoorbeeld, de volgende dimensiefilters worden op dezelfde manier verwerkt:

-   + Rekening =\[1100\], afdeling
-   + Rekening =\[1100\]

U kunt ook een willekeurige combinatie van alfanumerieke tekens gebruiken voor exacte overeenkomst, en u kunt gedeeltelijke dimensies definiëren. Bijvoorbeeld: **locatie = \[10\*\]** omvat alle locatie dimensiewaarden die beginnen met 10.
...
-   **Weergave rekeningvaluta** : het type valuta (natuurlijke, functionele of rapportage) opgeven die de transacties worden weergegeven in. Deze functionaliteit wordt ook wel valutaomrekening genoemd. De valutaomzetting is het vermogen om grootboekbedragen te rapporteren in een valuta die misschien niet de functionele valuta van het bedrijf is of de valuta waarin de transactie werd ingevoerd.
...
**Opmerking:** De opties die hier worden beschreven, kunnen verschillen, afhankelijk van het ERP-systeem. Zie voor meer informatie uw [documentatie bij Microsoft ERP-systeem](https://www.microsoft.com/en-us/download/details.aspx?id=5916).
...
| Functionele valuta van bedrijfsgegevens | Leeg                | **$2,310\*\*** : het resultaat worden alle gegevens in de bedrijfsvaluta die is opgegeven in de bedrijfsgegevens. **Opmerking:** Dit bedrag is de som van alle transacties in functionele valuta. |
...
U kunt een kolom maken die alle waarden in een opgegeven kolom weergeeft als een percentage van een basisnummer. Daarom kunt u relaties tussen rijen weergeven, zoals een percentage van een verkopenrij of een percentage van een totale onkostenrij. Als u wilt vermenigvuldigen of delen van elke rij in een bepaalde kolom door een basisrij, voer de kolom die u wilt gebruiken in de berekening en voer vervolgens **\*BASEROW** of **/BASEROW**. Voer bijvoorbeeld **C\*BASEROW** of **C/BASEROW**. ** Opmerking:** Wanneer u een basisrijberekening in een kolomdefinitie gebruikt, moet u ervoor zorgen dat elke rijdefinitie die in deze kolomdefinitie wordt gebruikt ten minste één basisrij voor berekeningen bevat.
