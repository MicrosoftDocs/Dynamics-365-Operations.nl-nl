...
---
# <a name="create-a-configuration-providand-mark-it-as-active-for-electronic-reporting-er"></a>Een configuratieprovider maken en deze als actief markeren voor elektronische aangifte (ER)
