...
---
# <a name="use-computations-to-make-the-output-for-counting-and-summing-for-electronic-reporting-er"></a>Berekeningen gebruiken voor het maken van de uitvoer voor tellen en totaliseren voor elektronische aangifte (ER)
