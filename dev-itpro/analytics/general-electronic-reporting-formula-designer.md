...
<td>Als de landinstelling van de server van het Dynamics 365 for Operations-exemplaar is gedefinieerd als <strong>EN-US</strong>, retourneert <strong>TEXT (NOW ())</strong> de huidige sessiedatum van Dynamics 365 for Operations, 12/17/2015, als de tekenreeks <strong>&quot;12/17/2015 07:59:23 AM&quot;</strong>. <strong>TEXT (1/3)</strong> retourneert <strong>&quot;0.33&quot;</strong>.</td>
</tr>
<tr class="even">
...
De formule die kan worden ontworpen, is als volgt: FORMAT (CONCATENATE (@&quot;SYS70894&quot;, &quot;. &quot;, @&quot;SYS18389&quot;), model.Customer.Name, DATETIMEFORMAT (model.ProcessingDate, &quot;d&quot;)) Als een rapport wordt verwerkt voor de <strong>klant Litware Retail</strong> op 17 december 2015 in de cultuur <strong>EN-US</strong> en de taal <strong>EN-US</strong>, retourneert deze formule de volgende tekst, die kan worden weergegeven als uitzonderingsbericht voor de eindgebruiker: &quot;Nothing to print. Customer Litware Retail is stopped for 12/17/2015."&quot; Als hetzelfde rapport voor de <strong>klant Litware Retail</strong> wordt verwerkt op 17 december 2015 in de cultuur <strong>NL</strong> en de taal <strong>NL</strong>, retourneert deze formule de volgende tekst die een andere datumnotatie gebruikt: &quot;Er is niets om af te drukken. Klant "Litware Retail" is gestopt voor 17-12-2015.&quot; <strong>Opmerking: </strong>de volgende syntaxis wordt toegepast in ER-formules voor labels:
<ul>
<li><strong>Voor labels van Dynamics 365 for Operations-resources:</strong> <strong>@&quot;X&quot;</strong>, waarbij X de label-ID in de Application Object Tree (AOT) is</li>
<li><strong>Voor labels die zich in ER-configuraties bevinden:</strong> <strong>@&quot;ER_LABEL:X&quot;</strong>, waarbij X de label-ID in de ER-configuratie is</li>
</ul></td>
</tr>
<tr class="odd">
...
SUMIFS (sleutelreeks voor optelling, tekenreeks criteriumbereik1, tekenreeks criteriumwaarde1 \[, tekenreeks criteriumbereik2, tekenreeks criteriumwaarde2 tekenreeks, …\])
...
COUNTIFS (tekenreeks criteriumbereik1, tekenreeks criteriumwaarde1 \[, tekenreeks criteriumbereik2, tekenreeks criteriumwaarde2, …\])
...
COLLECTEDLIST (tekenreeks criteriumbereik1, tekenreeks criteriumwaarde1 \[, tekenreeks criteriumbereik2, tekenreeks criteriumwaarde2, …\])
...
| ROUNDAMOUNT (aantal, decimalen, afrondingsregel)                                       | Rond het opgegeven bedrag af op basis van de opgegeven afrondingsregel en het opgegeven aantal decimalen. **Opmerking:** de afrondingsregel moet worden opgegeven als een waarde van de Dynamics 365 for Operations-opsomming **RoundOffType**.                          | Als de parameter **model.RoundOff** is ingesteld op Downward, retourneert **ROUNDAMOUNT (1000,787, 2, model.RoundOff)** de waarde **1000,78**. Als de parameter **model.RoundOff** is ingesteld op **Normal** of **Rounding-up**, retourneert **ROUNDAMOUNT (1000,787, 2, model.RoundOff)** de waarde **1000,79**. |
...
| FA\_BALANCE (code vast activum, waardemodelcode, aangiftejaar, aangiftedatum) | Retourneert de voorbereide gegevenscontainer van vaste-activasaldi. Het rapportjaar moet zijn gespecificeerd als waarde van een Dynamics 365 for Operations-opsomming **AssetYear**.                                                                                           | FA\_SUM ("COMP-000001", “Current”, AxEnumAssetYear.ThisYear, SESSIONTODAY ()) retourneert de voorbereide gegevenscontainer met saldi voor het vaste activum "COMP-000001" met het waardemodel “Current” op de huidige sessiedatum voor Dynamcis 365 for Operations.                                                                |
