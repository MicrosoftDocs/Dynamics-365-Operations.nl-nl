...
<tbody>
<tr class="odd">
<td><strong>Wat kunt u doen?</strong></td>
<td><strong>Dynamics AX 2012</strong></td>
<td><strong>Dynamics AX 7.0</strong></td>
<td><strong>Waarom is dit belangrijk?</strong></td>
</tr>
<tr class="even">
<td>Snel een overzicht krijgen van de voorraadbalans, de OHW-voorraadbalans (onderhanden werk) en wat de voorraadmutaties voor de geselecteerde boekperiode zijn.</td>
...
| Zet de Business Connector in om scenario's voor bedrijfslogica en ondersteuningintegratie op te stellen.         | De business connector is beschikbaar voor X ++-code aanroepen vanuit beheerde code. Wij raden aan dat u de business connector alleen aan de bedrijfslogica van de auteur in C\#, niet voor integratie-scenario's. | De Business Connector wordt niet meer ondersteund. In de behoefte om scenario's aan te maken wordt voorzien doordat X++ in de beheerde code is gecompileerd. Daarom is interop eenvoudiger. In integratiescenario's wordt voorzien door middel van OData.       | U kunt de Business Connector in de toekomst niet meer gebruiken.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
...
<td>Feitenblokken zijn toegevoegd aan de pagina **Rekeningschema**.</td>
<td> Toegang tot belangrijke informatie is eenvoudiger wanneer een rekeningschema is gedefinieerd en toegewezen.</td>
</tr>
<tr class="odd">
<td>Geef correcties op het afsluitwerkblad en afsluittransacties in afzonderlijke kolommen weer op de lijstpagina **Proefbalans**. </td>
<td>De gebruiker ziet beide transactietypen in één kolom.</td>
<td>Er is een extra parameter toegevoegd aan de lijstpagina **Proefbalans**.</td>
...
<tr class="even">
<td>Gebruik de nieuwe pagina **Globale algemene journalen**.</td>
<td>Niet beschikbaar </td>
<td>Nieuwe pagina **Globale algemene journalen** voor het invoeren van algemene journalen. Rechten voor deze pagina worden toegevoegd aan de rol **Accountant**.</td>
...
<tr class="odd">
<td>Gebruik de nieuwe pagina **Boekhoudingsbronverkenner**.</td>
<td>Beschikbaar vanaf Dynamics AX 2012 R3-CU10.</td>
<td>Nieuwe pagina **Boekhoudingsbronverkenner** en acties om daar naartoe te gaan vanaf de lijspagina **Proefbalans** en de pagina **Boekstuktransacties**.</td>
...
<td>Rapportopties zijn toegevoegd, zodat verschillende filters kunnen worden toegepast wanneer een gebruiker een rapport bekijkt. Een nieuw rapport wordt vervolgens gegenereerd op basis van deze filters.</td>
...
<td>Financiële gegevens analyseren met behulp van de 'Financiële prestaties controleren' Power BI-inhoud.</td>
<td>Niet beschikbaar</td>
<td>Selecteer in PowerBI.com **Get Data** en selecteer vervolgens het inhoudpakket **Dynamics AX - Financial performance**. Voer de URL voor uw Dynamics AX-eindpunt in om uw gegevens in het dashboard te bekijken.</td>
...
<td>Niet beschikbaar </td>
<td>De afsluitingssjablonen en -plannen kunnen worden gemaakt met de Financiële periode afsluiten configuratie. Gebruik de werkruimte **Financiële periode afsluiten** om de voortgang van afsluitingsplannen voor meerdere bedrijven te volgen.</td>
...
<tr class="odd">
<td>Vergelijk budgetgegevens met werkelijke cijfers en stel grootboekprognoses op met de werkruimte **Grootboekbudgetten en prognoses** en aanvullende queryformulieren.</td>
<td>Niet beschikbaar</td>
<td> Toegang tot de werkruimte gaat via Dynamics AX-dashboard. Deze bevat koppelingen naar verschillende nieuwe querypagina's: **Overzicht werkelijke waarden versus budget**, **Overzicht statistieken voor budgetbeheer**, **Budgetregisterposten** en **Budgetplannen**.</td>
...
<td>Het document **Budgetplan** wordt weergegeven als lijst van regels met ingangsdatums en bedragen voor combinaties van financiële dimensies. De gebruiker moet Excel-sjablonen maken en gebruiken om de gegevens van budgetplannnen in een draaitabel weer te geven.</td>
...
<tr class="odd">
<td>Druk het rapport **Leveranciersfactuurtransacties** af door informatie van het rapport **Gedetailleerde vervaldagenlijst** te gebruiken, dat de dagen na vervaldatum bevat. </td>
<td>U moet twee verschillende rapporten afdrukken: **Gedetailleerde vervaldagenlijst** en **Leveranciersfactuurtransacties**.</td>
<td>De informatie voor de rapporten is geconsolideerd in het rapport **Leveranciersfactuurtransacties**. Het rapport **Gedetailleerde vervaldagenlijst** is afgeschaft. </td>
...
<td>Niet beschikbaar</td>
<td>Op de pagina **Btw-vereffeningsperiode** kunt u opgeven dat het vereffeningsproces moet worden uitgevoerd in de batchmodus.</td>
...
<td>U moet de rapporten **BTW omzet en inkopen** genereren met de functionaliteit voor niet-gerealiseerde btw, zodat gebruikers transacties kunnen identificeren die tot de gerealiseerde en niet-gerealiseerde secties behoren op basis van de status.</td>
<td>De rapporten **BTW omzet en inkopen** zijn gewijzigd en wegen nu de voorwaardelijke belastingfunctie alleen mee door specifieke vereffeningsperioden te gebruiken voor de definitie van codes voor niet-gerealiseerd en gerealiseerde btw.</td>
...
<td>Niet beschikbaar</td>
<td>Op de pagina **Vaste-activaparameters** kunt u kiezen om in te lopen aan het einde van de boekperiode of van het fiscale jaar.</td>
...
<td>De functie is geïmplementeerd als de configuratie van een elektronische aangifte. Deze functionaliteit is beschikbaar voor Duitsland en Oostenrijk.</td>
...
<td>Saldilijst met groep totaalrekeningen rapport wordt geïmplementeerd als SSRS-rapport (LedgerAccountSum\_FR).</td>
...
<td>Intrastat-basisproductcodes vormen een aparte lijst. Hoewel er een categoriehiërarchie van het type Basisproductcode is, kunnen deze basisproductcodes als standaard worden gebruikt in Retail HQent en verkoopcategorieën.</td>
<td>Afzonderlijke lijst met Intrastat-basisproductcodes worden samengevoegd met de producthiërarchie van het type basisproductcode.</td>
...
<td>Intrastat-basisproductcode is een tekstveld om aan te duiden, aanvullende eenheden en de ** product ** kaart heeft een veld ter identificatie van het aantal extra eenheden in kilo's.</td>
...
|------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Wat kunt u doen?**                                                                                                                                 | **Dynamics AX 2012**                                                                                                             | **Dynamics AX 7.0**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | **Waarom is dit belangrijk?**                                                                                                                                                                                                                                            |
| Voer een controle van de materiaalbeschikbaarheid uit voor productieorders op een aparte pagina, die wordt geopend vanuit de werkruimte **Productievloerbeheer**. | Niet beschikbaar                                                                                                                    | De productiesupervisor kan controleren of de materialen voor geplande productieorders op de vereiste datum beschikbaar zijn. In de werkruimte kan de productiesupervisor zien hoeveel productieorders in de status in behandeling en in afwachting van vrijgave zijn. Gebaseerd op het dynamische hoofdplan wordt de informatie over de materiaalbeschikbaarheid bijgewerkt als de materiaalbehoeften worden vervuld met voorhanden voorraad voor werkelijke orders of geplande orders. Op basis van de informatie voor materiaalbeschikbaarheid kan de supervisor de orders op de pagina **Materiaalbeschikbaarheid** vrijgeven.                                                                                                                                                                                                                                                                                                                        | Dit helpt productiesupervisors juiste beslissingen te nemen over de toewijzing van materialen aan orders wanneer productieorders aan de werkvloer zijn vrijgegeven.                                                                                                       |
| Start en rapporteer de voortgang voor productietaken met de nieuwe pagina **Taakkaartapparaat**.                                                              | Het formulier **Taakregistratie** is voornamelijk bedoeld voor grote terminalschermen, en de UI wordt meestal bediend via muiskliks. | Hoewel de nieuwe ** taak kaartapparaat ** pagina's is ontworpen ter vereenvoudiging, ook bedoeld voor het contact. De pagina past goed op mobiele apparaten, zoals telefoons en tablets. De werknemer op de werkvloer ondervindt minder overbelasting door gegevens en meer gebruiksgemak. De werknemer kan traditionele taken uitvoeren, zoals het starten en beëindigen van taken en rapporteren over de voortgang ervan. Naast het werken aan de werkelijke taak of het afmelden en het uitklokken, kan de werknemer bijlagen weergeven, lunchpauze nemen en andere activiteiten uitvoeren. De taken worden via een wachtrij doorgegeven aan de werknemer in een geplande volgorde, maar ze kunnen ook door de werknemer worden uitgekozen. De pagina is voornamelijk bedoeld voor afzonderlijke productiebewerkingen, waar de materialen voor de productie worden voorbereid. Voor scenario's die verband houden met het rapporteren van co- en bijproducten zijn gekoppeld, en voor materiaalverzameling door traceren van dimensies, gebruikt u de pagina **Taakregistratie**. | Door een ander UI te introduceren die voor aanraking is ontworpen en toegankelijk is vanaf alle typen apparaten, zoals terminalschermen en mobiele apparaten, helpt deze functie om de implementatiekosten voor een traditioneel uitroltraject van werkvloerregistraties te verminderen. |

## <a name="master-planning-and-forecasting"></a>Hoofdplanning en prognoses
|                                                                                                                            |                                                                                                                                                                                                                                                                                               |                                                                                                                                                                                                                                                                                                                                                                   |                                                                                                                                                         |
|----------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Wat kunt u doen?**                                                                                                       | **Dynamics AX 2012**                                                                                                                                                                                                                                                                          | **Dynamics AX 7.0**                                                                                                                                                                                                                                                                                                                                               | **Waarom is dit belangrijk?**                                                                                                                              |
| Waarschuw de gebruiker als een verkooporder of productieorder niet op de geplande datum gereed is voor levering.                         | De waarschuwingen die worden gemaakt door de hoofdplanning worden *vertragingsberichten* (futures messages) genoemd. *Toekomstige* is een contract tussen twee partijen te kopen en verkopen van een activum naar een prijs die overeengekomen is vandaag (de *vertragingsberichten prijs*), hoewel de levering en betaling plaats in de toekomst (de *leveringsdatum)*. | *Vertragingsberichten* en *vertragingsdatums* zijn hernoemd *vertragingen berekend* en * datums, vertraagd * respectievelijk.                                                                                                                                                                                                                                                   | De terminologie die in AX 2012 werd gebruikt, is onnauwkeurig en leidde tot onjuiste vertalingen.                                                               |
...
<tr class="odd">
<td>Retail kanaal verkoopgegevens analyseren met behulp van de inhoud van de Power BI 'detailhandel bewaken prestaties'.</td>
<td>Niet beschikbaar</td>
...
<td>Commerce Data Exchange is een systeem dat gegevens overzet tussen Microsoft Dynamics AX en afzetkanalen voor detailhandel, zoals online winkels of fysieke winkels. Voor meer informatie, zie <a href="https://technet.microsoft.com/en-us/library/dn741440.aspx">Commerce Data Exchange [AX 2012]</a>.</td>
...
<td>Deze functionaliteit vereist <a href="http://www.microsoft.com/en-us/download/details.aspx?id=42636">System Center 2012 Management Pack voor Microsoft Dynamics AX 2012 R3 CU8 Retail</a>.</td>
...
<li>Hij biedt 'vooraf gedefinieerde' Alternatieve levering, verpakkingen, zoals een combinatie locatie/magazijn/variant/transportmodus, op basis van de snelste levering (vroegst beschikbare datum) criterium waaruit de gebruiker kan kiezen.</li>
