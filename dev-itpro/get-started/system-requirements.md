...
-   Dynamics 365 for Operations is ontworpen voor netwerken met latentie van 250-300 milliseconden (ms) of minder. Dit is de latentie in een browserclient naar het Microsoft Azure-datacentrum waar Dynamics 365 for Operations wordt gehost. Het wordt aangeraden om uw netwerklatentie te testen op <http://www.azurespeed.com>.
...
Over het algemeen is Dynamics 365 for Operations geoptimaliseerd voor het internet. Het aantal roundtrips vanuit een browserclient naar het Azure-datacentrum is erg klein en de gehele nettolading is gecomprimeerd. 
