...
3. Klik op Gebruikersopties.
4. Klik op het tabblad Workflow.
    * Zorg ervoor dat de sectie Meldingen is uitgevouwen.     Geef in de sectie Melding op, hoe u wilt dat de gebruiker geïnformeerd wordt over werkstroom-gerelateerde zaken.  
5. Selecteer een optie in het veld Meldingtype workflow voor regelartikelen.
    * Gegroepeerd: Regelartikelmeldingen worden gegroepeerd tot één e-mailbericht.    Individueel: Een e-mailbericht wordt verzonden voor elk regelartikel.  
    * Als u wilt dat de gebruiker meldingen ontvangt in de client, vinkt u het selectievakje Meldingen verzenden in e-mail aan.  
6. Klik op Opslaan.
7. Sluit de pagina.
