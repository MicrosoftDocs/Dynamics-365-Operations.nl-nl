...
De volgende sneltoetsen gelden in heel Microsoft Dynamics 365 for Finance and Operations. 
...
| Naar het standaardactievenster gaan                  | Ctrl+F6                          |
| Een tabblad openen in het actievenster of een menu           | Enter of spatiebalk of Alt+Pijl omlaag |
...
| Naar de volgende/vorige maand gaan       | Pagina omlaag/Pagina omhoog                       |
| Naar het volgende/vorige jaar gaan        | Ctrl+Shift+Pagina omlaag/Ctrl+Shift+Pagina omhoog |
...
| Het filtervenster openen (of de focus omschakelen tussen het filtervenster en het hoofdformulier als het filtervenster al open is) | Ctrl+F3       |
...
| Naar de vorige record gaan (buiten een raster)                                                                                    | Crtl+Pijl omhoog     |
...
| De navigatielijst openen in detailformulieren (of de focus omschakelen tussen de navigatielijst en het hoofdformulier als dat al open is) | Ctrl+F8           |
...
| Overschakelen naar detailweergave                              | Ctrl+Shift+D                                 |
| Overschakelen naar koptekstweergave                               | Ctrl+Shift+H                                 |
...
| Naar de volgende/vorige rij gaan zonder te selecteren (Opmerking: Deze sneltoets geldt alleen voor scenario's met meervoudige selectie.) | Ctrl+Pijl omhoog/Ctrl+Pijl omlaag |
| De huidige rij selecteren/wissen (Notitie: Deze snelkoppeling geldt alleen voor scenario's met meervoudige selectie.)                    | Ctrl+Spatiebalk/Ctrl+Klik         |
| De volgende/vorige rij toevoegen aan de geselecteerde set (Opmerking: Deze sneltoets geldt alleen voor scenario's met meervoudige selectie.)   | Shift+Spatiebalk                     |
| Een bereik van rijen toevoegen aan de geselecteerde set (Opmerking: Deze sneltoets geldt alleen voor scenario's met meervoudige selectie.)         | Shift+Klik                     |
| Naar de volgende/vorige pagina met gegevens gaan                                                                          | Pagina omhoog/Pagina omlaag             |
| Een nieuwe rij maken onder aan het raster                                                                    | Pijl omlaag (vanuit de laatste rij)  |
| Alle rijen selecteren of wissen                                                                                      | Ctrl+Shift+M                    |
| Naar de eerste record gaan                                                                                      | Ctrl+Home                       |
| Naar de laatste record gaan                                                                                       | Ctrl+End                        |
...
| Het rechterdeel van de vervolgkeuzelijst sluiten/openen                                                                      | Alt+Pijl naar rechts/Alt+Pijl naar links |
| Schakelen tussen "Alleen geldige weergeven" en "Alles weergeven"                                                                        | Alt+W                            |
| De waarde in de vervolgkeuzelijst en selecteren en naar het volgende segment gaan                                                       | Invoeren                            |
| Naar het volgende/vorige besturingselement op de pagina gaan (wanneer de focus zich in het invoerbesturingselement bevindt)                                          | Tabtoets/Shift+Tabtoets                  |
| Naar het volgende/vorige invoerveld in de flyout gaan (wanneer de focus zich in de vervolgkeuzelijst bevindt)                               | Tabtoets/Shift+Tabtoets                  |
| Een rij omhoog/omlaag verplaatsen in de zoekopdracht                                                                                        | Pijl omhoog/Pijl omlaag            |
| Een pagina omhoog/omlaag verplaatsen in de zoekopdracht                                                                                       | Pagina omhoog/Pagina omlaag              |
