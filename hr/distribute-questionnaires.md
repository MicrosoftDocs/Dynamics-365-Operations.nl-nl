...
Titel: Een vragenlijst verspreiden en invullen Beschrijving: In dit onderwerp wordt uitgelegd hoe u de vragenlijsten die u ontwerpt kunt distribueren, zodat ze beschikbaar zijn voor de persoon of groep personen die de lijsten gaat invullen. Auteur: twheeloc manager: AnnBe ms.date: 20-06/2017 ms.topic: artikel ms.prod: ms.service: Dynamics365Operations ms.technology: 

# <a name="optional-metadata"></a>optionele metagegevens

ms.search.form: KMConnectionType, KMKnowledgeCollectorPlanningTabel, SysEmailParameters
# <a name="robots"></a>ROBOTS: 
doelgroep: toepassingsgebruiker
...
ms.author: twheeloc ms.search.validFrom: 2016-02-28 ms.dyn365.ops.version: AX 7.0.0, Talent update juli 2017

---

# <a name="distribute-and-complete-a-questionnaire"></a>Een vragenlijst verspreiden en invullen
