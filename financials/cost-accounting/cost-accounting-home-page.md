...
Het volgende leertraject toont de belangrijkste concepten en taken met verbindingslijnen tussen verwante taken die het karakter van de kostprijsboekhoudingmodule beschrijven.

![Leertraject voor kostprijsboekhouding](./media/cost-accounting-map.png)

## <a name="get-started-videos"></a>Aan de slag-video's
