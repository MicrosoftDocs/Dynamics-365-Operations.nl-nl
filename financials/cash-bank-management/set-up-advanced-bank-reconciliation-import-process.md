...
description: Met de functie Geavanceerde bankafstemming kunt u elektronische bankafschriften importeren en deze automatisch afstemmen met banktransacties in Microsoft Dynamics 365 for Operations. In dit artikel wordt uitgelegd hoe u de importfunctionaliteit voor uw bankafschriften kunt instellen.
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
Met de functie Geavanceerde bankafstemming kunt u elektronische bankafschriften importeren en deze automatisch afstemmen met banktransacties in Microsoft Dynamics 365 for Operations. In dit artikel wordt uitgelegd hoe u de importfunctionaliteit voor uw bankafschriften kunt instellen. 

De instelling voor de importeren van bankafschriften varieert, afhankelijk van de indeling van uw elektronische bankafschrift. Microsoft Dynamics 365 voor bewerkingen ondersteunt drie indelingen van bankafschriften vanuit de doos: ISO20022 en MT940 BAI2.

## <a name="sample-files"></a>Voorbeeldbestanden
U beschikt voor alle drie de opmaakopties, bestanden die het elektronische bankafschrift van de oorspronkelijke indeling naar een indeling waarmee Dynamics 365 for Operations kunt vertalen. U kunt de vereiste resourcebestanden vinden onder het knooppunt **Resources** in Application Explorer in Microsoft Visual Studio. Nadat u de bestanden hebt gevonden, kopieert u deze naar een enkele bekende locatie, zodat u ze gemakkelijker kunt uploaden tijdens het instellingsproces.

| Naam van bron                                           | Bestandsnaam                            |
|---------------------------------------------------------|--------------------------------------|
| BankStmtImport\_BAI2CSV\_naar\_BAI2XML\_xslt              | BAI2CSV-to-BAI2XML.xslt              |
| BankStmtImport\_BAI2XML\_naar\_afstemming\_xslt       | BAI2XML-to-Reconciliation.xslt       |
| BankStmtImport\_BankReconciliation\_naar\_samengestelde\_xslt | BankReconciliation-to-Composite.xslt |
...
| BankStmtImport\_MT940XML\_naar\_afstemming\_xslt      | MT940XML-to-Reconciliation.xslt      |
...
Hieronder ziet u voorbeelden van de geavanceerde afstemming-import bestand technische indeling definities en drie bijbehorende bankafschriftbestanden voorbeeld: https://mbs.microsoft.com/customersource/northamerica/AX/learning/documentation/how-to-articles/exofbankstfotechlayouts  
...
10. Klik voor volgnummer 1 op **Bestand uploaden** en selecteer het bestand** ISO20022XML-to-Reconciliation.xslt** dat u eerder hebt opgeslagen. **opmerking:** Dynamics 365 voor bewerkingen transformatiebestanden worden gebouwd voor de standaardindeling. Aangezien banken afwijken van die vaak van deze indeling, moet u wellicht de transformatiebestand toewijzen aan uw Bankafschriftindeling bijwerken. <!-- For details about the expected format for ISO20022, see [Dynamics AX ISO20022 Layout](./media/dynamicsaxiso20022layout1.xlsx).-->
11. Click **New**.
...
1.  Ga naar **Kas- en bankbeheer**&gt;**Setup**&gt;**geavanceerde instellingen van bank-afstemming**&gt;**indeling bankafschrift**.
2.  Click **New**.
...
11. Klik op **Nieuw**.
12. Klik voor volgnummer 2 op **Bestand uploaden** en selecteer het bestand **MT940XML-to-Reconciliation.xslt** dat u eerder hebt opgeslagen. **opmerking:** Dynamics 365 voor bewerkingen transformatiebestanden worden gebouwd voor de standaardindeling. Aangezien banken afwijken van die vaak van deze indeling, moet u wellicht de transformatiebestand toewijzen aan uw Bankafschriftindeling bijwerken. <!--- For details about the expected format for MT940, see [Dynamics AX MT940 Layout](./media/dynamicsaxmt940layout1.xlsx)-->
13. Click **New**.
...
11. Klik op **Nieuw**.
12. Klik voor volgnummer 2 op **Bestand uploaden** en selecteer het bestand **BAI2XML-to-Reconciliation.xslt** dat u eerder hebt opgeslagen. **opmerking:** Dynamics 365 voor bewerkingen transformatiebestanden worden gebouwd voor de standaardindeling. Omdat banken vaak afwijken van die van deze indeling en moet u wellicht de transformatiebestand toewijzen aan uw Bankafschriftindeling wordt bijgewerkt. <!--- For details about the expected format for BAI2, see [Dynamics AX BAI2 Layout](./media/dynamicsaxbai2layout1.xlsx).-->
13. Click **New**.
14. Klik voor volgnummer 3 op **Bestand uploaden** en selecteer het bestand **BankReconciliation-to-Composite.xslt** dat u eerder hebt opgeslagen.
15. Klik op **Transformaties toepassen**.
