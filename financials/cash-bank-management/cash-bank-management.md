---
title: Startpagina Contanten en bankbeheer
description: "U kunt Kas- en bankbeheer gebruiken voor het onderhouden van de bankrekeningen van de rechtspersoon en de financiële instrumenten die aan de bankrekeningen zijn gekoppeld."
author: twheeloc
manager: AnnBe
ms.date: 04/04/2017
ms.topic: index-page
...
-   [Kredietbrieven en importincasso´s](letters-of-credit-import-collections.md)
...
-   [Importeren van de geavanceerde bankafstemming instellen](set-up-advanced-bank-reconciliation-import-process.md)
...
-   [Leveranciersfacturen met behulp van een betalingsvoorstel maken](../accounts-payable/create-vendor-payments-payment-proposal.md)
...
## <a name="accounts-receivable-payments-and-settlements"></a>Klantenbetalingen en -vereffeningen
...
-   [Scenario: Verwerken van korting voor contante betaling voor overbetalingen](../cash-bank-management/cash-discount-handling-overpayments.md)
