...
Dit onderwerp bevat informatie over het mobiele werkgebied Onkostenbeheer, dat beschikbaar is voor de mobiele app Microsoft Dynamics 365 for Finance and Operations. Via dit werkgebied kunnen gebruikers een ontvangstbewijs vastleggen en uploaden, zodat zij dit later aan een onkostennota kunnen koppelen. Het mobiele werkgebied stelt gebruikers tevens in staat snel een onkostenregel te maken op basis van een bevoegd ontvangstbewijs.
...
-   Een foto maken van een ontvangstbewijs en deze uploaden naar Microsoft Dynamics 365 for Finance and Operations. Een gebruiker kan vervolgens deze foto later aan een onkostennota koppelen.
...
<td>Als u Dynamics 365 for Finance and Operations nog niet hebt geïmplementeerd in uw organisatie, dient uw systeembeheerder <a href="/dynamics365/unified-operations/dev-itpro/deployment/deploy-demo-environment">Een demo-omgeving voor Microsoft Dynamics 365 for Finance and Operations implementeren</a> te raadplegen.</td>
</tr>
<tr class="even">
...
<li><a href="/dynamics365/unified-operations/dev-itpro/deployment/apply-deployable-package-system">Pas het implementeerbare pakket toe</a> op uw Finance and Operations-systeem.</li>
</ol></td>
</tr>
<tr class="odd">
<td>Het mobiele werkgebied <strong>Onkostenbeheer</strong> moet worden gepubliceerd naar de mobiele app Finance and Operations.</td>
<td>Systeembeheerder</td>
<td><ol>
<li>Finance and Operations in uw browser starten.</li>
...
## <a name="download-and-install-the-finance-and-operations-mobile-app"></a>Download en installeer de mobiele app Finance and Operations.
Download en installeer de mobiele app Finance and Operations vanuit uw store voor mobiele apps.

-   Voor Android: [Finance and Operations in de Google Play Store](https://play.google.com/store/apps/details?id=com.microsoft.dynamics365.operations.mobile)
-   Voor iPhone: [Finance and Operations in de iTunes apps store](https://itunes.apple.com/us/app/dynamics-365-for-operations/id1180836730?mt=8)

## <a name="sign-in-to-the-finance-and-operations-mobile-app"></a>Aanmelden bij de mobiele app Finance en Operations
1.  Start de app op uw mobiele apparaat.
2.  Voer uw Finance and Operations-URL in.
3.  Voer het bedrijf in waarbij u zich wilt aanmelden. Voer bijvoorbeeld **USMF** in.
4.  De eerste keer dat u zich aanmeldt, wordt u gevraagd om de gebruikersnaam en het wachtwoord voor uw Finance and Operations-account. Voer uw referenties in.
...
3.  Selecteer de categorie voor de onkostenpost. U ziet een lijst van onkostencategorieën die in uw app zijn geladen voor offline gebruik. Standaard worden maximaal 50 artikelen geladen, maar een ontwikkelaar kan dit aantal wijzigen. Voor meer informatie moeten ontwikkelaars [Mobiel platform van Finance and Operations](/dynamics365/unified-operations/dev-itpro/mobile-apps/mobile-platform) raadplegen. Als uw categorie niet in de lijst staat, selecteert u **Zoeken** om een online zoekopdracht in Finance and Operations uit te voeren. Zoek op onkostencategorie of schakel over naar zoeken op onkostentype.
