...
| **Veld**                             | **Omschrijving**             |
|---------------------------------------|--------------------------------------------------------------------------------------|
|**Minimum uren voor per diem**           | Geef het minimumaantal uren op dat een werknemer moet werken in een dag om voor een dagvergoeding voor reiskosten te ontvangen.                                                                                      |
