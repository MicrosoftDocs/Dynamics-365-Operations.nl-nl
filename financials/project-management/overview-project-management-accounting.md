...
Een project is een groep activiteiten die is ontworpen voor dienstverlening, een product of een resultaat te bereiken. Projecten bronnen verbruiken en financiële resultaten genereren in de vorm van opbrengsten of activa.

## <a name="projects-across-industries"></a>Projecten in de verschillende bedrijfstakken
De functionaliteit voor projectbeheer en boekhouding kan in meerdere bedrijfstakken worden gebruikt, zoals u ziet in de volgende afbeelding. [![projecten in hele bedrijfstakken](./media/projects-accross-industries.jpg)](./media/projects-accross-industries.jpg) 

In een callcenter kan een ticket worden gebruikt om de set acties te beschrijven die zijn vereist om een probleem op te lossen. Adviesbureaus zoals management of technische raadpleging organisaties of instanties, reclame verwijzen naar hun activiteiten als projecten. In marketing vertegenwoordigt een campagne een set van werk dat moet worden geleverd. In op projecten gebaseerde productie heeft een productieorder betrekking op de verschillende werkzaamheden die moet worden uitgevoerd om bepaalde eindproducten te produceren. Welke naam wordt gebruikt voor hen, deze projecten bestaan uit resources, planningen en kosten en de projectbeheer en boekhouding-functionaliteit in Microsoft Dynamics 365 for Operations helpen u bij de planning, uitvoering en analyse van deze projecten.
...
Tijdens de beginfase consequenties verschillende belangrijke. De geschatte arbeid, onkosten en materialen communiceren met de klant kunt u een projectofferte. U kunt de factureringsregel voorwaarden, beperkingen en overeenkomsten vastleggen in een projectcontract. U kunt een structuur voor werkspecificatie (projectstructuur) plannen en het werk te schatten. U kunt prognoses en budgetten instellen als richtlijn voor de projectuitvoering. De volgende afbeelding ziet u de structuur van een project. [![project structuur](./media/project-structure1.jpg)](./media/project-structure1.jpg)  
...
U kunt de zes typen projecten maken in Microsoft Dynamics 365 voor bewerkingen. Elk projecttype wordt anders ingesteld voor kosten en de verantwoording van opbrengsten. Het projecttype dat u kiest hangt af van het doel van het project. De volgende tabel beschrijft het typisch doel van elk projecttype.
...
> [!NOTE] 
> Transacties op investeringsprojecten worden niet weergegeven op de **kosten boeken**, **transitorische opbrengsten**, of **factuurvoorstellen maken** pagina.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | | kostenproject | Net als investeringsprojecten, kostenprojecten worden doorgaans gebruikt voor het bijhouden van interne projecten en alleen uren, onkosten en artikelen van deze kunnen worden geregistreerd. Kostenprojecten zijn echter gewoonlijk van kortere duur dan investeringsprojecten. Bovendien kunnen kostenprojecten in tegenstelling tot investeringsprojecten niet worden gekapitaliseerd naar balansrekeningen. In plaats daarvan worden de projecttransacties alleen geboekt op winst- en verliesrekeningen. 
[!NOTE] 
> Transacties op kostenprojecten worden niet weergegeven op de **kosten boeken**, **transitorische opbrengsten**, of **factuurvoorstellen maken** pagina. Omdat kostenprojecten doorgaans gebruikt worden voor het bijhouden van interne projecten, hebben zij niet normaal gesproken moet worden gekoppeld aan een klantrekening. Als uw installatie echter vereist dat artikelbehoeften worden gemaakt voor inkooporders, moet u het kostenproject aan een klant koppelen. Deze koppeling is vereist omdat de artikelbehoeften als verkooporderregels worden beheerd, en het systeem vereist dat een klant wordt opgegeven. Deze instelling zorgt er echter niet voor dat artikelbehoeften automatisch op basis van een inkooporder worden gemaakt. Voor kostenprojecten wordt de instelling **Artikelbehoefte maken** genegeerd. Als u een artikelbehoefte in een kostenproject nodig hebt, kunt u er een handmatig maken, mits een klant aan het project is gekoppeld. | | Interne | Interne projecten worden gebruikt om kosten te houden op een project dat binnen uw organisatie. Interne projecten kunnen een planningshulpmiddel beheren verbruik van bronnen bevatten. **opmerking:** transacties op interne projecten worden niet weergegeven op de **transitorische opbrengsten** of **factuurvoorstellen maken** pagina.                                                                                                                                                                                                                                                                       | | tijd | tijdprojecten worden gebruikt voor het bijhouden van de tijd die is gekoppeld aan niet-toerekenbare en niet-productieve activiteiten, zoals een project voor het bijhouden van ziekteverlof voor werknemers. Transacties in tijdprojecten worden niet naar het grootboek geboekt. In plaats daarvan worden ze opgenomen in rapporten over werknemersbenutting. Op tijdprojecten kunnen alleen uurtransacties worden geregistreerd. U kunt een uurjournaal of -werkblad gebruiken om deze uren op het project te registreren. Nadat de uren zijn geregistreerd, deze als projecttransacties weergegeven maar geen bijbehorende boekstuktransacties.

> [!NOTE] 
> Transacties op tijdprojecten worden niet weergegeven op de **kosten boeken**, **transitorische opbrengsten**, of **factuurvoorstellen maken** pagina.                                                                                                                                                                                       |
...
Hier volgen enkele van de manieren waarop u de functionaliteit voor resourceplanning kunt gebruiken:
...
Er zijn twee manieren beheren en controleren van uw projecten: project prognoses en budgetten project. U kunt prognoses gebruiken als uw organisatie een operationeel perspectief heeft en zich richt op opbrengsten en kosten die van specifieke transacties worden afgeleid. Als uw organisatie zich echter meer richt op financiële bedragen, kunt u budgettering gebruiken.
...
-   Verbruikt artikel/geen koppeling naar order ***: koppeling van het project aan een artikelbehoefte. Met deze methode kunt u de werkelijke projectkosten weergeven wanneer de productie de status **Gestart** heeft of is gereedgemeld. De kosten worden geboekt als artikeltransacties voor meerdere projecten voor grondstoffen en uren die zijn verbruikt voor de productie. U kunt het niveau in de stuklijsthiërarchie bepalen waarop de projecten in de productie moeten worden bijgehouden.
...
-   Als u artikelen wilt bestellen uit de voorraad van het bedrijf, moet u de order invoeren als een artikelbehoefte. Als u de **artikelbehoeften** pagina, u kunt de vereiste instellen zodat u artikelen als gedeeltelijke leveringen ontvangt. U kunt daarom verbruik van een hoeveelheid van de artikelen kunt uitstellen totdat de items vereist zijn.
...
> [!NOTE] 
> De pakbon voor een projectgerelateerde verkooporder kan niet worden geannuleerd als de artikelen die al zijn gemarkeerd voor verpakking. 
...
<td>De kostenraming moet handmatig worden ingevoerd. Nadat de kolom <strong>Totale kosten</strong> of <strong>Totale hoeveelheid</strong> op de pagina <strong>Kostenraming</strong> is ingevuld, worden de werkelijke kosten afgetrokken van de door de gebruiker ingevoerde totalen. Het resultaat bestaat uit de kosten om het project te voltooien. Doorgaans wordt de voortgang van kosten gebaseerd op bijvoorbeeld het aantal hotelverblijven en maaltijden die in elke periode worden geregistreerd, niet bijgehouden. Maar. In plaats daarvan wordt de voortgang meestal bijgehouden op basis van een vergelijking met het totale aantal geschatte uren. Bij deze benadering is geen prognosemodel nodig en kunnen de totale kosten of de totale hoeveelheid handmatig worden gewijzigd. Wanneer een waarde wordt ingevoerd in de <strong>totale kosten</strong> of <strong>totale hoeveelheid</strong> kolom, Microsoft Dynamics 365 for Operations vergelijkt deze waarde ten opzichte van de werkelijke transacties die zijn geboekt in de periode en verkleint u de waarde in de <strong>hoeveelheid tot volledig</strong> of <strong>kosten voor voltooien</strong> kolom.</td>
</tr>
<tr class="even">
...
De voorspelde ramingen verminderen niet automatisch door Microsoft Dynamics 365 voor bewerkingen. Daarom raden we aan om een oorspronkelijk prognosemodel van het project met een vaste prijs bij te houden om een startsituatie vast te stellen waarmee een vergelijking wordt gemaakt wanneer het project is voltooid. 
> [!NOTE]Wanneer u deze methode selecteert, moet u ten minste twee prognosemodellen gebruiken. Eén model dient de oorspronkelijke prognose te bevatten. Voor het andere model moet u prognosetransacties kopiëren vanuit een ander model. Deze methode is alleen geldig voor projecten met een vaste prijs en investeringsprojecten.</td>
> </tr>
<tr class="odd">
...
-   **Factuurdatum:** en met 31 maart 2012. Deze datum wordt bepaald op basis van de factuurfrequentie. Voor dit voorbeeld stelt u de factuurfrequentie op de huidige maand in. Dit betekent dat alle transacties die in de maand maart zijn geboekt, op de laatste dag van de maand worden gefactureerd.
-   **Vervaldatum:** 14 April 2012. Deze datum wordt bepaald op basis van de betalingsvoorwaarden die zijn ingesteld voor het project. Voor dit voorbeeld hebt u betalingsvoorwaarden van 14 dagen geselecteerd. Daarom worden 14 dagen toegevoegd aan de factuurdatum om op een vervaldatum van 14 april 2012 uit te komen.
-   **Verwachte betalingsdatum verkoop:** 27 April 2012. Deze datum wordt berekend door het toevoegen van het aantal dagen in de **algemene bufferdagen** op de **voor projectbeheer en boekhoudparameters** pagina met het aantal dagen in de **afzonderlijke bufferdagen** op **projectcontracten** pagina en vervolgens het totaal toe te voegen aan het aantal dagen in de **einddatum** veld. Voor dit voorbeeld hebt u **3** ingevoerd in het veld **Algemene bufferdagen** en **10** in het veld **Afzonderlijke bufferdagen**. Daarom worden 13 dagen toegevoegd aan de vervaldatum om uit te komen op een verwachte betalingsdatum verkoop van 27 april 2012.
...
#### <a name="actual-cash-inflow"></a>Werkelijke kasontvangsten
...
> [!NOTE] 
> De vervaldatum voor de inkooporder is gebaseerd op de leverancierstransactie wanneer de projectinkooporder wordt gemaakt. De vervaldatum wordt niet bepaald door eventuele standaardinstellingen. 
...
> [!NOTE] 
> Als u werkt met de **kostenbeheer** pagina voor de huidige status van projectkosten, de prognosemodellen gebruiken die zijn geselecteerd voor het oorspronkelijke en resterende budget. Als u andere prognosemodellen selecteert wanneer u kosten berekent, zijn de resultaten van de berekening mogelijk niet nauwkeurig.
