---
title: Reserveren van dezelfde batch voor een verkooporder
...
# <a name="reserve-the-same-batch-for-a-sales-order"></a>Reserveren van dezelfde batch voor een verkooporder
