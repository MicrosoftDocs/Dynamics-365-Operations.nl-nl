---
title: Bijwerken van standaardkosten beheren
description: "Updates van standaardkostengegevens kunnen worden beheerd met behulp van twee verschillende benaderingen: de benadering met één versie en de methode met twee versies."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="manage-standard-cost-updates"></a>Bijwerken van standaardkosten beheren

Updates van standaardkostengegevens kunnen worden beheerd met behulp van twee verschillende benaderingen: de benadering met één versie en de methode met twee versies. 
...
-   **Methode met één versie voor updates van kostengegevens** − In de methode met één versie, bevat de oorspronkelijke kostprijsberekeningsversie 2016-STD alle kostenregistraties. Kostenupdates worden geregistreerd in 2016 STD en worden ingesteld op een status "In behandeling." De kosten in behandeling kunnen handmatig worden ingevoerd voor een nieuw inkoopartikel of kunnen worden berekend voor een gefabriceerd artikel om correcties te reflecteren. Wanneer de methode met één versie wordt gebruikt, hoeven de stuklijstberekeningen niet een terugvalgegevensbron omdat alle actieve kosten zijn opgenomen in de kostprijsberekeningsversie. Nadat de kosten in behandeling actief worden, bevat de oorspronkelijke kostprijsberekeningsversie 2016-STD opnieuw alle huidige actieve kosten.
...
In dit voorbeeld wordt één extra kostprijsberekeningsversie gebruikt om updates tijdens het jaar 2016 beheren. Er kan meer dan een extra kostprijsberekeningsversie worden gebruikt, bijvoorbeeld een aparte versie voor elke batch met updates. Wanneer meer dan één extra kostprijsberekening wordt gebruikt, dan moet de terugval worden uitgedrukt als de actieve kosten, omdat de actieve kosten over meerdere kostprijsberekeningsversies zijn verdeeld.
