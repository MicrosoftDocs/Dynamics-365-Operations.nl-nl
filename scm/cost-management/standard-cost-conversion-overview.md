...
## <a name="2-review-and-change-the-new-costing-version-for-the-conversion-record"></a>2. Controleer en wijzig de nieuwe kostprijsberekeningsversie voor de conversierecord
...
## <a name="3-identify-the-items-to-convert-to-standard-cost"></a>3. Geef de artikelen te converteren naar de standaardkostprijs
...
## <a name="4-enter-or-calculate-the-pending-standard-cost-for-each-item-that-is-being-converted"></a>4. invoeren of berekenen van de standaardkostprijs in behandeling voor elk artikel dat wordt geconverteerd
...
## <a name="5-check-and-resolve-any-issues-for-the-items-that-are-being-converted"></a>5. Controleer en corrigeer de fouten voor de artikelen die worden geconverteerd
...
## <a name="7-back-up-the-database-before-conversion"></a>7. back-up van de database vóór de conversie
Met de back-up kunt u de database terugzetten als er fouten zijn opgetreden tijdens de conversie.

## <a name="8-perform-the-conversion-when-the-conversion-record-has-a-ready-status"></a>8. de conversie uitgevoerd wanneer de conversierecord de status gereed heeft
...
## <a name="9-validate-and-reconcile-the-inventory-values-for-the-converted-items"></a>9. valideren en de voorraadwaarden weergeven voor de geconverteerde artikelen afstemmen
