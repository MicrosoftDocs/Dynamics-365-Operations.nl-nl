---
title: Producten die kunnen worden geproduceerd of verkregen instellen
description: 'Producten die op verschillende manieren kunnen worden doorgegeven: kan worden geproduceerd (gefabriceerd) of aangeschaft (ingekochte). Dit artikel beschrijft sommige algemene punten om na te gaan wanneer u producten configureert om multi-sourcing te ondersteunen.'
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="set-up-products-that-can-be-produced-or-procured"></a>Producten die kunnen worden geproduceerd of verkregen instellen

Producten die op verschillende manieren kunnen worden doorgegeven: kan worden geproduceerd (gefabriceerd) of aangeschaft (ingekochte). Dit artikel beschrijft sommige algemene punten om na te gaan wanneer u producten configureert om multi-sourcing te ondersteunen. 
