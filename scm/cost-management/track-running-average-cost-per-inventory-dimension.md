...
Er zijn drie typen voorraaddimensies: product, opslag en tracering. Productdimensies zijn onder andere configuratie, grootte en kleur. Productdimensies worden altijd financieel bijgehouden. Opslag- en traceringsdimensies zijn onder andere site, magazijn, locatie, voorraadstatus, nummerbord, batchnummer en serienummer. U kunt bepalen welke opslag- en traceringsdimensies financieel worden bijgehouden. **Voorbeeld 1** Als de opslagdimensiegroep die aan het artikel is gekoppeld, financieel wordt bijgehouden door het magazijn, wordt de lopende gemiddelde kostprijs per magazijn berekend. De volgende inkooporders zijn gefactureerd:
