...
De volgende tabel bevat de transportbeheerengines die beschikbaar zijn in Microsoft Dynamics 365 for Operations.

| Transportbeheer engines | Omschrijving                                                                                                                                                                                                                                                                                                                 |
|----------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Tariefengine**                  | Tarieven berekenen.                                                                                                                                                                                                                                                                                                           |
| **Algemene engine**               | Eenvoudige hulpengines die door andere engines worden gebruikt die geen gegevens van Microsoft Dynamics 365 for Operations vereisen, bijvoorbeeld een toewijzingsengine. De verdelingsengines worden gebruikt om de totaalkosten van transport van specifieke orders en regels te verlagen, gebaseerd dimensies, zoals het volume en gewicht. |
...
De gegevens die u gebruikt wanneer u tarieven in Microsoft Dynamics 365 for Operations berekent worden bepaald door de metagegevensconfiguratie. Bijvoorbeeld, als u voor tarieven gebaseerd op postcodes wilt zoeken, moet u metagegevens instellen gebaseerd op oekopdrachttypee van een postcode.
