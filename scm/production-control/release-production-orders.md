...
Nadat een productieorder is vrijgegeven, zijn de productietaken die verband houden met de order zichtbaar en gereed voor registratie. De operators kunnen gegevens taak registreren, zoals starten, stoppen en is voltooid, op het de **taak kaart terminal** pagina of het **taak kaartapparaat** pagina. De geregistreerde tijd en hoeveelheid automatisch overgebracht van de registratiepagina's aan productiejournalen te houden de verbruikte tijd en hoeveelheid.
...
Werkzaamheden voor het verzamelen van grondstoffen worden gegenereerd tijdens de vrijgave. Werk wordt alleen gegenereerd voor de hoeveelheid van materialen die fysiek is gereserveerd voor de productieorder voordat de order is vrijgegeven. De volgende instellingen zijn vereist voor het genereren van magazijnwerk voor orderverzameling grondstof:
