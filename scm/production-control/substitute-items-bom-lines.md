...
Overweeg na scenario: een computer waarop de fabricage van een bedrijf bevat een onderdeel dat in twee maanden van de leverancierscatalogus verlopen zal. Van de vervaldatum bewerken, wordt een nieuw onderdeel die kan worden vervangen voor het oude onderdeel worden aangeboden door de leverancier. Van- en t/m-datums kunnen worden ingesteld op stuklijstregels. In dit voorbeeld stelt u in dat de oude component vervalt door de vervaldatum in het veld **Einddatum** in te voeren. Vervolgens stelt u in de stuklijst de nieuwe, vervangende component in zodat deze geldig is vanaf de dag dat de oude component vervalt. Om dit te doen, voert u de begindatum in het veld **Begindatum** in.
