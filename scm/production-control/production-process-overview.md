---
title: Productie verwerken-overzicht
description: "Dit artikel biedt een overzicht van de productieprocessen. Hierin worden de verschillende fasen van productieorders, batchorders en kanbans van order maken naar afsluiting van de financiële periode."
author: YuyuScheller
manager: AnnBe
ms.date: 04/04/2017
ms.topic: article
...
# <a name="production-process-overview"></a>Productie verwerken-overzicht

Dit artikel biedt een overzicht van de productieprocessen. Hierin worden de verschillende fasen van productieorders, batchorders en kanbans van order maken naar afsluiting van de financiële periode. 
...
De **productiebeheer** module is gekoppeld aan andere modules, zoals **productgegevensbeheer**, **voorraadbeheer**, **grootboek**, **magazijnbeheer**, **projectadministratie**, en **Organisatiebeheer**. Door deze integratie wordt de informatiestroom ondersteund die is vereist om de productie van een afgewerkt artikel te voltooien.  

Het productieproces wordt doorgaans beïnvloed door de kostprijsboekhouding en voorraadwaarderingsmethoden die voor een bepaald productieproces worden gekozen. Dynamics 365 voor bewerkingen ondersteunt zowel werkelijke kosten (first in, first out \[FIFO\]; deze laatste in, first out \[LIFO\]; zwevend gemiddelde; en periodieke gewogen gemiddelde) en methoden voor standaardkosten. Lean manufacturing wordt geïmplementeerd op basis van het principe van kostprijsberekening via terugwaarts afboeken.  
...
Verschillende producten en de productietopologieën vereisen het gebruik van verschillende ordertypen. De verschillende ordertypen in een gemengde modus kunnen worden toegepast in Dynamics 365 voor bewerkingen. Met andere woorden, alle ordertypen kunnen voorkomen tijdens het totale proces van het vervaardigen van één afgewerkt product.
...
2.  **Geschat** – U kunt ramingen voor materiaal- en resourceverbruik berekenen. De raming genereert voorraadtransacties voor grondstoffen die de status **In bestelling** hebben. De ontvangsten voor de belangrijkste producten, coproducten en bijproducten worden gegenereerd wanneer productieorders of batchorders worden geraamd. Als de stuklijst regels van bevat de **vastgelegd aanbod** typt, inkooporders voor materialen of services voor uitbestede bewerking zijn gegenereerd en vastgekoppeld aan de productieorder of batchorder. Artikelen of orders worden gereserveerd volgens de reserveringstrategie van de productieorder, en de prijs van de voltooide goederen wordt berekend op basis van parameterinstellingen.
...
5.  **Voorbereid**/**opgenomen** : wanneer alle materialen en bronnen hebt op de locatie van de productie, de productiestuklijstregels is klaargezet of kanbanregels zijn bijgewerkt naar de status van **opgenomen**. Getraceerde aanbodorders en bijbehorende magazijnwerkzaamheden worden meestal in deze fase voltooid. De kanbankaarten of taakkaarten die zijn vereist om de productievoortgang te rapporteren moeten worden toegewezen en afgedrukt.
