...
Stapverbruik wordt gebruikt voor het berekenen van het constante verbruik in hoeveelheidsintervallen. Als u **Stapverbruik** selecteert in het veld **Formule** op het tabblad **Instellen**, kunt u informatie over de stappen toevoegen op het tabblad **Stapverbruik**. De vaste verbruikte hoeveelheid kan worden ingesteld in intervallen van de geproduceerde hoeveelheid. Stapverbruik wordt bijvoorbeeld,ingesteld op de wijze die in de volgende tabel wordt aangegeven.
